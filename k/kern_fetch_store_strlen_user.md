# Function: <code>kern_fetch_store_strlen_user</code>
...
```
In kernel/trace/trace_eprobe.c (ffffffff8129541e)
Location: kernel/trace/trace_probe_kernel.h:15
Inline: True
Inline callers:
...
```
```
In kernel/trace/trace_events_synth.c (ffffffff812983b8)
Location: kernel/trace/trace_probe_kernel.h:15
Inline: True
Inline callers:
...
```
```
In kernel/trace/trace_kprobe.c (ffffffff812ad5e5)
Location: kernel/trace/trace_probe_kernel.h:15
Inline: True
Inline callers:
