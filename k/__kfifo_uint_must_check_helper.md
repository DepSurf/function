# Function: <code>__kfifo_uint_must_check_helper</code>
...
Location: include/linux/kfifo.h:176
Inline: True
```
```
...
```
In mm/memory-failure.c (0)
Location: include/linux/kfifo.h:177
Inline: True
```
```
In drivers/gpio/gpiolib.c (0)
...
```
In mm/memory-failure.c (0)
Location: include/linux/kfifo.h:163
Inline: True
```
```
In drivers/gpio/gpiolib.c (0)
