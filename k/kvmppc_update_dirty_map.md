...
```
In arch/powerpc/kvm/book3s_hv_rm_mmu.c (c000000000120278)
Location: arch/powerpc/kvm/book3s_hv_rm_mmu.c:109
Inline: True
Inline callers:
...
```
c00000000011c840-c00000000011c914: kvmppc_update_dirty_map (STB_GLOBAL)
```
</details>
</li>
<li>
