# Function: <code>kirin_apb_ctrl_readl</code>
...
```
In drivers/pci/controller/dwc/pcie-kirin.c (ffff800010735ff0)
Location: drivers/pci/controller/dwc/pcie-kirin.c:102
Inline: True
Inline callers:
