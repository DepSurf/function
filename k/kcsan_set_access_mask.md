# Function: <code>kcsan_set_access_mask</code>
...
Location: include/linux/kcsan-checks.h:153
Inline: True
```
```
...
```
In init/do_mounts.c (0)
Location: include/linux/kcsan-checks.h:159
Inline: True
```
```
In arch/x86/kernel/cpu/sgx/encl.c (0)
...
```
In init/do_mounts.c (0)
Location: include/linux/kcsan-checks.h:204
Inline: True
```
```
In arch/x86/kernel/cpu/sgx/encl.c (0)
