...
```
In arch/arm64/kvm/inject_fault.c (ffff8000100cf4f0)
Location: arch/arm64/kvm/inject_fault.c:234
Inline: False
Direct callers:
...
```
ffff8000100cf4f0-ffff8000100cf528: kvm_inject_vabt (STB_GLOBAL)
```
</details>
</li>
<li>
