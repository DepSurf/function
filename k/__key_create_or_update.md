...
```
In security/keys/key.c (ffffffff81687c20)
Location: security/keys/key.c:795
Inline: False
Direct callers:
...
```
ffffffff81687c20-ffffffff8168822b: __key_create_or_update (STB_LOCAL)
```
</details>
</li>
<li>
...
```
In security/keys/key.c (ffffffff816c4140)
Location: security/keys/key.c:791
Inline: False
Direct callers:
  - security/keys/key.c:key_create
  - security/keys/key.c:key_create_or_update
...
```
ffffffff816c4140-ffffffff816c474b: __key_create_or_update (STB_LOCAL)
```
</details>
</li>
</ul>
