...
```
In arch/arm64/kernel/debug-monitors.c (ffff800010086290)
Location: arch/arm64/kernel/debug-monitors.c:408
Inline: False
Direct callers:
...
```
ffff800010086290-ffff8000100862e8: kernel_enable_single_step (STB_GLOBAL)
```
</details>
</li>
<li>
