# Function: <code>kcsan_atomic_next</code>
...
Location: include/linux/kcsan-checks.h:158
Inline: True
```
```
...
Location: include/linux/kcsan-checks.h:152
Inline: True
```
```
...
```
In init/do_mounts.c (0)
Location: include/linux/kcsan-checks.h:203
Inline: True
```
```
