# Function: <code>kcsan_flat_atomic_begin</code>
...
Location: include/linux/kcsan-checks.h:156
Inline: True
```
```
...
```
In kernel/sched/cputime.c (0)
Location: include/linux/kcsan-checks.h:150
Inline: True
```
```
In kernel/auditsc.c (0)
...
Location: include/linux/kcsan-checks.h:201
Inline: True
```
```
In kernel/auditsc.c (0)
