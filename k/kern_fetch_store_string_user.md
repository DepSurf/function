# Function: <code>kern_fetch_store_string_user</code>
...
```
In kernel/trace/trace_eprobe.c (ffffffff81294f79)
Location: kernel/trace/trace_probe_kernel.h:66
Inline: True
Inline callers:
...
```
```
In kernel/trace/trace_events_synth.c (ffffffff81297f52)
Location: kernel/trace/trace_probe_kernel.h:66
Inline: True
Inline callers:
