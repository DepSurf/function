# Function: <code>kvm_timer_update_irq</code>
...
```
In virt/kvm/arm/arch_timer.c (ffff8000100ec960)
Location: virt/kvm/arm/arch_timer.c:294
Inline: True
Direct callers:
...
```
ffff8000100ec960-ffff8000100eca6c: kvm_timer_update_irq.isra.0 (STB_LOCAL)
```
</details>
</li>
<li>
