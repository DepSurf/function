# Function: <code>kvm_vcpu_sys_get_rt</code>
...
```
In arch/arm64/kvm/sys_regs.c (ffff8000100d9520)
Location: arch/arm64/include/asm/kvm_emulate.h:374
Inline: True
Inline callers:
...
```
```
In virt/kvm/arm/hyp/vgic-v3-sr.c (ffff800010dacbcc)
Location: arch/arm64/include/asm/kvm_emulate.h:374
Inline: True
Inline callers:
...
```
```
In arch/arm64/kvm/hyp/switch.c (ffff800010dae35c)
Location: arch/arm64/include/asm/kvm_emulate.h:374
Inline: True
Inline callers:
