# Function: <code>kirin_apb_ctrl_writel</code>
...
```
In drivers/pci/controller/dwc/pcie-kirin.c (ffff800010736090)
Location: drivers/pci/controller/dwc/pcie-kirin.c:96
Inline: True
Inline callers:
