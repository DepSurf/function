# Function: <code>mm_is_thread_local</code>
...
```
In arch/powerpc/mm/book3s64/hash_pgtable.c (c00000000008bc68)
Location: arch/powerpc/include/asm/tlb.h:64
Inline: True
Inline callers:
  - arch/powerpc/mm/book3s64/hash_pgtable.c:hpte_do_hugepage_flush
```
```
In arch/powerpc/mm/book3s64/hash_utils.c (c00000000008de20)
Location: arch/powerpc/include/asm/tlb.h:64
Inline: True
Inline callers:
...
```
```
In arch/powerpc/mm/book3s64/hash_tlb.c (c00000000009156c)
Location: arch/powerpc/include/asm/tlb.h:64
Inline: True
Inline callers:
...
```
```
In arch/powerpc/mm/book3s64/radix_tlb.c (c00000000009cf5c)
Location: arch/powerpc/include/asm/tlb.h:64
Inline: True
Inline callers:
