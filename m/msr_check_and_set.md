...
```
In arch/powerpc/kernel/process.c (c0000000000206f0)
Location: arch/powerpc/kernel/process.c:121
Inline: False
Direct callers:
...
```
c0000000000206f0-c000000000020720: msr_check_and_set (STB_GLOBAL)
```
</details>
</li>
<li>
