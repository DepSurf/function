# Function: <code>mddev_unlock_and_resume</code>
...
```
In drivers/md/md.c (ffffffff81e219ae)
Location: drivers/md/md.h:848
Inline: True
Inline callers:
...
```
```
In drivers/md/md-bitmap.c (ffffffff81e25b14)
Location: drivers/md/md.h:848
Inline: True
Inline callers:
...
```
```
In drivers/md/md-autodetect.c (ffffffff839598ab)
Location: drivers/md/md.h:848
Inline: True
Inline callers:
