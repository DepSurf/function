# Function: <code>__mptcp_sync_sndbuf</code>
...
```
In net/mptcp/protocol.c (ffffffff8214d24f)
Location: net/mptcp/protocol.h:803
Inline: True
Inline callers:
...
```
```
In net/mptcp/subflow.c (ffffffff8214ff96)
Location: net/mptcp/protocol.h:803
Inline: True
Inline callers:
