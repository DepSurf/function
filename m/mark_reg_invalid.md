# Function: <code>mark_reg_invalid</code>
...
```
In kernel/bpf/verifier.c (ffffffff8130050b)
...
```
In kernel/bpf/verifier.c (ffffffff813241a5)
Location: kernel/bpf/verifier.c:837
Inline: True
Inline callers:
