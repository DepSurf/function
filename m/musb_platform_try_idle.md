# Function: <code>musb_platform_try_idle</code>
...
```
In drivers/usb/musb/musb_core.c (c0b64e84)
Location: drivers/usb/musb/musb_core.h:526
Inline: True
Inline callers:
...
```
```
In drivers/usb/musb/musb_virthub.c (c0b69444)
Location: drivers/usb/musb/musb_core.h:526
Inline: True
Inline callers:
...
```
```
In drivers/usb/musb/musb_gadget.c (c0b6fa9c)
Location: drivers/usb/musb/musb_core.h:526
Inline: True
Inline callers:
