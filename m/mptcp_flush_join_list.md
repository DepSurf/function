...
```
In net/mptcp/protocol.c (ffffffff81ba9300)
...
```
ffffffff81ba9300-ffffffff81ba933e: mptcp_flush_join_list (STB_LOCAL)
```
</details>
</li>
<li>
...
```
In net/mptcp/protocol.c (ffffffff81c76e50)
Location: net/mptcp/protocol.c:784
Inline: False
Direct callers:
  - net/mptcp/protocol.c:mptcp_stream_accept
  - net/mptcp/protocol.c:__mptcp_check_send_data_fin
...
```
ffffffff81c76e50-ffffffff81c76e8e: mptcp_flush_join_list (STB_LOCAL)
```
</details>
</li>
<li>
