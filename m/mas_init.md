...
Location: include/linux/maple_tree.h:484
Inline: True
Inline callers:
...
```
```
In mm/mprotect.c (ffffffff81404220)
Location: include/linux/maple_tree.h:484
Inline: True
Inline callers:
...
```
```
In fs/proc/task_mmu.c (ffffffff815653ec)
Location: include/linux/maple_tree.h:484
Inline: True
Inline callers:
...
Location: include/linux/maple_tree.h:523
Inline: True
Inline callers:
  - kernel/sched/fair.c:task_numa_work
```
```
In kernel/bpf/task_iter.c (ffffffff813498e6)
Location: include/linux/maple_tree.h:523
Inline: True
Inline callers:
...
```
```
In mm/mprotect.c (ffffffff814307f4)
Location: include/linux/maple_tree.h:523
Inline: True
Inline callers:
  - mm/mprotect.c:do_mprotect_pkey
...
```
```
In fs/proc/task_mmu.c (ffffffff8159c1f0)
Location: include/linux/maple_tree.h:523
Inline: True
Inline callers:
  - fs/proc/task_mmu.c:m_start
