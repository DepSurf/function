# Function: <code>mte_parent_shift</code>
...
```
In lib/maple_tree.c (ffffffff82038d86)
Location: lib/maple_tree.c:399
Inline: True
Inline callers:
...
```
In lib/maple_tree.c (ffffffff820ae385)
Location: lib/maple_tree.c:404
Inline: True
Inline callers:
  - lib/maple_tree.c:mas_push_data
  - lib/maple_tree.c:mast_fill_bnode
...
```
In lib/maple_tree.c (ffffffff8218f2b8)
Location: lib/maple_tree.c:424
Inline: True
Inline callers:
