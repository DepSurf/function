# Function: <code>mas_safe_min</code>
...
```
In lib/maple_tree.c (ffffffff82038caa)
Location: lib/maple_tree.c:720
Inline: True
Inline callers:
...
```
In lib/maple_tree.c (ffffffff820adccf)
Location: lib/maple_tree.c:723
Inline: True
Inline callers:
...
```
In lib/maple_tree.c (ffffffff82188f26)
Location: lib/maple_tree.c:716
Inline: True
Inline callers:
  - lib/maple_tree.c:mas_empty_area
  - lib/maple_tree.c:mas_anode_descend
