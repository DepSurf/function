# Function: <code>mas_set_height</code>
...
```
In lib/maple_tree.c (ffffffff8203866a)
Location: lib/maple_tree.c:187
Inline: True
Inline callers:
...
```
In lib/maple_tree.c (ffffffff820ab5f7)
Location: lib/maple_tree.c:192
Inline: True
Inline callers:
  - lib/maple_tree.c:mas_replace
```
...
```
In lib/maple_tree.c (ffffffff82190e6e)
Location: lib/maple_tree.c:200
Inline: True
Inline callers:
