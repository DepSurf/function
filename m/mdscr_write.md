...
```
In arch/arm64/kernel/debug-monitors.c (ffff800010086088)
Location: arch/arm64/kernel/debug-monitors.c:37
Inline: False
Direct callers:
...
```
ffff800010086088-ffff800010086180: mdscr_write (STB_LOCAL)
```
</details>
</li>
<li>
