# Function: <code>meson_parm_write</code>
...
```
In drivers/clk/meson/clk-cpu-dyndiv.c (ffff8000107e6284)
Location: drivers/clk/meson/parm.h:38
Inline: True
Inline callers:
  - drivers/clk/meson/clk-cpu-dyndiv.c:meson_clk_cpu_dyndiv_set_rate
```
```
In drivers/clk/meson/clk-dualdiv.c (ffff8000107e6740)
Location: drivers/clk/meson/parm.h:38
Inline: True
Inline callers:
...
```
```
In drivers/clk/meson/clk-mpll.c (ffff8000107e6f2c)
Location: drivers/clk/meson/parm.h:38
Inline: True
Inline callers:
...
```
```
In drivers/clk/meson/clk-pll.c (ffff8000107e7a64)
Location: drivers/clk/meson/parm.h:38
Inline: True
Inline callers:
...
```
In drivers/clk/meson/clk-mpll.c (c0901b4c)
Location: drivers/clk/meson/parm.h:38
Inline: True
Inline callers:
  - drivers/clk/meson/clk-mpll.c:mpll_init
...
```
```
In drivers/clk/meson/clk-pll.c (c0902bc8)
Location: drivers/clk/meson/parm.h:38
Inline: True
Inline callers:
  - drivers/clk/meson/clk-pll.c:meson_clk_pll_set_rate
