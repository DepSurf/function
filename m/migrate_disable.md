...
Location: include/linux/preempt.h:335
Inline: True
Inline callers:
  - kernel/seccomp.c:seccomp_run_filters
```
```
In kernel/trace/bpf_trace.c (ffffffff811ea3f8)
Location: include/linux/preempt.h:335
Inline: True
Inline callers:
...
```
```
In kernel/bpf/bpf_iter.c (ffffffff81216064)
Location: include/linux/preempt.h:335
Inline: True
Inline callers:
...
```
```
In kernel/bpf/cgroup.c (ffffffff8122ec5c)
Location: include/linux/preempt.h:335
Inline: True
Inline callers:
...
```
```
In net/bpf/test_run.c (ffffffff81a7e255)
Location: include/linux/preempt.h:335
Inline: True
Inline callers:
...
```
In kernel/sched/core.c (ffffffff810d6b30)
Location: kernel/sched/core.c:1742
Inline: False
Direct callers:
  - kernel/seccomp.c:seccomp_run_filters
  - kernel/trace/bpf_trace.c:trace_call_bpf
...
```
ffffffff810d6b30-ffffffff810d6b7e: migrate_disable (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In kernel/sched/core.c (ffffffff810d8810)
Location: kernel/sched/core.c:1750
Inline: False
Direct callers:
  - kernel/seccomp.c:seccomp_run_filters
  - kernel/trace/bpf_trace.c:trace_call_bpf
...
```
ffffffff810d8810-ffffffff810d885e: migrate_disable (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In kernel/sched/core.c (ffffffff810ec0a0)
Location: kernel/sched/core.c:2128
Inline: False
Direct callers:
  - kernel/seccomp.c:seccomp_run_filters
  - kernel/trace/bpf_trace.c:trace_call_bpf
...
```
ffffffff810ec0a0-ffffffff810ec0ee: migrate_disable (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In kernel/sched/core.c (ffffffff81108580)
Location: kernel/sched/core.c:2224
Inline: False
Direct callers:
  - kernel/seccomp.c:seccomp_run_filters
...
```
ffffffff81108580-ffffffff811085fb: migrate_disable (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In kernel/sched/core.c (ffffffff8112d4e0)
Location: kernel/sched/core.c:2216
Inline: False
Direct callers:
...
```
ffffffff8112d4e0-ffffffff8112d55b: migrate_disable (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In kernel/sched/core.c (ffffffff8113a9e0)
...
```
ffffffff8113a9e0-ffffffff8113aa5b: migrate_disable (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In kernel/sched/core.c (ffffffff8114c930)
Location: kernel/sched/core.c:2419
Inline: False
Direct callers:
  - kernel/seccomp.c:__seccomp_filter
  - kernel/trace/ring_buffer.c:ring_buffer_resize
...
```
ffffffff8114c930-ffffffff8114c9ab: migrate_disable (STB_GLOBAL)
```
</details>
</li>
</ul>
