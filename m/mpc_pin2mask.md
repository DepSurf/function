# Function: <code>mpc_pin2mask</code>
...
```
In drivers/gpio/gpio-mpc8xxx.c (ffff8000106cf81c)
Location: drivers/gpio/gpio-mpc8xxx.c:75
Inline: True
Inline callers:
...
```
In drivers/gpio/gpio-mpc8xxx.c (c0869484)
Location: drivers/gpio/gpio-mpc8xxx.c:75
Inline: True
Inline callers:
  - drivers/gpio/gpio-mpc8xxx.c:mpc8xxx_irq_set_type
