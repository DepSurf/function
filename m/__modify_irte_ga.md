# Function: <code>__modify_irte_ga</code>
...
```
In drivers/iommu/amd/iommu.c (ffffffff81b520c0)
Location: drivers/iommu/amd/iommu.c:3093
Inline: True
Direct callers:
...
```
ffffffff81b520c0-ffffffff81b52143: __modify_irte_ga.isra.0 (STB_LOCAL)
```
</details>
</li>
</ul>
