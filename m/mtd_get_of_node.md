# Function: <code>mtd_get_of_node</code>
...
```
In drivers/mtd/mtdcore.c (c0a90e04)
Location: include/linux/mtd/mtd.h:382
Inline: True
Inline callers:
...
```
```
In drivers/mtd/mtdpart.c (c0a948bc)
Location: include/linux/mtd/mtd.h:382
Inline: True
Inline callers:
...
```
```
In drivers/mtd/parsers/ofpart.c (c0a97458)
Location: include/linux/mtd/mtd.h:382
Inline: True
Inline callers:
...
```
```
In drivers/mtd/nand/raw/nand_base.c (c0aa2454)
Location: include/linux/mtd/mtd.h:382
Inline: True
```
</details>
