# Function: <code>mutex_set_owner</code>
...
```
In kernel/locking/mutex.c (ffffffff818219a9)
Location: kernel/locking/mutex.h:20
Inline: True
Inline callers:
...
```
In kernel/locking/mutex.c (ffffffff8189c04c)
