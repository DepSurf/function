# Function: <code>mte_mk_root</code>
...
```
In lib/maple_tree.c (ffffffff82038676)
Location: lib/maple_tree.c:316
Inline: True
Inline callers:
...
```
In lib/maple_tree.c (ffffffff820ab5e1)
...
```
In lib/maple_tree.c (ffffffff82190e88)
