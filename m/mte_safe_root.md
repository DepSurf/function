# Function: <code>mte_safe_root</code>
...
```
In lib/maple_tree.c (ffffffff82030a4c)
Location: lib/maple_tree.c:321
Inline: True
Inline callers:
...
```
In lib/maple_tree.c (ffffffff820ac540)
Location: lib/maple_tree.c:326
Inline: True
Inline callers:
  - lib/maple_tree.c:mt_find
  - lib/maple_tree.c:mtree_load
...
```
In lib/maple_tree.c (ffffffff8218dc2d)
