...
```
In drivers/clk/mediatek/clk-mtk.c (ffff8000107e1cd8)
Location: drivers/clk/mediatek/clk-mtk.c:236
Inline: False
Direct callers:
...
```
ffff8000107e1cd8-ffff8000107e1db8: mtk_clk_register_composites (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In drivers/clk/mediatek/clk-mtk.c (c08fef98)
Location: drivers/clk/mediatek/clk-mtk.c:236
Inline: False
Direct callers:
  - drivers/clk/mediatek/clk-mt7622.c:mtk_pericfg_init
...
```
c08fef98-c08ff058: mtk_clk_register_composites (STB_GLOBAL)
```
</details>
</li>
<li>
