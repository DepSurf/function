...
```
In lib/maple_tree.c (ffffffff8203854b)
Location: lib/maple_tree.c:1127
Inline: True
Inline callers:
...
```
In lib/maple_tree.c (ffffffff820a96d0)
Location: lib/maple_tree.c:1180
Inline: False
Direct callers:
  - lib/maple_tree.c:mas_wr_bnode
  - lib/maple_tree.c:mas_wr_node_store
...
```
ffffffff820a96d0-ffffffff820a983f: mas_pop_node (STB_LOCAL)
```
</details>
</li>
<li>
...
```
In lib/maple_tree.c (ffffffff821816d0)
Location: lib/maple_tree.c:1139
Inline: False
Direct callers:
...
```
ffffffff821816d0-ffffffff8218183f: mas_pop_node (STB_LOCAL)
```
</details>
</li>
</ul>
