...
```
In arch/powerpc/sysdev/msi_bitmap.c (c0000000000b7a00)
Location: arch/powerpc/sysdev/msi_bitmap.c:38
Inline: False
Direct callers:
...
```
c0000000000b7a00-c0000000000b7ac0: msi_bitmap_free_hwirqs (STB_GLOBAL)
```
</details>
</li>
<li>
