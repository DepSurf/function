...
```
In arch/powerpc/sysdev/msi_bitmap.c (c0000000000b7890)
Location: arch/powerpc/sysdev/msi_bitmap.c:14
Inline: False
Direct callers:
...
```
c0000000000b7890-c0000000000b7a00: msi_bitmap_alloc_hwirqs (STB_GLOBAL)
```
</details>
</li>
<li>
