...
```
In fs/namespace.c (ffffffff812994b0)
Location: fs/namespace.c:542
Inline: False
Direct callers:
...
```
ffffffff812994b0-ffffffff812994d5: mnt_drop_write_file_path (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
ffffffff812bf330-ffffffff812bf340: mnt_drop_write_file_path (STB_GLOBAL)
```
</details>
</li>
<li>
