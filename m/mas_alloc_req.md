# Function: <code>mas_alloc_req</code>
...
```
In lib/maple_tree.c (ffffffff8202810b)
...
```
In lib/maple_tree.c (ffffffff820ab9e6)
Location: lib/maple_tree.c:611
Inline: True
Inline callers:
...
```
In lib/maple_tree.c (ffffffff8218f35d)
Location: lib/maple_tree.c:633
Inline: True
Inline callers:
