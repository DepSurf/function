...
```
In arch/powerpc/sysdev/msi_bitmap.c (c0000000000b7e50)
Location: arch/powerpc/sysdev/msi_bitmap.c:111
Inline: False
Direct callers:
...
```
c0000000000b7e50-c0000000000b7fa8: msi_bitmap_alloc (STB_GLOBAL)
```
</details>
</li>
<li>
