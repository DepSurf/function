...
```
In arch/powerpc/sysdev/mpic.c (c0000000000b47a8)
Location: arch/powerpc/sysdev/mpic.c:173
Inline: True
Inline callers:
...
```
c0000000000b4630-c0000000000b4650: _mpic_read.isra.0.part.0 (STB_LOCAL)
```
</details>
</li>
<li>
