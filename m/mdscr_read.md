...
```
In arch/arm64/kernel/debug-monitors.c (ffff80001008626c)
Location: arch/arm64/kernel/debug-monitors.c:46
Inline: True
Inline callers:
...
```
ffff800010085aa8-ffff800010085ac4: mdscr_read (STB_LOCAL)
```
</details>
</li>
<li>
