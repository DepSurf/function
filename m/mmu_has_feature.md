# Function: <code>mmu_has_feature</code>
...
Location: arch/powerpc/include/asm/mmu.h:196
Inline: True
Inline callers:
...
Inline callers:
  ...
  - arch/powerpc/mm/book3s64/hash_utils.c:htab_convert_pte_flags
```
```
In arch/powerpc/mm/book3s64/slb.c (c00000000008fe94)
Location: arch/powerpc/include/asm/mmu.h:196
Inline: True
Inline callers:
  ...
  - arch/powerpc/mm/book3s64/slb.c:preload_add
```
```
...
```
```
In arch/powerpc/mm/book3s64/hash_native.c (c000000000092774)
Location: arch/powerpc/include/asm/mmu.h:196
Inline: True
Inline callers:
...
```
```
In arch/powerpc/mm/book3s64/hash_64k.c (c00000000009de88)
Location: arch/powerpc/include/asm/mmu.h:196
Inline: True
Inline callers:
...
```
```
In arch/powerpc/mm/copro_fault.c (c0000000000a68e0)
Location: arch/powerpc/include/asm/mmu.h:196
Inline: True
Inline callers:
...
```
```
In arch/powerpc/platforms/pseries/lpar.c (c0000000013617cc)
Location: arch/powerpc/include/asm/mmu.h:196
Inline: True
Inline callers:
