# Function: <code>map_value_has_timer</code>
...
```
In kernel/bpf/syscall.c (ffffffff812342a0)
Location: include/linux/bpf.h:201
Inline: True
Inline callers:
...
```
```
In kernel/bpf/verifier.c (ffffffff8123b98f)
Location: include/linux/bpf.h:201
Inline: True
Inline callers:
...
```
```
In kernel/bpf/helpers.c (ffffffff8124fb08)
Location: include/linux/bpf.h:201
Inline: True
Inline callers:
...
```
```
In kernel/bpf/hashtab.c (ffffffff81254fae)
Location: include/linux/bpf.h:201
Inline: True
Inline callers:
...
```
```
In kernel/bpf/arraymap.c (ffffffff81257c49)
Location: include/linux/bpf.h:201
Inline: True
Inline callers:
...
```
```
In kernel/bpf/local_storage.c (ffffffff8125becf)
Location: include/linux/bpf.h:201
Inline: True
Inline callers:
...
```
```
In net/core/bpf_sk_storage.c (ffffffff81b0a5c8)
Location: include/linux/bpf.h:201
Inline: True
Inline callers:
...
```
In kernel/bpf/syscall.c (ffffffff81270e1b)
Location: include/linux/bpf.h:251
Inline: True
Inline callers:
...
```
```
In kernel/bpf/verifier.c (ffffffff812814b1)
Location: include/linux/bpf.h:251
Inline: True
Inline callers:
  - kernel/bpf/verifier.c:check_map_prog_compatibility
...
```
```
In kernel/bpf/hashtab.c (ffffffff8129e39e)
Location: include/linux/bpf.h:251
Inline: True
Inline callers:
  - kernel/bpf/hashtab.c:__htab_map_lookup_and_delete_batch
...
```
```
In kernel/bpf/local_storage.c (ffffffff812a5a0b)
Location: include/linux/bpf.h:251
Inline: True
Inline callers:
  - kernel/bpf/local_storage.c:bpf_cgroup_storage_alloc
