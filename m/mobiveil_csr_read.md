# Function: <code>mobiveil_csr_read</code>
...
```
In drivers/pci/controller/pcie-mobiveil.c (ffff80001072bfa8)
Location: drivers/pci/controller/pcie-mobiveil.c:238
Inline: True
Direct callers:
...
```
ffff80001072bfa8-ffff80001072c014: mobiveil_csr_read.constprop.0 (STB_LOCAL)
```
</details>
</li>
<li>
