# Function: <code>ma_meta_end</code>
...
```
In lib/maple_tree.c (ffffffff82030aae)
Location: lib/maple_tree.c:903
Inline: True
Inline callers:
...
```
In lib/maple_tree.c (ffffffff820ab2eb)
Location: lib/maple_tree.c:950
Inline: True
Inline callers:
  - lib/maple_tree.c:mtree_load
  - lib/maple_tree.c:mtree_load
...
```
In lib/maple_tree.c (ffffffff8218dca3)
Location: lib/maple_tree.c:922
Inline: True
Inline callers:
  - lib/maple_tree.c:mt_find
  - lib/maple_tree.c:mt_find
