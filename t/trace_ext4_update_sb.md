# Function: <code>trace_ext4_update_sb</code>
...
```
In fs/ext4/ioctl.c (ffffffff814ed5be)
...
```
In fs/ext4/ioctl.c (ffffffff8158742e)
...
```
In fs/ext4/ioctl.c (ffffffff815bdaee)
...
```
In fs/ext4/ioctl.c (ffffffff815f68ae)
