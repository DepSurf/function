# Function: <code>trace_ext4_journal_start_sb</code>
...
```
In fs/ext4/ext4_jbd2.c (ffffffff8155aaba)
...
```
In fs/ext4/ext4_jbd2.c (ffffffff815928da)
...
```
In fs/ext4/ext4_jbd2.c (ffffffff815cb5fa)
