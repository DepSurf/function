# Function: <code>__tcp_fast_path_on</code>
...
```
```
In net/ipv4/tcp_input.c (ffffffff8177046c)
Location: include/net/tcp.h:634
Inline: True
Inline callers:
...
```
In net/ipv4/tcp.c (ffffffff817d3d2c)
Location: include/net/tcp.h:630
Inline: True
Inline callers:
  - net/ipv4/tcp.c:tcp_recvmsg
```
```
In net/ipv4/tcp_input.c (ffffffff817e0c4b)
Location: include/net/tcp.h:630
Inline: True
Inline callers:
  - net/ipv4/tcp_input.c:tcp_rcv_state_process
...
```
In net/ipv4/tcp.c (ffffffff81803a6f)
Location: include/net/tcp.h:628
Inline: True
Inline callers:
  - net/ipv4/tcp.c:tcp_recvmsg
```
```
In net/ipv4/tcp_input.c (ffffffff8181104d)
Location: include/net/tcp.h:628
Inline: True
Inline callers:
  - net/ipv4/tcp_input.c:tcp_rcv_state_process
...
```
In net/ipv4/tcp.c (ffffffff818245bb)
Location: include/net/tcp.h:636
Inline: True
Inline callers:
  - net/ipv4/tcp.c:tcp_recvmsg
```
```
In net/ipv4/tcp_input.c (ffffffff81831133)
Location: include/net/tcp.h:636
Inline: True
Inline callers:
  - net/ipv4/tcp_input.c:tcp_rcv_state_process
...
```
In net/ipv4/tcp.c (ffffffff818a5ead)
Location: include/net/tcp.h:612
Inline: True
Inline callers:
  - net/ipv4/tcp.c:tcp_recvmsg
```
```
In net/ipv4/tcp_input.c (ffffffff818b0565)
Location: include/net/tcp.h:612
Inline: True
Inline callers:
  - net/ipv4/tcp_input.c:tcp_rcv_state_process
...
Location: include/net/tcp.h:622
Inline: True
Inline callers:
  - net/ipv4/tcp.c:tcp_recvmsg
```
...
Location: include/net/tcp.h:649
Inline: True
Inline callers:
  - net/ipv4/tcp.c:tcp_recvmsg
```
...
Location: include/net/tcp.h:650
Inline: True
Inline callers:
  - net/ipv4/tcp.c:tcp_recvmsg
```
