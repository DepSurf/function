# Function: <code>ti_sci_put_one_xfer</code>
...
```
In drivers/firmware/ti_sci.c (ffff800010b50f90)
Location: drivers/firmware/ti_sci.c:389
Inline: True
Direct callers:
...
```
ffff800010b50f90-ffff800010b5106c: ti_sci_put_one_xfer.isra.0 (STB_LOCAL)
```
</details>
</li>
<li>
