# Function: <code>trace_io_uring_task_add</code>
...
```
In fs/io_uring.c (ffffffff8137d8f5)
...
```
In fs/io_uring.c (ffffffff8138cd3f)
Location: include/trace/events/io_uring.h:414
Inline: True
Inline callers:
  - fs/io_uring.c:__io_async_wake
...
```
In fs/io_uring.c (ffffffff8139302a)
...
```
In fs/io_uring.c (ffffffff813e084a)
...
```
In io_uring/io_uring.c (ffffffff816ce742)
...
```
In io_uring/poll.c (ffffffff8179ca52)
...
```
In io_uring/poll.c (ffffffff817ddc82)
...
```
In io_uring/poll.c (ffffffff81822022)
Location: include/trace/events/io_uring.h:455
Inline: True
Inline callers:
  - io_uring/poll.c:__io_poll_execute
