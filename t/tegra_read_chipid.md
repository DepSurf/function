...
```
In drivers/soc/tegra/fuse/tegra-apbmisc.c (c15920c0)
Location: drivers/soc/tegra/fuse/tegra-apbmisc.c:28
Inline: True
Inline callers:
...
```
c093a5d8-c093a610: tegra_read_chipid.part.0 (STB_LOCAL)
c093a610-c093a648: tegra_read_chipid (STB_GLOBAL)
```
</details>
</li>
<li>
