# Function: <code>trace_event_get_offsets_io_uring_defer</code>
...
```
In io_uring/io_uring.c (ffffffff816c9cd1)
...
```
In io_uring/io_uring.c (ffffffff81788239)
...
```
In io_uring/io_uring.c (ffffffff817c8779)
Location: include/trace/events/io_uring.h:184
Inline: True
Inline callers:
  - io_uring/io_uring.c:perf_trace_io_uring_defer
...
```
In io_uring/io_uring.c (ffffffff8180d449)
Location: include/trace/events/io_uring.h:184
Inline: True
Inline callers:
  - io_uring/io_uring.c:perf_trace_io_uring_defer
