# Function: <code>tcp_ao_len_aligned</code>
...
```
In net/ipv4/tcp_output.c (ffffffff81fe6149)
Location: include/net/tcp_ao.h:71
Inline: True
Inline callers:
...
```
```
In net/ipv4/tcp_ipv4.c (ffffffff81ff3b1a)
Location: include/net/tcp_ao.h:71
Inline: True
Inline callers:
...
```
```
In net/ipv4/tcp_minisocks.c (ffffffff81ff8d0b)
Location: include/net/tcp_ao.h:71
Inline: True
Inline callers:
...
```
```
In net/ipv4/tcp_ao.c (ffffffff82053f84)
Location: include/net/tcp_ao.h:71
Inline: True
Inline callers:
...
```
```
In net/ipv6/tcp_ipv6.c (ffffffff820ca675)
Location: include/net/tcp_ao.h:71
Inline: True
Inline callers:
