...
```
In arch/powerpc/mm/book3s64/radix_tlb.c (c00000000009b904)
Location: arch/powerpc/mm/book3s64/radix_tlb.c:310
Inline: True
Inline callers:
...
```
c000000000096cf0-c0000000000972b8: _tlbie_pid (STB_LOCAL)
```
</details>
</li>
<li>
