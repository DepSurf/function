# Function: <code>tcp_ao_maclen</code>
...
Location: include/net/tcp_ao.h:60
Inline: True
Inline callers:
...
```
```
In net/ipv4/tcp_ipv4.c (ffffffff81ff3ac0)
Location: include/net/tcp_ao.h:60
Inline: True
Inline callers:
...
```
```
In net/ipv4/tcp_ao.c (ffffffff82054200)
Location: include/net/tcp_ao.h:60
Inline: True
Inline callers:
...
```
```
In net/ipv6/tcp_ipv6.c (ffffffff820ca535)
Location: include/net/tcp_ao.h:60
Inline: True
Inline callers:
