...
```
In arch/powerpc/kernel/process.c (c000000000020fe8)
Location: arch/powerpc/kernel/process.c:873
Inline: True
Inline callers:
...
```
c000000000021610-c000000000021654: tm_reclaim_current (STB_GLOBAL)
```
</details>
</li>
<li>
