# Function: <code>tick_nohz_user_enter_prepare</code>
...
```
In kernel/entry/common.c (ffffffff8113cde7)
Location: include/linux/tick.h:304
Inline: True
Inline callers:
...
```
In kernel/entry/common.c (ffffffff8115ff07)
Location: include/linux/tick.h:308
Inline: True
Inline callers:
  - kernel/entry/common.c:exit_to_user_mode_prepare
  - kernel/entry/common.c:exit_to_user_mode_loop
...
```
In kernel/entry/common.c (0)
Location: include/linux/tick.h:310
Inline: True
```
</details>
</li>
...
Location: include/linux/tick.h:300
Inline: True
Inline callers:
