# Function: <code>trace_event_get_offsets_ext4_ext_rm_leaf</code>
...
Location: include/trace/events/ext4.h:2095
Inline: True
```
</details>
</li>
...
```
In fs/ext4/super.c (0)
Location: include/trace/events/ext4.h:2077
Inline: True
```
</details>
</li>
...
```
In fs/ext4/super.c (ffffffff815e88aa)
...
```
In fs/ext4/super.c (ffffffff8162129a)
