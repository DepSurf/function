# Function: <code>trace_event_get_offsets_io_uring_queue_async_work</code>
...
```
In io_uring/io_uring.c (ffffffff816c9e9d)
...
```
In io_uring/io_uring.c (ffffffff8178993c)
...
```
In io_uring/io_uring.c (ffffffff817ca3cc)
Location: include/trace/events/io_uring.h:140
Inline: True
Inline callers:
  - io_uring/io_uring.c:perf_trace_io_uring_queue_async_work
...
```
In io_uring/io_uring.c (ffffffff8180f00c)
Location: include/trace/events/io_uring.h:140
Inline: True
Inline callers:
  - io_uring/io_uring.c:perf_trace_io_uring_queue_async_work
