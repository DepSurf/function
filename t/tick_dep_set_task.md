# Function: <code>tick_dep_set_task</code>
...
```
In kernel/time/posix-cpu-timers.c (0)
Location: include/linux/tick.h:264
Inline: True
```
</details>
</li>
...
```
In kernel/time/posix-cpu-timers.c (0)
Location: include/linux/tick.h:275
Inline: True
```
</details>
</li>
...
```
In kernel/rcu/tree.c (ffffffff811ddf1b)
...
```
```
In kernel/time/posix-cpu-timers.c (ffffffff81213b51)
Location: include/linux/tick.h:239
Inline: True
Inline callers:
...
```
In kernel/time/posix-cpu-timers.c (ffffffff8112e885)
