# Function: <code>to_tegra_dma_chan</code>
...
```
In drivers/dma/tegra20-apb-dma.c (c0929f18)
Location: drivers/dma/tegra20-apb-dma.c:253
Inline: True
Inline callers:
  - drivers/dma/tegra20-apb-dma.c:tegra_dma_of_xlate
