# Function: <code>trace_io_uring_register</code>
...
```
In fs/io_uring.c (ffffffff81381787)
...
```
In fs/io_uring.c (ffffffff8138f853)
Location: include/trace/events/io_uring.h:67
Inline: True
Inline callers:
  - fs/io_uring.c:__ia32_sys_io_uring_register
...
```
In fs/io_uring.c (ffffffff8139eed6)
Location: include/trace/events/io_uring.h:67
Inline: True
Inline callers:
  - fs/io_uring.c:__ia32_sys_io_uring_register
...
```
In fs/io_uring.c (ffffffff813ef1b2)
Location: include/trace/events/io_uring.h:67
Inline: True
Inline callers:
  - fs/io_uring.c:__ia32_sys_io_uring_register
...
```
In io_uring/io_uring.c (ffffffff816d8cb3)
...
```
In io_uring/io_uring.c (ffffffff8178c86d)
...
```
In io_uring/io_uring.c (ffffffff817cda03)
Location: include/trace/events/io_uring.h:69
Inline: True
Inline callers:
...
```
In io_uring/register.c (ffffffff8182bf2e)
Location: include/trace/events/io_uring.h:69
Inline: True
Inline callers:
