# Function: <code>trace_event_get_offsets_ext4_da_update_reserve_space</code>
...
```
In fs/ext4/super.c (0)
Location: include/trace/events/ext4.h:1143
Inline: True
```
</details>
</li>
...
```
In fs/ext4/super.c (ffffffff815e6aaf)
...
```
In fs/ext4/super.c (ffffffff8161f49f)
