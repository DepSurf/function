# Function: <code>to_reset_simple_data</code>
...
Location: drivers/reset/reset-simple.c:26
Inline: True
```
</details>
</li>
...
```
In drivers/reset/reset-simple.c (0)
Location: drivers/reset/reset-simple.c:25
Inline: True
```
</details>
</li>
...
```
In drivers/reset/reset-simple.c (c0959fb0)
Location: drivers/reset/reset-simple.c:26
Inline: True
Inline callers:
  - drivers/reset/reset-simple.c:reset_simple_status
