# Function: <code>to_imx7_src</code>
...
```
In drivers/reset/reset-imx7.c (ffff80001084d54c)
Location: drivers/reset/reset-imx7.c:85
Inline: True
Inline callers:
...
```
In drivers/reset/reset-imx7.c (c095998c)
Location: drivers/reset/reset-imx7.c:85
Inline: True
Inline callers:
  - drivers/reset/reset-imx7.c:imx8mq_reset_set
