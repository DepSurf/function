# Function: <code>twl_class_is_6030</code>
...
```
In drivers/regulator/twl6030-regulator.c (c0957dc0)
Location: include/linux/mfd/twl.h:161
Inline: True
Inline callers:
...
```
```
In drivers/rtc/rtc-twl.c (c0b8fc3c)
Location: include/linux/mfd/twl.h:161
Inline: True
Inline callers:
