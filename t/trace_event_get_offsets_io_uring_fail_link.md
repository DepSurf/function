# Function: <code>trace_event_get_offsets_io_uring_fail_link</code>
...
```
In io_uring/io_uring.c (ffffffff816c9b05)
...
```
In io_uring/io_uring.c (ffffffff8178977d)
...
```
In io_uring/io_uring.c (ffffffff817ca20d)
Location: include/trace/events/io_uring.h:283
Inline: True
Inline callers:
  - io_uring/io_uring.c:perf_trace_io_uring_fail_link
...
```
In io_uring/io_uring.c (ffffffff8180ee4d)
Location: include/trace/events/io_uring.h:283
Inline: True
Inline callers:
  - io_uring/io_uring.c:perf_trace_io_uring_fail_link
