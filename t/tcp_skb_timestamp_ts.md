# Function: <code>tcp_skb_timestamp_ts</code>
...
```
In net/ipv4/tcp_input.c (ffffffff81fdc9d3)
Location: include/net/tcp.h:852
Inline: True
```
```
In net/ipv4/tcp_output.c (ffffffff81fec6d8)
Location: include/net/tcp.h:852
Inline: True
Inline callers:
