...
```
In drivers/vfio/vfio_iommu_spapr_tce.c (c000000000ab2050)
Location: drivers/vfio/vfio_iommu_spapr_tce.c:643
Inline: False
Direct callers:
...
```
c000000000ab2050-c000000000ab237c: tce_iommu_create_window (STB_LOCAL)
```
</details>
</li>
<li>
