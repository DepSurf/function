# Function: <code>timer_pending</code>
...
Location: include/linux/timer.h:163
Inline: True
```
```
...
```
In arch/x86/kernel/cpu/mcheck/mce.c (0)
Location: include/linux/timer.h:184
Inline: True
```
```
In kernel/workqueue.c (0)
...
```
In arch/x86/kernel/cpu/mcheck/mce.c (0)
Location: include/linux/timer.h:181
Inline: True
```
```
In kernel/workqueue.c (0)
...
```
In arch/x86/kernel/cpu/mcheck/mce.c (0)
Location: include/linux/timer.h:156
Inline: True
```
```
In kernel/workqueue.c (0)
...
```
In arch/x86/kernel/cpu/mcheck/mce.c (0)
Location: include/linux/timer.h:154
Inline: True
```
```
In kernel/workqueue.c (0)
...
```
In arch/x86/kernel/cpu/mce/core.c (0)
Location: include/linux/timer.h:165
Inline: True
```
```
In kernel/workqueue.c (0)
...
Location: include/linux/timer.h:166
Inline: True
Inline callers:
  - arch/x86/kernel/cpu/mce/core.c:__start_timer
```
...
Location: include/linux/timer.h:151
Inline: True
Inline callers:
  - arch/x86/kernel/cpu/mce/core.c:__start_timer
```
...
```
In kernel/workqueue.c (c036fec8)
Location: include/linux/timer.h:165
Inline: True
Inline callers:
  - kernel/workqueue.c:worker_enter_idle
...
```
```
In kernel/time/timer.c (c03e7ea8)
Location: include/linux/timer.h:165
Inline: True
Inline callers:
  - kernel/time/timer.c:add_timer_on
...
```
```
In block/blk-timeout.c (c07987b4)
Location: include/linux/timer.h:165
Inline: True
Inline callers:
  - block/blk-timeout.c:blk_add_timer
```
```
In block/blk-mq.c (c0799b24)
Location: include/linux/timer.h:165
Inline: True
```
```
In block/blk-stat.c (c07a0c78)
Location: include/linux/timer.h:165
Inline: True
Inline callers:
  - block/blk-stat.c:blk_stat_add
...
```
```
In drivers/char/random.c (c09a9944)
Location: include/linux/timer.h:165
Inline: True
```
```
In drivers/ata/libahci.c (c0a85ec0)
Location: include/linux/timer.h:165
Inline: True
Inline callers:
...
```
```
In drivers/usb/dwc2/hcd_queue.c (c0b1e324)
Location: include/linux/timer.h:165
Inline: True
Inline callers:
  - drivers/usb/dwc2/hcd_queue.c:dwc2_unreserve_timer_fn
```
```
In drivers/usb/host/xhci-ring.c (c0b520c4)
Location: include/linux/timer.h:165
Inline: True
Inline callers:
  - drivers/usb/host/xhci-ring.c:xhci_stop_endpoint_command_watchdog
```
```
In drivers/leds/led-core.c (c0c327f4)
Location: include/linux/timer.h:165
Inline: True
```
```
In net/core/drop_monitor.c (c0d32ee8)
Location: include/linux/timer.h:165
Inline: True
Inline callers:
  - net/core/drop_monitor.c:net_dm_hw_summary_probe
```
```
In net/sched/sch_generic.c (c0d4c7b4)
Location: include/linux/timer.h:165
Inline: True
Inline callers:
  - net/sched/sch_generic.c:dev_shutdown
```
```
In net/ipv4/inet_connection_sock.c (c0d7c300)
Location: include/linux/timer.h:165
Inline: True
```
```
In net/ipv4/tcp_ipv4.c (c0d9a904)
Location: include/linux/timer.h:165
Inline: True
Inline callers:
...
```
```
In net/ipv6/addrconf.c (c0e06974)
Location: include/linux/timer.h:165
Inline: True
Inline callers:
...
```
```
In net/ipv6/ip6_fib.c (c0e20ba4)
Location: include/linux/timer.h:165
Inline: True
Inline callers:
  - net/ipv6/ip6_fib.c:fib6_add
...
```
```
In net/ipv6/tcp_ipv6.c (c0e392f8)
Location: include/linux/timer.h:165
Inline: True
Inline callers:
...
```
```
In net/ipv6/ip6_flowlabel.c (c0e41a40)
Location: include/linux/timer.h:165
Inline: True
Inline callers:
  - net/ipv6/ip6_flowlabel.c:fl_release
```
```
In net/ipv6/addrconf_core.c (c0e5371c)
Location: include/linux/timer.h:165
Inline: True
Inline callers:
  - net/ipv6/addrconf_core.c:in6_dev_finish_destroy
...
```
```
In kernel/time/timer.c (c0000000001ffb44)
Location: include/linux/timer.h:165
Inline: True
Inline callers:
  - kernel/time/timer.c:add_timer
...
```
```
In net/sched/sch_generic.c (c000000000d33718)
Location: include/linux/timer.h:165
Inline: True
Inline callers:
  - net/sched/sch_generic.c:dev_shutdown
...
```
```
In net/ipv6/addrconf_core.c (c000000000e8b420)
Location: include/linux/timer.h:165
Inline: True
Inline callers:
  - net/ipv6/addrconf_core.c:in6_dev_finish_destroy
