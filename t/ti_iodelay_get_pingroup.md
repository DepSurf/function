...
```
In drivers/pinctrl/ti/pinctrl-ti-iodelay.c (c08562a0)
Location: drivers/pinctrl/ti/pinctrl-ti-iodelay.c:376
Inline: True
Direct callers:
...
```
c08562a0-c08562f8: ti_iodelay_get_pingroup (STB_LOCAL)
```
</details>
</li>
<li>
