# Function: <code>trace_event_get_offsets_io_uring_poll_arm</code>
...
```
In io_uring/io_uring.c (ffffffff816c9745)
...
```
In io_uring/io_uring.c (ffffffff817893df)
...
```
In io_uring/io_uring.c (ffffffff817ca04f)
...
```
In io_uring/io_uring.c (ffffffff8180ec8f)
Location: include/trace/events/io_uring.h:414
Inline: True
Inline callers:
  - io_uring/io_uring.c:perf_trace_io_uring_poll_arm
