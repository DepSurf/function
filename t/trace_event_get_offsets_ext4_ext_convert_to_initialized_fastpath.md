# Function: <code>trace_event_get_offsets_ext4_ext_convert_to_initialized_fastpath</code>
...
```
In fs/ext4/super.c (ffffffff815e77e2)
...
```
In fs/ext4/super.c (ffffffff816201d2)
