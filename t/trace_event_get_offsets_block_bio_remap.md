# Function: <code>trace_event_get_offsets_block_bio_remap</code>
...
Location: include/trace/events/block.h:591
Inline: True
```
</details>
</li>
...
```
In block/blk-core.c (0)
Location: include/trace/events/block.h:598
Inline: True
```
</details>
</li>
...
```
In block/blk-core.c (ffffffff8176f648)
...
```
In block/blk-core.c (ffffffff817b18b8)
