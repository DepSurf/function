# Function: <code>to_mvebu_pwm</code>
...
```
In drivers/gpio/gpio-mvebu.c (ffff8000106d13c0)
Location: drivers/gpio/gpio-mvebu.c:603
Inline: True
Inline callers:
...
```
In drivers/gpio/gpio-mvebu.c (c086b570)
Location: drivers/gpio/gpio-mvebu.c:603
Inline: True
Inline callers:
  - drivers/gpio/gpio-mvebu.c:mvebu_pwm_apply
