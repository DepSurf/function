# Function: <code>trace_io_uring_submit_sqe</code>
...
```
In fs/io_uring.c (ffffffff81388b0b)
...
```
In fs/io_uring.c (ffffffff81399797)
Location: include/trace/events/io_uring.h:331
Inline: True
Inline callers:
  - fs/io_uring.c:io_submit_sqes
...
```
In fs/io_uring.c (ffffffff813a07bf)
...
```
In fs/io_uring.c (ffffffff813ef680)
...
```
In io_uring/io_uring.c (ffffffff816d61ed)
...
```
In io_uring/io_uring.c (ffffffff81791676)
