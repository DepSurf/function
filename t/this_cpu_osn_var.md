# Function: <code>this_cpu_osn_var</code>
...
```
In kernel/trace/trace_osnoise.c (ffffffff81298386)
Location: kernel/trace/trace_osnoise.c:226
Inline: True
Inline callers:
...
```
In kernel/trace/trace_osnoise.c (ffffffff812b39f8)
Location: kernel/trace/trace_osnoise.c:226
Inline: True
Inline callers:
  - kernel/trace/trace_osnoise.c:timerlat_fd_read
