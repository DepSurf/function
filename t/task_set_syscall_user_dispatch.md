...
```
In kernel/entry/syscall_user_dispatch.c (ffffffff811d96a0)
Location: kernel/entry/syscall_user_dispatch.c:72
Inline: False
Direct callers:
...
```
ffffffff811d96a0-ffffffff811d9781: task_set_syscall_user_dispatch (STB_LOCAL)
```
</details>
</li>
<li>
...
```
In kernel/entry/syscall_user_dispatch.c (ffffffff811ef350)
Location: kernel/entry/syscall_user_dispatch.c:72
Inline: False
Direct callers:
  - kernel/entry/syscall_user_dispatch.c:syscall_user_dispatch_set_config
...
```
ffffffff811ef350-ffffffff811ef431: task_set_syscall_user_dispatch (STB_LOCAL)
```
</details>
</li>
</ul>
