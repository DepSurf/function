# Function: <code>trace_event_get_offsets_ext4_remove_blocks</code>
...
Location: include/trace/events/ext4.h:2054
Inline: True
```
</details>
</li>
...
```
In fs/ext4/super.c (0)
Location: include/trace/events/ext4.h:2036
Inline: True
```
</details>
</li>
...
```
In fs/ext4/super.c (ffffffff815e872e)
...
```
In fs/ext4/super.c (ffffffff8162111e)
