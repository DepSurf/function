# Function: <code>trace_event_get_offsets_sock_rcvqueue_full</code>
...
Location: include/trace/events/sock.h:10
Inline: True
```
</details>
</li>
...
```
In net/core/net-traces.c (0)
Location: include/trace/events/sock.h:11
Inline: True
```
</details>
</li>
...
```
In net/core/net-traces.c (ffffffff81e8b49a)
Location: include/trace/events/sock.h:71
Inline: True
Inline callers:
...
```
In net/core/net-traces.c (ffffffff81f4d4aa)
Location: include/trace/events/sock.h:71
Inline: True
Inline callers:
  - net/core/net-traces.c:perf_trace_sock_rcvqueue_full
