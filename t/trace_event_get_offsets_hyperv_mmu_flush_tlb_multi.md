# Function: <code>trace_event_get_offsets_hyperv_mmu_flush_tlb_multi</code>
...
```
In arch/x86/hyperv/mmu.c (ffffffff81045e9c)
Location: arch/x86/include/asm/trace/hyperv.h:11
Inline: True
Inline callers:
...
```
In arch/x86/hyperv/mmu.c (ffffffff8104c56c)
Location: arch/x86/include/asm/trace/hyperv.h:11
Inline: True
Inline callers:
  - arch/x86/hyperv/mmu.c:perf_trace_hyperv_mmu_flush_tlb_multi
