# Function: <code>tpm_platform_end_xfer</code>
...
```
In drivers/char/tpm/tpm_tis.c (ffffffff815bec83)
Location: drivers/char/tpm/tpm_tis.c:175
Inline: True
Inline callers:
...
```
ffffffff815bec20-ffffffff815bec5d: tpm_platform_end_xfer.part.2 (STB_LOCAL)
```
</details>
</li>
<li>
