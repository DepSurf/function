# Function: <code>tcp_ao_digest_size</code>
...
```
In net/ipv4/tcp_ipv4.c (ffffffff81ff41cd)
Location: include/net/tcp_ao.h:76
Inline: True
Inline callers:
  - net/ipv4/tcp_ipv4.c:tcp_v4_reqsk_send_ack
```
```
In net/ipv4/tcp_ao.c (ffffffff820586e6)
Location: include/net/tcp_ao.h:76
Inline: True
Inline callers:
...
```
```
In net/ipv6/tcp_ipv6.c (ffffffff820cae0f)
Location: include/net/tcp_ao.h:76
Inline: True
Inline callers:
...
```
```
In net/ipv6/tcp_ao.c (ffffffff820f4cd5)
Location: include/net/tcp_ao.h:76
Inline: True
Inline callers:
