# Function: <code>trace_iomap_writepage</code>
...
```
In fs/iomap/buffered-io.c (ffffffff8151dec7)
Location: fs/iomap/trace.h:82
Inline: True
Inline callers:
  - fs/iomap/buffered-io.c:iomap_do_writepage
...
```
In fs/iomap/buffered-io.c (ffffffff8155605a)
Location: fs/iomap/trace.h:82
Inline: True
Inline callers:
  - fs/iomap/buffered-io.c:iomap_do_writepage
...
```
In fs/iomap/buffered-io.c (ffffffff8158c51d)
Location: fs/iomap/trace.h:82
Inline: True
Inline callers:
  - fs/iomap/buffered-io.c:iomap_do_writepage
