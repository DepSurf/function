# Function: <code>tick_dep_set</code>
...
```
In kernel/sched/build_utility.c (ffffffff8119147a)
Location: include/linux/tick.h:215
Inline: True
Inline callers:
  - kernel/sched/build_utility.c:clear_sched_clock_stable
```
```
In kernel/rcu/tree.c (ffffffff811e1e28)
Location: include/linux/tick.h:215
Inline: True
Inline callers:
...
```
In kernel/sched/clock.c (ffffffff810c7f6c)
Location: include/linux/tick.h:214
Inline: True
Inline callers:
