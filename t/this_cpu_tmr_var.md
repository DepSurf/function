# Function: <code>this_cpu_tmr_var</code>
...
```
In kernel/trace/trace_osnoise.c (ffffffff81298348)
Location: kernel/trace/trace_osnoise.c:250
Inline: True
Inline callers:
...
```
In kernel/trace/trace_osnoise.c (ffffffff812b39ba)
Location: kernel/trace/trace_osnoise.c:250
Inline: True
Inline callers:
  - kernel/trace/trace_osnoise.c:timerlat_fd_read
