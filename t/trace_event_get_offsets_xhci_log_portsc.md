# Function: <code>trace_event_get_offsets_xhci_log_portsc</code>
...
Location: drivers/usb/host/xhci-trace.h:475
Inline: True
```
</details>
</li>
...
```
In drivers/usb/host/xhci-trace.c (ffffffff81cfa3fa)
...
```
In drivers/usb/host/xhci-trace.c (ffffffff81dafd49)
Location: drivers/usb/host/xhci-trace.h:511
Inline: True
Inline callers:
  - drivers/usb/host/xhci-trace.c:perf_trace_xhci_log_portsc
