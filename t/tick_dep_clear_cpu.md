# Function: <code>tick_dep_clear_cpu</code>
...
Location: include/linux/tick.h:250
Inline: True
```
</details>
</li>
...
```
In kernel/events/core.c (0)
Location: include/linux/tick.h:263
Inline: True
```
</details>
</li>
...
```
In kernel/rcu/tree.c (0)
Location: include/linux/tick.h:283
Inline: True
```
```
In kernel/events/core.c (0)
...
```
In kernel/rcu/tree.c (0)
Location: include/linux/tick.h:289
Inline: True
```
```
In kernel/events/core.c (0)
...
```
In kernel/rcu/tree.c (ffffffff811d67c9)
Location: include/linux/tick.h:233
Inline: True
Inline callers:
...
```
```
In kernel/events/core.c (ffffffff8139ae22)
Location: include/linux/tick.h:233
Inline: True
Inline callers:
...
Location: include/linux/tick.h:232
Inline: True
Inline callers:
  - kernel/events/core.c:perf_event_task_tick
```
