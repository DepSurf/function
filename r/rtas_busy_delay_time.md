...
```
In arch/powerpc/kernel/rtas.c (c00000000003cf0c)
Location: arch/powerpc/kernel/rtas.c:489
Inline: True
Inline callers:
...
```
c00000000003e360-c00000000003e3b8: rtas_busy_delay_time (STB_GLOBAL)
```
</details>
</li>
<li>
