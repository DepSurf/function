# Function: <code>rtnl_notify_needed</code>
...
```
In net/sched/sch_api.c (ffffffff81f7637b)
Location: include/linux/rtnetlink.h:169
Inline: True
Inline callers:
...
```
```
In net/sched/cls_api.c (ffffffff81f7ae7e)
Location: include/linux/rtnetlink.h:169
Inline: True
Inline callers:
...
```
```
In net/sched/act_api.c (ffffffff81f8363d)
Location: include/linux/rtnetlink.h:169
Inline: True
Inline callers:
