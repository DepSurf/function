...
```
In drivers/clk/rockchip/clk.c (ffff800011489de8)
Location: drivers/clk/rockchip/clk.c:625
Inline: False
Direct callers:
...
```
ffff800011489de8-ffff800011489e60: rockchip_register_restart_notifier (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In drivers/clk/rockchip/clk.c (c1583040)
Location: drivers/clk/rockchip/clk.c:625
Inline: False
Direct callers:
  - drivers/clk/rockchip/clk-px30.c:px30_clk_init
...
```
c1583040-c1583098: rockchip_register_restart_notifier (STB_GLOBAL)
```
</details>
</li>
<li>
