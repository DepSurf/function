...
```
In drivers/clk/rockchip/softrst.c (ffff800011489e60)
Location: drivers/clk/rockchip/softrst.c:80
Inline: False
Direct callers:
...
```
ffff800011489e60-ffff800011489f18: rockchip_register_softrst (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In drivers/clk/rockchip/softrst.c (c1583098)
Location: drivers/clk/rockchip/softrst.c:80
Inline: False
Direct callers:
  - drivers/clk/rockchip/clk-px30.c:px30_clk_init
...
```
c1583098-c1583144: rockchip_register_softrst (STB_GLOBAL)
```
</details>
</li>
<li>
