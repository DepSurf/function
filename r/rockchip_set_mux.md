...
```
In drivers/pinctrl/pinctrl-rockchip.c (ffff8000106983a0)
Location: drivers/pinctrl/pinctrl-rockchip.c:1226
Inline: False
Direct callers:
...
```
ffff8000106983a0-ffff800010698670: rockchip_set_mux (STB_LOCAL)
```
</details>
</li>
<li>
...
```
In drivers/pinctrl/pinctrl-rockchip.c (c0838ab4)
Location: drivers/pinctrl/pinctrl-rockchip.c:1226
Inline: False
Direct callers:
  - drivers/pinctrl/pinctrl-rockchip.c:rockchip_irq_set_type
...
```
c0838ab4-c0838da0: rockchip_set_mux (STB_LOCAL)
```
</details>
</li>
<li>
