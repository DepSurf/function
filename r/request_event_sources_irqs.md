...
```
In arch/powerpc/platforms/pseries/event_sources.c (c0000000000f1d30)
Location: arch/powerpc/platforms/pseries/event_sources.c:11
Inline: False
Direct callers:
...
```
c0000000000f1d30-c0000000000f1e74: request_event_sources_irqs (STB_GLOBAL)
```
</details>
</li>
<li>
