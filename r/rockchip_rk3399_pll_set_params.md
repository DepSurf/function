...
```
In drivers/clk/rockchip/clk-pll.c (ffff8000107ed7e0)
Location: drivers/clk/rockchip/clk-pll.c:655
Inline: False
Direct callers:
...
```
ffff8000107ed7e0-ffff8000107ed990: rockchip_rk3399_pll_set_params (STB_LOCAL)
```
</details>
</li>
<li>
...
```
In drivers/clk/rockchip/clk-pll.c (c09065a8)
Location: drivers/clk/rockchip/clk-pll.c:655
Inline: False
Direct callers:
  - drivers/clk/rockchip/clk-pll.c:rockchip_rk3399_pll_init
...
```
c09065a8-c0906784: rockchip_rk3399_pll_set_params (STB_LOCAL)
```
</details>
</li>
<li>
