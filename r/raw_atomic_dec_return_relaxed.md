# Function: <code>raw_atomic_dec_return_relaxed</code>
...
Location: include/linux/atomic/atomic-arch-fallback.h:1295
Inline: True
```
```
...
Location: include/linux/atomic/atomic-arch-fallback.h:1304
Inline: True
```
```
