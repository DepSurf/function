# Function: <code>raw_atomic_sub_return_relaxed</code>
...
Location: include/linux/atomic/atomic-arch-fallback.h:855
Inline: True
```
```
...
Location: include/linux/atomic/atomic-arch-fallback.h:864
Inline: True
```
```
