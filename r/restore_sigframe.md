...
```
In arch/arm64/kernel/signal.c (ffff800010092aa0)
Location: arch/arm64/kernel/signal.c:482
Inline: False
Direct callers:
...
```
ffff800010092aa0-ffff80001009315c: restore_sigframe (STB_LOCAL)
```
</details>
</li>
<li>
...
```
In arch/arm/kernel/signal.c (c030e184)
Location: arch/arm/kernel/signal.c:173
Inline: False
Direct callers:
...
```
c030e184-c030e390: restore_sigframe (STB_LOCAL)
```
</details>
</li>
<li>
