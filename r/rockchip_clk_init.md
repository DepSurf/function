...
```
In drivers/clk/rockchip/clk.c (ffff800011489150)
Location: drivers/clk/rockchip/clk.c:364
Inline: False
Direct callers:
...
```
ffff800011489150-ffff800011489220: rockchip_clk_init (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In drivers/clk/rockchip/clk.c (c1582340)
Location: drivers/clk/rockchip/clk.c:364
Inline: False
Direct callers:
  - drivers/clk/rockchip/clk-px30.c:px30_pmu_clk_init
...
```
c1582340-c15823fc: rockchip_clk_init (STB_GLOBAL)
```
</details>
</li>
<li>
