...
```
In arch/powerpc/kvm/book3s_hv_rm_mmu.c (c00000000011c450)
Location: arch/powerpc/kvm/book3s_hv_rm_mmu.c:26
Inline: False
Direct callers:
...
```
c00000000011c450-c00000000011c518: real_vmalloc_addr (STB_LOCAL)
```
</details>
</li>
<li>
