...
```
In drivers/pinctrl/pinctrl-rockchip.c (ffff80001069a150)
Location: drivers/pinctrl/pinctrl-rockchip.c:681
Inline: True
Inline callers:
...
```
In drivers/pinctrl/pinctrl-rockchip.c (c083765c)
Location: drivers/pinctrl/pinctrl-rockchip.c:681
Inline: False
Direct callers:
  - drivers/pinctrl/pinctrl-rockchip.c:rockchip_pinconf_get
...
```
c083765c-c08376dc: rockchip_get_recalced_mux (STB_LOCAL)
```
</details>
</li>
<li>
