...
Location: kernel/trace/ring_buffer.c:5873
Inline: False
Direct callers:
...
```
ffffffff821b7787-ffffffff821b77a5: ring_buffer_subbuf_order_set.cold (STB_LOCAL)
ffffffff812902f0-ffffffff812906db: ring_buffer_subbuf_order_set (STB_GLOBAL)
```
</details>
</li>
</ul>
