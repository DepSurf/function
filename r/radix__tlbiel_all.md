...
```
In arch/powerpc/mm/book3s64/radix_tlb.c (c00000000009ab00)
Location: arch/powerpc/mm/book3s64/radix_tlb.c:70
Inline: False
Direct callers:
...
```
c00000000009ab00-c00000000009ac1c: radix__tlbiel_all (STB_GLOBAL)
```
</details>
</li>
<li>
