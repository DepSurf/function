# Function: <code>raw_atomic_inc_return</code>
...
Location: include/linux/atomic/atomic-arch-fallback.h:1000
Inline: True
```
```
...
Location: include/linux/atomic/atomic-arch-fallback.h:1009
Inline: True
```
```
