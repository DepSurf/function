# Function: <code>__reuseport_get_incoming_cpu</code>
...
```
In net/core/sock_reuseport.c (ffffffff81e04d41)
...
```
In net/core/sock_reuseport.c (ffffffff81e77591)
Location: net/core/sock_reuseport.c:40
Inline: True
Inline callers:
  - net/core/sock_reuseport.c:reuseport_stop_listen_sock
...
```
In net/core/sock_reuseport.c (ffffffff81f37551)
Location: net/core/sock_reuseport.c:40
Inline: True
Inline callers:
  - net/core/sock_reuseport.c:reuseport_stop_listen_sock
