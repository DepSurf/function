...
```
In drivers/clk/rockchip/clk.c (ffff80001148935c)
Location: drivers/clk/rockchip/clk.c:437
Inline: False
Direct callers:
...
```
ffff80001148935c-ffff800011489cc0: rockchip_clk_register_branches (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In drivers/clk/rockchip/clk.c (c1582520)
Location: drivers/clk/rockchip/clk.c:437
Inline: False
Direct callers:
  - drivers/clk/rockchip/clk-px30.c:px30_pmu_clk_init
...
```
c1582520-c1582f40: rockchip_clk_register_branches (STB_GLOBAL)
```
</details>
</li>
<li>
