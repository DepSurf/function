# Function: <code>rtnl_has_listeners</code>
...
```
In net/sched/sch_api.c (ffffffff81f7666b)
Location: include/linux/rtnetlink.h:152
Inline: True
Inline callers:
...
```
```
In net/sched/cls_api.c (ffffffff81f7af63)
Location: include/linux/rtnetlink.h:152
Inline: True
Inline callers:
...
```
```
In net/sched/act_api.c (ffffffff81f83726)
Location: include/linux/rtnetlink.h:152
Inline: True
Inline callers:
