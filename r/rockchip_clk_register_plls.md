...
```
In drivers/clk/rockchip/clk.c (ffff800011489278)
Location: drivers/clk/rockchip/clk.c:413
Inline: False
Direct callers:
...
```
ffff800011489278-ffff80001148935c: rockchip_clk_register_plls (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In drivers/clk/rockchip/clk.c (c1582444)
Location: drivers/clk/rockchip/clk.c:413
Inline: False
Direct callers:
  - drivers/clk/rockchip/clk-px30.c:px30_pmu_clk_init
...
```
c1582444-c1582520: rockchip_clk_register_plls (STB_GLOBAL)
```
</details>
</li>
<li>
