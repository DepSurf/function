...
```
In drivers/clk/rockchip/clk.c (ffff800011489220)
Location: drivers/clk/rockchip/clk.c:398
Inline: False
Direct callers:
...
```
ffff800011489220-ffff800011489278: rockchip_clk_of_add_provider (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In drivers/clk/rockchip/clk.c (c15823fc)
Location: drivers/clk/rockchip/clk.c:398
Inline: False
Direct callers:
  - drivers/clk/rockchip/clk-px30.c:px30_pmu_clk_init
...
```
c15823fc-c1582444: rockchip_clk_of_add_provider (STB_GLOBAL)
```
</details>
</li>
<li>
