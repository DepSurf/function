# Function: <code>raw_atomic64_andnot</code>
...
Location: include/linux/atomic/atomic-arch-fallback.h:3653
Inline: True
```
```
...
Location: include/linux/atomic/atomic-arch-fallback.h:3658
Inline: True
```
```
