...
```
In arch/powerpc/mm/book3s64/radix_tlb.c (c000000000097f60)
Location: arch/powerpc/mm/book3s64/radix_tlb.c:811
Inline: True
Direct callers:
...
```
c000000000097f60-c000000000098440: radix__flush_tlb_kernel_range (STB_GLOBAL)
```
</details>
</li>
<li>
