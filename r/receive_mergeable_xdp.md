...
```
In drivers/net/virtio_net.c (ffffffff81c552f0)
Location: drivers/net/virtio_net.c:1366
Inline: False
Direct callers:
...
```
ffffffff81c552f0-ffffffff81c5578d: receive_mergeable_xdp (STB_LOCAL)
```
</details>
</li>
<li>
...
```
In drivers/net/virtio_net.c (ffffffff81d0b990)
Location: drivers/net/virtio_net.c:1580
Inline: False
Direct callers:
  - drivers/net/virtio_net.c:receive_mergeable
```
...
```
ffffffff81d0b990-ffffffff81d0be22: receive_mergeable_xdp (STB_LOCAL)
```
</details>
</li>
</ul>
