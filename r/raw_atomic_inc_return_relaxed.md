# Function: <code>raw_atomic_inc_return_relaxed</code>
...
Location: include/linux/atomic/atomic-arch-fallback.h:1077
Inline: True
```
```
...
Location: include/linux/atomic/atomic-arch-fallback.h:1086
Inline: True
```
```
