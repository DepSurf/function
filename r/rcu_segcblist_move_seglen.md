# Function: <code>rcu_segcblist_move_seglen</code>
...
```
In kernel/rcu/rcu_segcblist.c (ffffffff81135476)
Location: kernel/rcu/rcu_segcblist.c:122
Inline: True
Inline callers:
...
```
In kernel/rcu/rcu_segcblist.c (ffffffff81157e24)
Location: kernel/rcu/rcu_segcblist.c:122
Inline: True
Inline callers:
  - kernel/rcu/rcu_segcblist.c:rcu_segcblist_accelerate
