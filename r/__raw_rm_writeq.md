# Function: <code>__raw_rm_writeq</code>
...
```
In arch/powerpc/platforms/powernv/pci-ioda.c (c0000000000d976c)
Location: arch/powerpc/include/asm/io.h:364
Inline: True
Inline callers:
...
```
```
In arch/powerpc/kvm/book3s_hv_rm_xive.c (c000000000124f34)
Location: arch/powerpc/include/asm/io.h:364
Inline: True
Inline callers:
