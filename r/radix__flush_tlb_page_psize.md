...
```
In arch/powerpc/mm/book3s64/radix_tlb.c (c00000000009ada0)
Location: arch/powerpc/mm/book3s64/radix_tlb.c:747
Inline: False
Direct callers:
...
```
c00000000009ada0-c00000000009b43c: radix__flush_tlb_page_psize (STB_GLOBAL)
```
</details>
</li>
<li>
