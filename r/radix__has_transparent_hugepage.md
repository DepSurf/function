# Function: <code>radix__has_transparent_hugepage</code>
...
```
In mm/shmem.c (c00000000038e6b4)
Location: arch/powerpc/include/asm/book3s/64/radix.h:257
Inline: True
Inline callers:
...
```
```
In mm/huge_memory.c (c000000001385ae4)
Location: arch/powerpc/include/asm/book3s/64/radix.h:257
Inline: True
Inline callers:
...
```
```
In drivers/nvdimm/pfn_devs.c (c000000000a15b74)
Location: arch/powerpc/include/asm/book3s/64/radix.h:257
Inline: True
Inline callers:
