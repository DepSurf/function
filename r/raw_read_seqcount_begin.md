# Function: <code>raw_read_seqcount_begin</code>
...
Location: include/linux/seqlock.h:145
Inline: True
Inline callers:
  - kernel/sched/cputime.c:thread_group_cputime
```
```
In kernel/time/hrtimer.c (ffffffff810eea1f)
Location: include/linux/seqlock.h:145
Inline: True
Inline callers:
...
```
```
In kernel/time/hrtimer.c (ffffffff810f5b1f)
Location: include/linux/seqlock.h:145
Inline: True
Inline callers:
  - kernel/time/hrtimer.c:hrtimer_active
...
```
```
In kernel/time/hrtimer.c (ffffffff810fcadf)
Location: include/linux/seqlock.h:145
Inline: True
Inline callers:
  - kernel/time/hrtimer.c:hrtimer_active
...
Location: include/linux/seqlock.h:146
Inline: True
Inline callers:
  - kernel/sched/cputime.c:thread_group_cputime
```
...
```
```
In kernel/time/hrtimer.c (ffffffff811153dd)
Location: include/linux/seqlock.h:146
Inline: True
Inline callers:
  - kernel/time/hrtimer.c:hrtimer_active
...
```
```
In kernel/time/hrtimer.c (ffffffff81120a1d)
Location: include/linux/seqlock.h:146
Inline: True
Inline callers:
  - kernel/time/hrtimer.c:hrtimer_active
...
```
```
In kernel/time/hrtimer.c (ffffffff8112b269)
Location: include/linux/seqlock.h:146
Inline: True
Inline callers:
  - kernel/time/hrtimer.c:hrtimer_active
...
```
```
In kernel/time/hrtimer.c (ffffffff81137349)
Location: include/linux/seqlock.h:146
Inline: True
Inline callers:
  - kernel/time/hrtimer.c:hrtimer_active
...
```
In kernel/sched/cputime.c (0)
Location: include/linux/seqlock.h:164
Inline: True
Inline callers:
  - kernel/sched/cputime.c:thread_group_cputime
```
...
```
```
In kernel/time/hrtimer.c (ffff8000101a07cc)
Location: include/linux/seqlock.h:146
Inline: True
Inline callers:
  - kernel/time/hrtimer.c:hrtimer_active
...
```
```
In kernel/time/hrtimer.c (c03ea324)
Location: include/linux/seqlock.h:146
Inline: True
Inline callers:
  - kernel/time/hrtimer.c:hrtimer_active
...
```
```
In kernel/time/hrtimer.c (c000000000201694)
Location: include/linux/seqlock.h:146
Inline: True
Inline callers:
  - kernel/time/hrtimer.c:hrtimer_active
...
```
```
In kernel/time/hrtimer.c (ffffffff8112faf9)
Location: include/linux/seqlock.h:146
Inline: True
Inline callers:
  - kernel/time/hrtimer.c:hrtimer_active
...
```
```
In kernel/time/hrtimer.c (ffffffff81122569)
Location: include/linux/seqlock.h:146
Inline: True
Inline callers:
  - kernel/time/hrtimer.c:hrtimer_active
...
```
```
In kernel/time/hrtimer.c (ffffffff8112d819)
Location: include/linux/seqlock.h:146
Inline: True
Inline callers:
  - kernel/time/hrtimer.c:hrtimer_active
...
```
```
In kernel/time/hrtimer.c (ffffffff8113a149)
Location: include/linux/seqlock.h:146
Inline: True
Inline callers:
  - kernel/time/hrtimer.c:hrtimer_active
