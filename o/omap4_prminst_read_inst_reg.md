...
```
In arch/arm/mach-omap2/prminst44xx.c (c0343164)
Location: arch/arm/mach-omap2/prminst44xx.c:58
Inline: True
Inline callers:
...
```
c0342de0-c0342df8: omap4_prminst_read_inst_reg.part.0 (STB_LOCAL)
c0342e88-c0342ed8: omap4_prminst_read_inst_reg (STB_GLOBAL)
```
</details>
</li>
<li>
