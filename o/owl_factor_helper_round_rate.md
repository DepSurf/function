...
```
In drivers/clk/actions/owl-factor.c (ffff8000107ca1c8)
Location: drivers/clk/actions/owl-factor.c:120
Inline: False
Direct callers:
...
```
ffff8000107ca1c8-ffff8000107ca3ec: owl_factor_helper_round_rate (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In drivers/clk/actions/owl-factor.c (c08f5ff0)
Location: drivers/clk/actions/owl-factor.c:120
Inline: False
Direct callers:
  - drivers/clk/actions/owl-factor.c:owl_factor_round_rate
...
```
c08f5ff0-c08f61e4: owl_factor_helper_round_rate (STB_GLOBAL)
```
</details>
</li>
<li>
