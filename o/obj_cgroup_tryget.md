# Function: <code>obj_cgroup_tryget</code>
...
```
In mm/memcontrol.c (ffffffff81308d28)
...
```
In mm/memcontrol.c (ffffffff8130f606)
...
```
In mm/memcontrol.c (ffffffff8135a4f6)
...
```
In mm/memcontrol.c (ffffffff813cae74)
...
```
In mm/memcontrol.c (ffffffff8144f524)
Location: include/linux/memcontrol.h:776
Inline: True
Inline callers:
  - mm/memcontrol.c:__get_obj_cgroup_from_memcg
```
...
```
In mm/memcontrol.c (ffffffff81485054)
...
```
In mm/memcontrol.c (ffffffff814be86a)
