...
```
In arch/powerpc/platforms/powernv/opal-async.c (c0000000000c6830)
Location: arch/powerpc/platforms/powernv/opal-async.c:128
Inline: False
Direct callers:
...
```
c0000000000c6830-c0000000000c69b8: opal_async_wait_response (STB_GLOBAL)
```
</details>
</li>
<li>
