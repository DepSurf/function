...
```
In arch/powerpc/platforms/powernv/opal-call.c (c0000000000c49b0)
Location: arch/powerpc/platforms/powernv/opal-call.c:275
Inline: False
Direct callers:
...
```
c0000000000c49b0-c0000000000c49e8: opal_imc_counters_stop (STB_GLOBAL)
```
</details>
</li>
<li>
