...
```
In arch/powerpc/platforms/powernv/opal-async.c (c0000000000c65a0)
Location: arch/powerpc/platforms/powernv/opal-async.c:66
Inline: False
Direct callers:
...
```
c0000000000c65a0-c0000000000c66c8: opal_async_get_token_interruptible (STB_GLOBAL)
```
</details>
</li>
<li>
