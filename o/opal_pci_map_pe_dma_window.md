...
```
In arch/powerpc/platforms/powernv/opal-call.c (c0000000000c3130)
Location: arch/powerpc/platforms/powernv/opal-call.c:177
Inline: False
Direct callers:
...
```
c0000000000c3130-c0000000000c3168: opal_pci_map_pe_dma_window (STB_GLOBAL)
```
</details>
</li>
<li>
