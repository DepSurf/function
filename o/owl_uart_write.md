# Function: <code>owl_uart_write</code>
...
```
In drivers/tty/serial/owl-uart.c (ffff8000108a6f24)
Location: drivers/tty/serial/owl-uart.c:80
Inline: True
Inline callers:
...
```
In drivers/tty/serial/owl-uart.c (c09a281c)
Location: drivers/tty/serial/owl-uart.c:80
Inline: True
Inline callers:
  - drivers/tty/serial/owl-uart.c:owl_uart_port_write
