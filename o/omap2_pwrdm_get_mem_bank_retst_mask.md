...
```
In arch/arm/mach-omap2/powerdomain-common.c (c0346624)
Location: arch/arm/mach-omap2/powerdomain-common.c:67
Inline: False
Direct callers:
...
```
c0346624-c0346674: omap2_pwrdm_get_mem_bank_retst_mask (STB_GLOBAL)
```
</details>
</li>
<li>
