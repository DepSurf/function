# Function: <code>omap4_cminst_read_inst_reg</code>
...
```
In arch/arm/mach-omap2/cminst44xx.c (c0341ae4)
Location: arch/arm/mach-omap2/cminst44xx.c:113
Inline: True
Inline callers:
...
```
c0341ab4-c0341acc: omap4_cminst_read_inst_reg.part.0 (STB_LOCAL)
```
</details>
</li>
<li>
