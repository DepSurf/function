...
```
In drivers/of/base.c (ffff800010b6be40)
Location: drivers/of/base.c:1946
Inline: False
```
**Symbols:**

```
ffff800010b6be40-ffff800010b6bfac: of_update_property (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
c0c4f0b0-c0c4f1a4: of_update_property (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In drivers/of/base.c (c000000000c45f50)
Location: drivers/of/base.c:1946
Inline: False
Direct callers:
...
```
c000000000c45f50-c000000000c460b8: of_update_property (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In drivers/of/base.c (ffffffe000721152)
Location: drivers/of/base.c:1946
Inline: False
```
**Symbols:**
...
```
ffffffe000721152-ffffffe000721218: of_update_property (STB_GLOBAL)
```
</details>
</li>
</ul>
