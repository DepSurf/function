# Function: <code>__omap_dm_timer_write</code>
...
```
In arch/arm/mach-omap2/timer.c (c1512f68)
Location: include/clocksource/timer-ti-dm.h:265
Inline: True
Inline callers:
...
```
```
In drivers/clocksource/timer-ti-dm.c (c0c47a48)
Location: include/clocksource/timer-ti-dm.h:265
Inline: True
Inline callers:
