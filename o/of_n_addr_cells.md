...
```
In drivers/of/base.c (ffff800010b68420)
Location: drivers/of/base.c:89
Inline: False
Direct callers:
...
```
ffff800010b68420-ffff800010b684d8: of_n_addr_cells (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
c0c4c39c-c0c4c444: of_n_addr_cells (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In drivers/of/base.c (c000000000c40bb0)
Location: drivers/of/base.c:89
Inline: False
Direct callers:
...
```
c000000000c40bb0-c000000000c40c90: of_n_addr_cells (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In drivers/of/base.c (ffffffe00071e6ac)
Location: drivers/of/base.c:89
Inline: False
Direct callers:
  - drivers/of/base.c:arch_find_n_match_cpu_physical_id
...
```
ffffffe00071e6ac-ffffffe00071e722: of_n_addr_cells (STB_GLOBAL)
```
</details>
</li>
</ul>
