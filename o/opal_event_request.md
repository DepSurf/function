...
```
In arch/powerpc/platforms/powernv/opal-irqchip.c (c0000000000cce70)
Location: arch/powerpc/platforms/powernv/opal-irqchip.c:306
Inline: False
Direct callers:
...
```
c0000000000cce70-c0000000000ccecc: opal_event_request (STB_GLOBAL)
```
</details>
</li>
<li>
