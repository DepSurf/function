# Function: <code>ZSTD_HcFindBestMatch_selectMLS</code>
...
```
In lib/zstd/compress.c (ffffffff815b230b)
Location: lib/zstd/compress.c:1869
Inline: True
Inline callers:
...
```
In lib/zstd/compress.c (ffffffff815ccc7f)
Location: lib/zstd/compress.c:1869
Inline: True
Inline callers:
  - lib/zstd/compress.c:ZSTD_compressBlock_greedy
...
```
In lib/zstd/compress/zstd_lazy.c (ffffffff81737b40)
Location: lib/zstd/compress/zstd_lazy.c:787
Inline: True
Inline callers:
