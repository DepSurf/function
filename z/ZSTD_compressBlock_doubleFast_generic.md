# Function: <code>ZSTD_compressBlock_doubleFast_generic</code>
...
```
In lib/zstd/compress.c (ffffffff815afe37)
Location: lib/zstd/compress.c:1254
Inline: True
Inline callers:
...
```
In lib/zstd/compress.c (ffffffff815d87a8)
Location: lib/zstd/compress.c:1254
Inline: True
Inline callers:
  - lib/zstd/compress.c:ZSTD_compressBlock_doubleFast
...
```
In lib/zstd/compress/zstd_double_fast.c (ffffffff81721971)
