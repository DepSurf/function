# Function: <code>ZSTD_confirmRepcodesAndEntropyTables</code>
...
```
In lib/zstd/compress/zstd_compress.c (ffffffff81718289)
Location: lib/zstd/compress/zstd_compress.c:2605
Inline: True
Inline callers:
