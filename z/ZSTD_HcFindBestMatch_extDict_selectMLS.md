# Function: <code>ZSTD_HcFindBestMatch_extDict_selectMLS</code>
...
```
In lib/zstd/compress.c (ffffffff815befa7)
Location: lib/zstd/compress.c:1881
Inline: True
Inline callers:
...
```
In lib/zstd/compress.c (ffffffff815d167c)
Location: lib/zstd/compress.c:1881
Inline: True
Inline callers:
  - lib/zstd/compress.c:ZSTD_compressBlock_lazy2_extDict
...
```
In lib/zstd/compress/zstd_lazy.c (ffffffff817406fa)
Location: lib/zstd/compress/zstd_lazy.c:835
Inline: True
Inline callers:
