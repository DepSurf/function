...
```
In drivers/mailbox/zynqmp-ipi-mailbox.c (ffff800010b7d258)
Location: drivers/mailbox/zynqmp-ipi-mailbox.c:436
Inline: False
Direct callers:
...
```
ffff800010b7d258-ffff800010b7d2c8: zynqmp_ipi_mbox_get_buf_res (STB_LOCAL)
```
</details>
</li>
<li>
