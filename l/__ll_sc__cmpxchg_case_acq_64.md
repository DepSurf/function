# Function: <code>__ll_sc__cmpxchg_case_acq_64</code>
...
```
In init/main.c (0)
Location: arch/arm64/include/asm/atomic_ll_sc.h:306
Inline: True
```
```
...
```
```
In kernel/locking/mutex.c (ffff800010da424c)
Location: arch/arm64/include/asm/atomic_ll_sc.h:306
Inline: True
Inline callers:
...
```
```
In kernel/locking/rwsem.c (ffff800010169024)
Location: arch/arm64/include/asm/atomic_ll_sc.h:306
Inline: True
Inline callers:
...
```
```
In kernel/locking/rtmutex.c (ffff800010da5b24)
Location: arch/arm64/include/asm/atomic_ll_sc.h:306
Inline: True
Inline callers:
