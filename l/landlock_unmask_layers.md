...
Location: security/landlock/ruleset.c:623
Inline: False
Direct callers:
...
```
ffffffff821d1f2d-ffffffff821d1f6e: landlock_unmask_layers.cold (STB_LOCAL)
ffffffff8176c050-ffffffff8176c186: landlock_unmask_layers (STB_GLOBAL)
```
</details>
</li>
</ul>
