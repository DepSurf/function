# Function: <code>__lse__cmpxchg_case_acq_64</code>
...
```
In init/main.c (0)
Location: arch/arm64/include/asm/atomic_lse.h:371
Inline: True
```
```
...
```
```
In kernel/locking/mutex.c (ffff800010da421c)
Location: arch/arm64/include/asm/atomic_lse.h:371
Inline: True
Inline callers:
...
```
```
In kernel/locking/rwsem.c (ffff800010168ff0)
Location: arch/arm64/include/asm/atomic_lse.h:371
Inline: True
Inline callers:
...
```
```
In kernel/locking/rtmutex.c (ffff800010da5a84)
Location: arch/arm64/include/asm/atomic_lse.h:371
Inline: True
Inline callers:
