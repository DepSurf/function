# Function: <code>__ll_sc__cmpxchg_case_32</code>
...
Location: arch/arm64/include/asm/atomic_ll_sc.h:301
Inline: True
```
```
...
```
```
In kernel/locking/qspinlock.c (ffff80001016ac24)
Location: arch/arm64/include/asm/atomic_ll_sc.h:301
Inline: True
Inline callers:
...
```
```
In kernel/locking/qrwlock.c (ffff80001016c9bc)
Location: arch/arm64/include/asm/atomic_ll_sc.h:301
Inline: True
Inline callers:
...
```
```
In lib/refcount.c (ffff800010637af8)
Location: arch/arm64/include/asm/atomic_ll_sc.h:301
Inline: True
```
```
...
```
```
In drivers/iommu/arm-smmu-v3.c (ffff8000108d5298)
Location: arch/arm64/include/asm/atomic_ll_sc.h:301
Inline: True
Inline callers:
