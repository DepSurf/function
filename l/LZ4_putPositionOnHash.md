# Function: <code>LZ4_putPositionOnHash</code>
...
```
In lib/lz4/lz4_compress.c (ffffffff815a3f18)
Location: lib/lz4/lz4_compress.c:91
Inline: True
Inline callers:
...
```
In lib/lz4/lz4_compress.c (ffffffff815bfab1)
Location: lib/lz4/lz4_compress.c:91
Inline: True
Inline callers:
  - lib/lz4/lz4_compress.c:LZ4_compress_fast_continue
