# Function: <code>latched_seq_write</code>
...
Location: kernel/printk/printk.c:444
Inline: True
Inline callers:
...
Location: kernel/printk/printk.c:439
Inline: True
Inline callers:
  - kernel/printk/printk.c:syslog_print_all
```
...
Location: kernel/printk/printk.c:525
Inline: True
Inline callers:
  - kernel/printk/printk.c:do_syslog
  - kernel/printk/printk.c:syslog_print_all
...
Location: kernel/printk/printk.c:512
Inline: True
Inline callers:
  - kernel/printk/printk.c:do_syslog
  - kernel/printk/printk.c:syslog_print_all
