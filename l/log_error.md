...
```
In arch/powerpc/kernel/rtas.c (c00000000003f1cc)
Location: arch/powerpc/include/asm/machdep.h:269
Inline: True
Inline callers:
...
```
```
In arch/powerpc/platforms/pseries/ras.c (c0000000000f1e98)
Location: arch/powerpc/include/asm/machdep.h:269
Inline: True
Inline callers:
  - arch/powerpc/platforms/pseries/ras.c:mce_process_errlog_event
...
```
```
In arch/powerpc/platforms/pseries/eeh_pseries.c (c0000000000f6468)
Location: arch/powerpc/include/asm/machdep.h:269
Inline: True
Inline callers:
