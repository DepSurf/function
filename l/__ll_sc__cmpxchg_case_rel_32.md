# Function: <code>__ll_sc__cmpxchg_case_rel_32</code>
...
Location: arch/arm64/include/asm/atomic_ll_sc.h:309
Inline: True
```
```
In kernel/locking/osq_lock.c (ffff80001016a794)
Location: arch/arm64/include/asm/atomic_ll_sc.h:309
Inline: True
Inline callers:
...
```
```
In lib/refcount.c (ffff8000106377a4)
Location: arch/arm64/include/asm/atomic_ll_sc.h:309
Inline: True
Inline callers:
