# Function: <code>l3mdev_fib_oif_rcu</code>
...
```
In net/ipv4/route.c (ffffffff8175583a)
Location: include/net/l3mdev.h:58
Inline: True
```
```
...
```
In net/ipv4/route.c (ffffffff817c19d4)
Location: include/net/l3mdev.h:111
Inline: True
```
```
