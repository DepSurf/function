# Function: <code>lwtunnel_headroom</code>
...
Location: include/net/lwtunnel.h:97
Inline: True
```
```
...
Location: include/net/lwtunnel.h:98
Inline: True
```
```
...
```
```
In net/ipv4/ip_output.c (ffffffff81a90aa4)
Location: include/net/lwtunnel.h:98
Inline: True
```
```
...
Location: include/net/lwtunnel.h:101
Inline: True
Inline callers:
  - net/ipv4/route.c:ip_mtu_from_fib_result
...
```
```
In net/ipv4/ip_output.c (ffffffff81b4bc3a)
Location: include/net/lwtunnel.h:101
Inline: True
```
```
...
```
```
In net/ipv4/ip_output.c (ffffffff81cd933a)
Location: include/net/lwtunnel.h:101
Inline: True
```
```
...
```
```
In net/ipv4/ip_output.c (ffffffff81e99a8a)
Location: include/net/lwtunnel.h:101
Inline: True
```
```
...
Location: include/net/lwtunnel.h:104
Inline: True
Inline callers:
  - net/ipv4/route.c:ip_mtu_from_fib_result
  - net/ipv4/route.c:ipv4_default_advmss
...
```
```
In net/ipv4/ip_output.c (ffffffff81ef83f7)
Location: include/net/lwtunnel.h:104
Inline: True
```
```
...
```
```
In net/ipv4/ip_output.c (ffffffff81fbc316)
Location: include/net/lwtunnel.h:104
Inline: True
```
```
