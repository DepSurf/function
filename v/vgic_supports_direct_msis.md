...
```
In virt/kvm/arm/vgic/vgic-mmio-v3.c (ffff8000100e47a0)
Location: virt/kvm/arm/vgic/vgic-mmio-v3.c:49
Inline: False
Direct callers:
...
```
ffff8000100e47a0-ffff8000100e47f8: vgic_supports_direct_msis (STB_GLOBAL)
```
</details>
</li>
<li>
