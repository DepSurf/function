...
```
In arch/x86/kernel/apic/vector.c (ffffffff810ac080)
Location: arch/x86/kernel/apic/vector.c:1044
Inline: False
Direct callers:
...
```
ffffffff810ac080-ffffffff810ac0a3: vector_schedule_cleanup (STB_GLOBAL)
```
</details>
</li>
</ul>
