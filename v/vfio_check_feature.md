# Function: <code>vfio_check_feature</code>
...
```
In drivers/vfio/vfio.c (ffffffff81a76d8d)
Location: include/linux/vfio.h:120
Inline: True
Inline callers:
...
```
```
In drivers/vfio/pci/vfio_pci_core.c (ffffffff81a80252)
Location: include/linux/vfio.h:120
Inline: True
Inline callers:
