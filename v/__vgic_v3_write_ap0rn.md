...
```
In virt/kvm/arm/hyp/vgic-v3-sr.c (ffff800010daca3c)
Location: virt/kvm/arm/hyp/vgic-v3-sr.c:113
Inline: True
Inline callers:
...
```
ffff800010daba98-ffff800010dabae8: __vgic_v3_write_ap0rn (STB_LOCAL)
```
</details>
</li>
<li>
