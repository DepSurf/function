# Function: <code>virtio_scsi_host</code>
...
```
In drivers/scsi/virtio_scsi.c (ffffffff81be3275)
Location: drivers/scsi/virtio_scsi.c:93
Inline: True
Inline callers:
...
```
In drivers/scsi/virtio_scsi.c (ffffffff81c386d5)
Location: drivers/scsi/virtio_scsi.c:99
Inline: True
Inline callers:
  - drivers/scsi/virtio_scsi.c:virtscsi_restore
  - drivers/scsi/virtio_scsi.c:virtscsi_remove
...
Location: drivers/scsi/virtio_scsi.c:92
Inline: True
```
</details>
</li>
