...
```
In virt/kvm/arm/hyp/vgic-v3-sr.c (ffff800010dac9dc)
Location: virt/kvm/arm/hyp/vgic-v3-sr.c:173
Inline: True
Inline callers:
...
```
ffff800010dabfc0-ffff800010dac000: __vgic_v3_read_ap1rn (STB_LOCAL)
```
</details>
</li>
<li>
