...
```
In drivers/virtio/virtio_pci_common.c (ffffffff81aafaf0)
Location: drivers/virtio/virtio_pci_common.c:680
Inline: False
Direct callers:
...
```
ffffffff81aafaf0-ffffffff81aafb1d: virtio_pci_vf_get_pf_dev (STB_GLOBAL)
```
</details>
</li>
</ul>
