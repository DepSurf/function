# Function: <code>virtqueue_napi_schedule</code>
...
```
In drivers/net/virtio_net.c (ffffffff81c4fdbe)
Location: drivers/net/virtio_net.c:393
Inline: True
Inline callers:
...
```
In drivers/net/virtio_net.c (ffffffff81d065bc)
Location: drivers/net/virtio_net.c:450
Inline: True
Inline callers:
  - drivers/net/virtio_net.c:virtnet_xdp_set
  - drivers/net/virtio_net.c:virtnet_xdp_set
