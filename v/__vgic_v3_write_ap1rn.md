...
```
In virt/kvm/arm/hyp/vgic-v3-sr.c (ffff800010daca6c)
Location: virt/kvm/arm/hyp/vgic-v3-sr.c:131
Inline: True
Inline callers:
...
```
ffff800010dabae8-ffff800010dabb38: __vgic_v3_write_ap1rn (STB_LOCAL)
```
</details>
</li>
<li>
