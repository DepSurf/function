...
```
In drivers/net/ethernet/microchip/vcap/vcap_api.c (ffffffff81bf8960)
Location: drivers/net/ethernet/microchip/vcap/vcap_api.c:731
Inline: False
Direct callers:
...
```
ffffffff81bf8960-ffffffff81bf8a1f: vcap_api_check (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In drivers/net/ethernet/microchip/vcap/vcap_api.c (ffffffff81c5cac0)
...
```
ffffffff81c5cac0-ffffffff81c5cb74: vcap_api_check (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In drivers/net/ethernet/microchip/vcap/vcap_api.c (ffffffff81d133f0)
Location: drivers/net/ethernet/microchip/vcap/vcap_api.c:860
Inline: False
Direct callers:
  - drivers/net/ethernet/microchip/vcap/vcap_api.c:vcap_get_rule_count_by_cookie
...
```
ffffffff81d133f0-ffffffff81d134a4: vcap_api_check (STB_GLOBAL)
```
</details>
</li>
</ul>
