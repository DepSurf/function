# Function: <code>vtime_delta</code>
...
```
In kernel/sched/build_policy.c (ffffffff81175498)
Location: kernel/sched/cputime.c:652
Inline: True
Inline callers:
...
```
In kernel/sched/cputime.c (ffffffff810c8a8d)
Location: kernel/sched/cputime.c:684
Inline: True
Inline callers:
