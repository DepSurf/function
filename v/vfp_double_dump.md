# Function: <code>vfp_double_dump</code>
...
```
In arch/arm/vfp/vfpdouble.c (c0308098)
Location: arch/arm/vfp/vfpdouble.c:48
Inline: True
Inline callers:
...
```
c0307b7c-c0307bd4: vfp_double_dump.part.0 (STB_LOCAL)
```
</details>
</li>
<li>
