# Function: <code>vma_is_initial_stack</code>
...
```
In kernel/events/core.c (ffffffff81392e78)
...
```
```
In fs/proc/task_mmu.c (ffffffff8159b0de)
Location: include/linux/mm.h:897
Inline: True
Inline callers:
...
```
```
In security/selinux/hooks.c (ffffffff816e63e9)
Location: include/linux/mm.h:897
Inline: True
Inline callers:
