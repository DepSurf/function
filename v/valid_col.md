...
```
In drivers/irqchip/irq-gic-v3-its.c (ffff80001066ffe0)
Location: drivers/irqchip/irq-gic-v3-its.c:202
Inline: False
Direct callers:
...
```
ffff80001066ffe0-ffff800010670028: valid_col (STB_LOCAL)
```
</details>
</li>
<li>
...
```
In drivers/irqchip/irq-gic-v3-its.c (c0818730)
Location: drivers/irqchip/irq-gic-v3-its.c:202
Inline: False
Direct callers:
  - drivers/irqchip/irq-gic-v3-its.c:its_build_vmovp_cmd
...
```
c0818730-c081879c: valid_col (STB_LOCAL)
```
</details>
</li>
<li>
