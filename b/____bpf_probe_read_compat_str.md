# Function: <code>____bpf_probe_read_compat_str</code>
...
```
In kernel/trace/bpf_trace.c (ffffffff811e9b20)
...
```
In kernel/trace/bpf_trace.c (ffffffff811e6fc7)
Location: kernel/trace/bpf_trace.c:308
Inline: True
Inline callers:
  - kernel/trace/bpf_trace.c:bpf_probe_read_compat_str
```
...
Location: kernel/trace/bpf_trace.c:304
Inline: True
Inline callers:
  - kernel/trace/bpf_trace.c:bpf_probe_read_compat_str
```
...
Location: kernel/trace/bpf_trace.c:307
Inline: True
Inline callers:
  - kernel/trace/bpf_trace.c:bpf_probe_read_compat_str
```
