...
```
In drivers/phy/broadcom/phy-brcm-sata.c (ffff80001068a338)
Location: drivers/phy/broadcom/phy-brcm-sata.c:202
Inline: False
Direct callers:
...
```
ffff80001068a338-ffff80001068a3b4: brcm_sata_phy_wr (STB_LOCAL)
```
</details>
</li>
<li>
