# Function: <code>blk_cmd_buf_len</code>
...
```
In block/blk-core.c (ffffffff813b4fcf)
Location: include/linux/blktrace_api.h:106
Inline: True
Inline callers:
...
```
In block/blk-core.c (ffffffff813f9e0c)
...
```
In block/blk-core.c (ffffffff8141379c)
Location: include/linux/blktrace_api.h:115
Inline: True
Inline callers:
  - block/blk-core.c:perf_trace_block_rq
