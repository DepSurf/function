# Function: <code>bpf_mprog_total</code>
...
```
In kernel/bpf/mprog.c (ffffffff8135c8f3)
Location: include/linux/bpf_mprog.h:194
Inline: True
Inline callers:
...
```
```
In kernel/bpf/tcx.c (ffffffff8137bcaa)
Location: include/linux/bpf_mprog.h:194
Inline: True
Inline callers:
...
```
```
In drivers/net/netkit.c (ffffffff81ce589c)
Location: include/linux/bpf_mprog.h:194
Inline: True
Inline callers:
