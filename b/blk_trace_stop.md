# Function: <code>blk_trace_stop</code>
...
```
In kernel/trace/blktrace.c (ffffffff81282ac7)
Location: kernel/trace/blktrace.c:366
Inline: True
Inline callers:
...
```
In kernel/trace/blktrace.c (ffffffff8129f76a)
Location: kernel/trace/blktrace.c:366
Inline: True
Inline callers:
  - kernel/trace/blktrace.c:sysfs_blk_trace_attr_store
...
```
In kernel/trace/blktrace.c (ffffffff812bae9a)
Location: kernel/trace/blktrace.c:366
Inline: True
Inline callers:
  - kernel/trace/blktrace.c:sysfs_blk_trace_attr_store
