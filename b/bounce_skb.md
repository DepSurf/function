...
Location: drivers/net/xen-netfront.c:676
Inline: False
Direct callers:
...
```
ffffffff81edc308-ffffffff81edc31d: bounce_skb.cold (STB_LOCAL)
ffffffff81a74ea0-ffffffff81a74fbc: bounce_skb (STB_GLOBAL)
```
</details>
</li>
<li>
...
Location: drivers/net/xen-netfront.c:677
Inline: True
Inline callers:
  - drivers/net/xen-netfront.c:xennet_start_xmit
```
