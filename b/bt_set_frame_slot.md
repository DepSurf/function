# Function: <code>bt_set_frame_slot</code>
...
```
In kernel/bpf/verifier.c (ffffffff8130d17d)
Location: kernel/bpf/verifier.c:3292
Inline: True
Inline callers:
...
```
In kernel/bpf/verifier.c (ffffffff813295cd)
