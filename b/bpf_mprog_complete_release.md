# Function: <code>bpf_mprog_complete_release</code>
...
```
In kernel/bpf/tcx.c (ffffffff8137b77f)
Location: include/linux/bpf_mprog.h:223
Inline: True
Inline callers:
...
```
```
In drivers/net/netkit.c (ffffffff81ce655e)
Location: include/linux/bpf_mprog.h:223
Inline: True
Inline callers:
