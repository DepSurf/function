# Function: <code>btf_type_nosize_or_null</code>
...
```
In kernel/bpf/btf.c (ffffffff812af11e)
...
```
In kernel/bpf/btf.c (ffffffff8130ee5d)
...
```
In kernel/bpf/btf.c (ffffffff8133e4ad)
...
```
In kernel/bpf/btf.c (ffffffff8136443d)
...
```
In kernel/bpf/btf.c (c00000000032d040)
Location: kernel/bpf/btf.c:355
Inline: True
Inline callers:
  - kernel/bpf/btf.c:btf_struct_resolve
...
```
In kernel/bpf/btf.c (ffffffe0001b89ba)
Location: kernel/bpf/btf.c:355
Inline: True
Inline callers:
  - kernel/bpf/btf.c:btf_struct_resolve
