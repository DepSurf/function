# Function: <code>blk_rq_check_expired</code>
...
```
In block/blk-timeout.c (ffffffff813c21a8)
Location: block/blk-timeout.c:113
Inline: True
Inline callers:
...
Location: block/blk-timeout.c:112
Inline: True
Inline callers:
  - block/blk-timeout.c:blk_timeout_work
```
...
```
In block/blk-timeout.c (ffffffff8148cb4f)
Location: block/blk-timeout.c:107
Inline: True
Inline callers:
  - block/blk-timeout.c:blk_timeout_work
```
