# Function: <code>bgl_lock_ptr</code>
...
```
In fs/mbcache.c (0)
Location: include/linux/blockgroup_lock.h:57
Inline: True
```
```
...
```
```
In fs/ext4/mballoc.c (ffffffff812fe062)
Location: include/linux/blockgroup_lock.h:57
Inline: True
Inline callers:
...
```
In fs/ext4/balloc.c (0)
Location: include/linux/blockgroup_lock.h:35
Inline: True
```
```
In fs/ext4/ialloc.c (0)
...
```
```
In fs/ext4/mballoc.c (ffffffff813140e2)
Location: include/linux/blockgroup_lock.h:35
Inline: True
Inline callers:
  - fs/ext4/mballoc.c:ext4_mb_new_group_pa
...
```
```
In fs/ext4/mballoc.c (ffffffff8130b617)
Location: include/linux/blockgroup_lock.h:35
Inline: True
Inline callers:
  - fs/ext4/mballoc.c:ext4_mb_new_group_pa
...
```
In fs/ext4/balloc.c (0)
Location: include/linux/blockgroup_lock.h:36
Inline: True
```
```
In fs/ext4/ialloc.c (0)
...
```
```
In fs/ext4/mballoc.c (ffffffff81330167)
Location: include/linux/blockgroup_lock.h:36
Inline: True
Inline callers:
  - fs/ext4/mballoc.c:ext4_mb_new_group_pa
...
```
```
In fs/ext4/mballoc.c (ffffffff81596c4f)
Location: include/linux/blockgroup_lock.h:36
Inline: True
Inline callers:
  - fs/ext4/mballoc.c:ext4_mballoc_query_range
...
```
```
In fs/ext4/mballoc.c (ffff800010496de4)
Location: include/linux/blockgroup_lock.h:36
Inline: True
Inline callers:
  - fs/ext4/mballoc.c:ext4_group_add_blocks
...
```
```
In fs/ext4/mballoc.c (ffffffe00031bb94)
Location: include/linux/blockgroup_lock.h:36
Inline: True
Inline callers:
  - fs/ext4/mballoc.c:ext4_mballoc_query_range
