# Function: <code>branch_clear_offset</code>
...
```
In arch/x86/kernel/uprobes.c (ffffffff81065b39)
Location: arch/x86/kernel/uprobes.c:678
Inline: True
Inline callers:
...
Location: arch/x86/kernel/uprobes.c:681
Inline: True
Inline callers:
  - arch/x86/kernel/uprobes.c:arch_uprobe_analyze_insn
```
...
Location: arch/x86/kernel/uprobes.c:695
Inline: True
Inline callers:
  - arch/x86/kernel/uprobes.c:arch_uprobe_analyze_insn
```
...
Location: arch/x86/kernel/uprobes.c:685
Inline: True
Inline callers:
  - arch/x86/kernel/uprobes.c:arch_uprobe_analyze_insn
```
...
```
In arch/x86/kernel/uprobes.c (ffffffff81081358)
Location: arch/x86/kernel/uprobes.c:685
Inline: True
Inline callers:
  - arch/x86/kernel/uprobes.c:arch_uprobe_analyze_insn
...
```
In arch/x86/kernel/uprobes.c (ffffffff81080df2)
Location: arch/x86/kernel/uprobes.c:686
Inline: True
Inline callers:
  - arch/x86/kernel/uprobes.c:arch_uprobe_analyze_insn
```
