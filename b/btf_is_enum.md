# Function: <code>btf_is_enum</code>
...
```
In tools/lib/bpf/relo_core.c (ffffffff812c9fc7)
...
```
In tools/lib/bpf/relo_core.c (ffffffff81332dca)
...
```
In tools/lib/bpf/relo_core.c (ffffffff81363b05)
Location: include/linux/btf.h:288
Inline: True
Inline callers:
  - tools/lib/bpf/relo_core.c:__bpf_core_types_match
  - tools/lib/bpf/relo_core.c:__bpf_core_types_match
...
```
In tools/lib/bpf/relo_core.c (ffffffff8138c9d5)
