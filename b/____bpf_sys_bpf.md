# Function: <code>____bpf_sys_bpf</code>
...
```
In kernel/bpf/syscall.c (ffffffff812344a5)
...
```
In kernel/bpf/syscall.c (ffffffff81277890)
...
```
In kernel/bpf/syscall.c (ffffffff812cdc20)
...
```
In kernel/bpf/syscall.c (ffffffff812f51b0)
...
```
In kernel/bpf/syscall.c (ffffffff81313fb0)
