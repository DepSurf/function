# Function: <code>bpf_prog_run_array_cg</code>
...
```
In kernel/bpf/cgroup.c (ffffffff812c5e1e)
Location: kernel/bpf/cgroup.c:29
Inline: True
Inline callers:
...
```
In kernel/bpf/cgroup.c (ffffffff8132b39e)
...
```
In kernel/bpf/cgroup.c (ffffffff8135b5be)
Location: kernel/bpf/cgroup.c:31
Inline: True
Inline callers:
  - kernel/bpf/cgroup.c:__cgroup_bpf_run_filter_getsockopt_kern
...
```
In kernel/bpf/cgroup.c (ffffffff8138424e)
Location: kernel/bpf/cgroup.c:31
Inline: True
Inline callers:
  - kernel/bpf/cgroup.c:__cgroup_bpf_run_filter_getsockopt_kern
