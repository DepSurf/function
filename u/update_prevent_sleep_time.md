# Function: <code>update_prevent_sleep_time</code>
...
```
In drivers/base/power/wakeup.c (0)
Location: drivers/base/power/wakeup.c:615
Inline: True
```
</details>
</li>
...
```
In drivers/base/power/wakeup.c (0)
Location: drivers/base/power/wakeup.c:621
Inline: True
```
</details>
</li>
...
```
In drivers/base/power/wakeup.c (0)
Location: drivers/base/power/wakeup.c:625
Inline: True
```
</details>
</li>
...
```
In drivers/base/power/wakeup.c (0)
Location: drivers/base/power/wakeup.c:656
Inline: True
```
</details>
</li>
...
```
In drivers/base/power/wakeup.c (0)
Location: drivers/base/power/wakeup.c:651
Inline: True
```
</details>
</li>
