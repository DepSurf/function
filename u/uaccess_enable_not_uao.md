...
Location: arch/arm64/include/asm/uaccess.h:220
Inline: True
Inline callers:
...
```
```
In arch/arm64/kernel/traps.c (ffff80001009462c)
Location: arch/arm64/include/asm/uaccess.h:220
Inline: True
Inline callers:
...
```
```
In kernel/sched/core.c (ffff80001013c9d8)
Location: arch/arm64/include/asm/uaccess.h:220
Inline: True
Inline callers:
...
```
```
In kernel/module.c (ffff8000101c1388)
Location: arch/arm64/include/asm/uaccess.h:220
Inline: True
Inline callers:
...
```
```
In drivers/video/fbdev/core/fbmem.c (ffff800010745b84)
Location: arch/arm64/include/asm/uaccess.h:220
Inline: True
Inline callers:
...
```
```
In drivers/tty/vt/vt_ioctl.c (ffff800010867338)
Location: arch/arm64/include/asm/uaccess.h:220
Inline: True
Inline callers:
...
```
ffff80001008a840-ffff80001008a8a8: uaccess_enable_not_uao (STB_LOCAL)
ffff80001008f8c0-ffff80001008f928: uaccess_enable_not_uao (STB_LOCAL)
ffff80001009dfb0-ffff80001009e018: uaccess_enable_not_uao (STB_LOCAL)
ffff8000100fa890-ffff8000100fa8f8: uaccess_enable_not_uao (STB_LOCAL)
ffff80001010bb28-ffff80001010bba0: uaccess_enable_not_uao (STB_LOCAL)
ffff800010114f90-ffff800010114ff8: uaccess_enable_not_uao (STB_LOCAL)
ffff8000101b6cc0-ffff8000101b6d28: uaccess_enable_not_uao (STB_LOCAL)
ffff800010221728-ffff800010221790: uaccess_enable_not_uao (STB_LOCAL)
ffff80001025fd18-ffff80001025fd80: uaccess_enable_not_uao (STB_LOCAL)
ffff800010298678-ffff8000102986e8: uaccess_enable_not_uao (STB_LOCAL)
ffff8000102ac070-ffff8000102ac0d8: uaccess_enable_not_uao (STB_LOCAL)
ffff80001039d900-ffff80001039d968: uaccess_enable_not_uao (STB_LOCAL)
ffff80001041a140-ffff80001041a1a8: uaccess_enable_not_uao (STB_LOCAL)
ffff80001041e140-ffff80001041e1a8: uaccess_enable_not_uao (STB_LOCAL)
ffff800010421870-ffff8000104218d8: uaccess_enable_not_uao (STB_LOCAL)
ffff80001048a440-ffff80001048a4a8: uaccess_enable_not_uao (STB_LOCAL)
ffff8000104e42a0-ffff8000104e4308: uaccess_enable_not_uao (STB_LOCAL)
ffff8000105f7748-ffff8000105f77b0: uaccess_enable_not_uao (STB_LOCAL)
ffff800010607ae8-ffff800010607b50: uaccess_enable_not_uao (STB_LOCAL)
ffff800010619f50-ffff800010619fb8: uaccess_enable_not_uao (STB_LOCAL)
ffff800010743440-ffff8000107434a8: uaccess_enable_not_uao (STB_LOCAL)
ffff8000108503c8-ffff800010850430: uaccess_enable_not_uao (STB_LOCAL)
ffff8000108653b0-ffff800010865418: uaccess_enable_not_uao (STB_LOCAL)
ffff80001086ab40-ffff80001086aba8: uaccess_enable_not_uao (STB_LOCAL)
ffff8000108742f0-ffff800010874358: uaccess_enable_not_uao (STB_LOCAL)
ffff80001098ff90-ffff80001098fff8: uaccess_enable_not_uao (STB_LOCAL)
ffff8000109fe708-ffff8000109fe770: uaccess_enable_not_uao (STB_LOCAL)
ffff800010a2ce78-ffff800010a2cee0: uaccess_enable_not_uao (STB_LOCAL)
ffff800010a9dd98-ffff800010a9de00: uaccess_enable_not_uao (STB_LOCAL)
ffff800010adf2d8-ffff800010adf340: uaccess_enable_not_uao (STB_LOCAL)
ffff800010ae5aa0-ffff800010ae5b08: uaccess_enable_not_uao (STB_LOCAL)
ffff800010ba2888-ffff800010ba28f0: uaccess_enable_not_uao (STB_LOCAL)
ffff800010bab268-ffff800010bab2d0: uaccess_enable_not_uao (STB_LOCAL)
ffff800010c32988-ffff800010c329f0: uaccess_enable_not_uao (STB_LOCAL)
ffff800010c4b4c0-ffff800010c4b528: uaccess_enable_not_uao (STB_LOCAL)
ffff800010c66010-ffff800010c66078: uaccess_enable_not_uao (STB_LOCAL)
ffff800010c6f228-ffff800010c6f290: uaccess_enable_not_uao (STB_LOCAL)
ffff800010d1c3a8-ffff800010d1c410: uaccess_enable_not_uao (STB_LOCAL)
ffff800010d7f548-ffff800010d7f5b0: uaccess_enable_not_uao (STB_LOCAL)
```
</details>
</li>
<li>
