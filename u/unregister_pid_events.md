# Function: <code>unregister_pid_events</code>
...
Location: kernel/trace/trace_events.c:627
Inline: True
Inline callers:
...
Location: kernel/trace/trace_events.c:628
Inline: True
Inline callers:
  - kernel/trace/trace_events.c:__ftrace_clear_event_pids
```
...
Location: kernel/trace/trace_events.c:835
Inline: True
Inline callers:
  - kernel/trace/trace_events.c:__ftrace_clear_event_pids
```
...
Location: kernel/trace/trace_events.c:836
Inline: True
Inline callers:
  - kernel/trace/trace_events.c:__ftrace_clear_event_pids
```
...
Location: kernel/trace/trace_events.c:856
Inline: True
Inline callers:
  - kernel/trace/trace_events.c:__ftrace_clear_event_pids
```
...
Location: kernel/trace/trace_events.c:871
Inline: True
Inline callers:
  - kernel/trace/trace_events.c:__ftrace_clear_event_pids
```
...
Location: kernel/trace/trace_events.c:867
Inline: True
Inline callers:
  - kernel/trace/trace_events.c:__ftrace_clear_event_pids
```
