# Function: <code>uv_blade_to_memory_nid</code>
...
Location: arch/x86/include/asm/uv/uv_hub.h:753
Inline: True
Inline callers:
...
Location: arch/x86/include/asm/uv/uv_hub.h:698
Inline: True
Inline callers:
  - arch/x86/platform/uv/uv_irq.c:uv_setup_irq
```
...
Location: arch/x86/include/asm/uv/uv_hub.h:679
Inline: True
Inline callers:
  - arch/x86/platform/uv/uv_irq.c:uv_setup_irq
```
...
Location: arch/x86/include/asm/uv/uv_hub.h:689
Inline: True
Inline callers:
  - arch/x86/platform/uv/uv_irq.c:uv_setup_irq
```
