...
Location: arch/x86/include/asm/tlbflush.h:111
Inline: True
Inline callers:
...
```
In arch/x86/mm/tlb.c (ffffffff8108b8cb)
Location: arch/x86/mm/tlb.c:140
Inline: True
Inline callers:
...
```
In arch/x86/mm/tlb.c (ffffffff8108b91b)
Location: arch/x86/mm/tlb.c:139
Inline: True
Inline callers:
  - arch/x86/mm/tlb.c:native_flush_tlb_one_user
```
...
Location: arch/x86/mm/tlb.c:147
Inline: True
Inline callers:
  - arch/x86/mm/tlb.c:native_flush_tlb_one_user
```
