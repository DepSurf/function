# Function: <code>uaccess_ttbr0_disable</code>
...
Location: arch/arm64/include/asm/uaccess.h:149
Inline: True
Inline callers:
...
```
```
In arch/arm64/kernel/traps.c (ffff8000100952c8)
Location: arch/arm64/include/asm/uaccess.h:149
Inline: True
Inline callers:
...
```
```
In arch/arm64/kernel/armv8_deprecated.c (ffff8000100a899c)
Location: arch/arm64/include/asm/uaccess.h:149
Inline: True
Inline callers:
...
```
```
In drivers/firmware/efi/arm-runtime.c (ffff800010b60ff8)
Location: arch/arm64/include/asm/uaccess.h:149
Inline: True
```
```
