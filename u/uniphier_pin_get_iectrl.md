# Function: <code>uniphier_pin_get_iectrl</code>
...
```
In drivers/pinctrl/uniphier/pinctrl-uniphier-core.c (c0857cb8)
Location: drivers/pinctrl/uniphier/pinctrl-uniphier.h:96
Inline: True
Inline callers:
