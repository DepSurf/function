# Function: <code>u64_stats_update_begin</code>
...
Location: include/linux/u64_stats_sync.h:78
Inline: True
```
```
...
Location: include/linux/u64_stats_sync.h:79
Inline: True
```
```
In drivers/net/loopback.c (0)
...
```
In kernel/cgroup/rstat.c (0)
Location: include/linux/u64_stats_sync.h:125
Inline: True
```
```
In kernel/seccomp.c (0)
...
```
In kernel/cgroup/rstat.c (0)
Location: include/linux/u64_stats_sync.h:126
Inline: True
```
```
In kernel/seccomp.c (0)
...
```
In drivers/net/loopback.c (0)
Location: include/linux/u64_stats_sync.h:136
Inline: True
```
```
In drivers/net/phy/mdio_bus.c (0)
...
Location: include/linux/u64_stats_sync.h:180
Inline: True
```
```
In drivers/net/loopback.c (0)
...
```
```
In net/packet/af_packet.c (c0e5cf08)
Location: include/linux/u64_stats_sync.h:79
Inline: True
Inline callers:
