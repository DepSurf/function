# Function: <code>uv_socket_to_node</code>
...
```
In arch/x86/kernel/apic/x2apic_uv_x.c (ffffffff836b7639)
Location: arch/x86/include/asm/uv/uv_hub.h:518
Inline: True
Inline callers:
...
```
In arch/x86/kernel/apic/x2apic_uv_x.c (ffffffff838e7f57)
Location: arch/x86/include/asm/uv/uv_hub.h:518
Inline: True
Inline callers:
  - arch/x86/kernel/apic/x2apic_uv_x.c:uv_system_init_hub
