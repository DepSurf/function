# Function: <code>uv_node_to_blade_id</code>
...
Location: arch/x86/include/asm/uv/uv_hub.h:735
Inline: True
```
```
...
```
In arch/x86/kernel/apic/x2apic_uv_x.c (ffffffff836b7780)
...
```
In arch/x86/kernel/apic/x2apic_uv_x.c (ffffffff838e80c8)
Location: arch/x86/include/asm/uv/uv_hub.h:667
Inline: True
Inline callers:
  - arch/x86/kernel/apic/x2apic_uv_x.c:uv_system_init_hub
