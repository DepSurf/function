# Function: <code>uart_lsr_tx_empty</code>
...
```
In drivers/tty/serial/8250/8250_port.c (ffffffff81a7d6db)
Location: include/linux/serial.h:21
Inline: True
Inline callers:
...
Location: include/linux/serial.h:26
Inline: True
```
```
In drivers/tty/serial/8250/8250_early.c (0)
