# Function: <code>user_event_get</code>
...
```
In kernel/trace/trace_events_user.c (ffffffff812c6f5b)
Location: kernel/trace/trace_events_user.c:194
Inline: True
Inline callers:
...
```
In kernel/trace/trace_events_user.c (ffffffff812e3930)
Location: kernel/trace/trace_events_user.c:222
Inline: True
Inline callers:
  - kernel/trace/trace_events_user.c:user_events_ioctl_reg
  - kernel/trace/trace_events_user.c:user_event_reg
