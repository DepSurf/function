...
```
In drivers/dma-buf/reservation.c (ffffffff815a5441)
Location: include/linux/fence.h:190
Inline: True
Inline callers:
...
Location: include/linux/fence.h:191
Inline: True
Inline callers:
  - drivers/dma-buf/reservation.c:reservation_object_add_excl_fence
```
...
```
```
In drivers/dma-buf/sync_file.c (ffffffff815fd12f)
Location: include/linux/fence.h:191
Inline: True
```
</details>
