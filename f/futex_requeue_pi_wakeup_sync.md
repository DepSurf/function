# Function: <code>futex_requeue_pi_wakeup_sync</code>
...
```
In kernel/futex.c (ffffffff81180417)
...
Location: kernel/futex/requeue.c:156
Inline: True
Inline callers:
...
Location: kernel/futex/requeue.c:158
Inline: True
Inline callers:
  - kernel/futex/requeue.c:futex_wait_requeue_pi
```
