# Function: <code>fdb_head_index</code>
...
```
In drivers/net/vxlan.c (ffffffff8176f746)
Location: drivers/net/vxlan.c:633
Inline: True
Inline callers:
...
```
ffffffff8176ca90-ffffffff8176caeb: fdb_head_index.isra.0.part.0 (STB_LOCAL)
```
</details>
</li>
<li>
