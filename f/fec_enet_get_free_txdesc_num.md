# Function: <code>fec_enet_get_free_txdesc_num</code>
...
```
In drivers/net/ethernet/freescale/fec_main.c (ffff8000109e7370)
Location: drivers/net/ethernet/freescale/fec_main.c:267
Inline: True
Inline callers:
...
```
In drivers/net/ethernet/freescale/fec_main.c (c0acc178)
Location: drivers/net/ethernet/freescale/fec_main.c:267
Inline: True
Inline callers:
  - drivers/net/ethernet/freescale/fec_main.c:fec_enet_rx_napi
