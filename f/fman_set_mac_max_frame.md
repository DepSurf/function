...
```
In drivers/net/ethernet/freescale/fman/fman.c (ffff8000109ee790)
Location: drivers/net/ethernet/freescale/fman/fman.c:2296
Inline: True
Direct callers:
...
```
ffff8000109ee790-ffff8000109ee808: fman_set_mac_max_frame (STB_GLOBAL)
```
</details>
</li>
<li>
