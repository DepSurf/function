...
```
In arch/powerpc/kernel/process.c (c000000000020980)
Location: arch/powerpc/kernel/process.c:309
Inline: False
Direct callers:
...
```
c000000000020980-c0000000000209e4: flush_altivec_to_thread (STB_GLOBAL)
```
</details>
</li>
<li>
