...
```
In arch/powerpc/kernel/ptrace.c (c000000000012100)
Location: arch/powerpc/kernel/ptrace.c:128
Inline: True
Direct callers:
...
```
c000000000012100-c0000000000121c0: flush_tmregs_to_thread (STB_LOCAL)
```
</details>
</li>
<li>
