# Function: <code>folio_clear_isolated</code>
...
```
In mm/migrate.c (ffffffff813b36af)
...
```
In mm/migrate.c (ffffffff8143463e)
...
```
In mm/migrate.c (ffffffff81469f8b)
...
```
In mm/migrate.c (ffffffff81498f38)
