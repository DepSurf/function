...
```
In fs/namei.c (ffffffff814c57a0)
...
```
ffffffff814c57a0-ffffffff814c59c6: __filename_parentat (STB_LOCAL)
```
</details>
</li>
<li>
...
```
In fs/namei.c (ffffffff814f7f80)
Location: fs/namei.c:2546
Inline: False
Direct callers:
  - fs/namei.c:do_renameat2
  - fs/namei.c:do_renameat2
...
```
ffffffff814f7f80-ffffffff814f81a6: __filename_parentat (STB_LOCAL)
```
</details>
</li>
</ul>
