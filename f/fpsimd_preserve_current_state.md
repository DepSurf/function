...
```
In arch/arm64/kernel/fpsimd.c (ffff800010087e38)
Location: arch/arm64/kernel/fpsimd.c:1065
Inline: True
Inline callers:
...
```
ffff800010087de0-ffff800010087e24: fpsimd_preserve_current_state (STB_GLOBAL)
```
</details>
</li>
<li>
