# Function: <code>folio_test_hugetlb_freed</code>
...
```
In mm/hugetlb.c (ffffffff81412b20)
...
```
In mm/hugetlb.c (ffffffff814464ce)
...
```
```
In mm/memory-failure.c (ffffffff81499920)
Location: include/linux/hugetlb.h:683
Inline: True
Inline callers:
...
```
In mm/hugetlb.c (ffffffff8147ff6e)
Location: include/linux/hugetlb.h:706
Inline: True
Inline callers:
  - mm/hugetlb.c:get_hwpoison_hugetlb_folio
  - mm/hugetlb.c:alloc_and_dissolve_hugetlb_folio
...
```
```
In mm/memory-failure.c (ffffffff814c90c2)
Location: include/linux/hugetlb.h:706
Inline: True
Inline callers:
  - mm/memory-failure.c:__get_huge_page_for_hwpoison
