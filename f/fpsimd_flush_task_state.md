...
```
In arch/arm64/kernel/fpsimd.c (ffff8000100881c0)
Location: arch/arm64/kernel/fpsimd.c:1194
Inline: True
Direct callers:
...
```
ffff8000100881c0-ffff800010088228: fpsimd_flush_task_state (STB_GLOBAL)
```
</details>
</li>
<li>
