# Function: <code>__flush_tlb_one_user</code>
...
Location: arch/x86/include/asm/paravirt.h:60
Inline: True
Inline callers:
  - arch/x86/mm/init_64.c:__set_pte_vaddr
```
...
```
```
In arch/x86/platform/uv/tlb_uv.c (ffffffff810950d7)
Location: arch/x86/include/asm/paravirt.h:60
Inline: True
Inline callers:
...
Location: arch/x86/include/asm/paravirt.h:66
Inline: True
Inline callers:
...
```
```
In arch/x86/platform/uv/tlb_uv.c (ffffffff81096597)
Location: arch/x86/include/asm/paravirt.h:60
Inline: True
Inline callers:
  - arch/x86/platform/uv/tlb_uv.c:bau_process_message
