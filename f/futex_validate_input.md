# Function: <code>futex_validate_input</code>
...
```
In kernel/futex/syscalls.c (ffffffff8122037c)
Location: kernel/futex/futex.h:91
Inline: True
Inline callers:
...
```
```
In io_uring/futex.c (ffffffff8182f425)
Location: kernel/futex/futex.h:91
Inline: True
Inline callers:
