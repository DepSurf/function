...
```
In arch/arm64/kernel/ftrace.c (ffff8000100a1c60)
Location: arch/arm64/kernel/ftrace.c:251
Inline: True
Inline callers:
...
```
In arch/arm/kernel/ftrace.c (c0314d8c)
Location: arch/arm/kernel/ftrace.c:218
Inline: True
Direct callers:
...
```
c0314d8c-c0314dd8: ftrace_modify_graph_caller (STB_LOCAL)
```
</details>
</li>
<li>
