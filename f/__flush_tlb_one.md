# Function: <code>__flush_tlb_one</code>
...
Location: arch/x86/include/asm/tlbflush.h:133
Inline: True
Inline callers:
...
```
```
In arch/x86/mm/tlb.c (ffffffff81072aa8)
Location: arch/x86/include/asm/tlbflush.h:133
Inline: True
Inline callers:
...
Location: arch/x86/include/asm/tlbflush.h:197
Inline: True
Inline callers:
  - arch/x86/kernel/acpi/apei.c:arch_apei_flush_tlb_one
```
...
```
```
In arch/x86/mm/tlb.c (ffffffff81072a68)
Location: arch/x86/include/asm/tlbflush.h:197
Inline: True
Inline callers:
  - arch/x86/mm/tlb.c:flush_tlb_page
...
```
```
In arch/x86/mm/tlb.c (ffffffff81076615)
Location: arch/x86/include/asm/tlbflush.h:197
Inline: True
Inline callers:
  - arch/x86/mm/tlb.c:flush_tlb_page
...
Location: arch/x86/include/asm/tlbflush.h:212
Inline: True
Inline callers:
  - arch/x86/kernel/acpi/apei.c:arch_apei_flush_tlb_one
```
