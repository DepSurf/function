...
```
In drivers/net/ethernet/freescale/fman/fman.c (ffff8000109eea10)
Location: drivers/net/ethernet/freescale/fman/fman.c:2351
Inline: False
Direct callers:
...
```
ffff8000109eea10-ffff8000109eea60: fman_get_revision (STB_GLOBAL)
```
</details>
</li>
<li>
