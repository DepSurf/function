# Function: <code>folio_test_isolated</code>
...
```
In mm/migrate.c (ffffffff813b375a)
...
```
In mm/migrate.c (ffffffff814345de)
...
```
In mm/migrate.c (ffffffff81469f2b)
...
```
In mm/migrate.c (ffffffff81498ef9)
