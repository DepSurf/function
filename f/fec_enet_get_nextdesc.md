# Function: <code>fec_enet_get_nextdesc</code>
...
```
In drivers/net/ethernet/freescale/fec_main.c (ffff8000109e6580)
Location: drivers/net/ethernet/freescale/fec_main.c:247
Inline: True
Inline callers:
...
```
In drivers/net/ethernet/freescale/fec_main.c (c0ac9650)
Location: drivers/net/ethernet/freescale/fec_main.c:247
Inline: True
Inline callers:
  - drivers/net/ethernet/freescale/fec_main.c:fec_enet_free_buffers
