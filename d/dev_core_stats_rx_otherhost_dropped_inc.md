# Function: <code>dev_core_stats_rx_otherhost_dropped_inc</code>
...
Location: include/linux/netdevice.h:3926
Inline: True
Inline callers:
...
Location: include/linux/netdevice.h:3970
Inline: True
Inline callers:
  - net/ipv4/ip_input.c:ip_rcv_core
```
...
Location: include/linux/netdevice.h:4029
Inline: True
Inline callers:
  - net/ipv4/ip_input.c:ip_rcv_core
```
...
```
In net/ipv4/ip_input.c (ffffffff81fb7f72)
Location: include/linux/netdevice.h:4095
Inline: True
Inline callers:
  - net/ipv4/ip_input.c:ip_rcv_core
```
```
In net/ipv6/ip6_input.c (ffffffff820881a0)
Location: include/linux/netdevice.h:4095
Inline: True
Inline callers:
  - net/ipv6/ip6_input.c:ip6_rcv_core
