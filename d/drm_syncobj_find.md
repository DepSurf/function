...
```
In drivers/gpu/drm/drm_syncobj.c (ffffffff81caefe0)
Location: drivers/gpu/drm/drm_syncobj.c:247
Inline: False
Direct callers:
...
```
ffffffff81caefe0-ffffffff81caf065: drm_syncobj_find (STB_GLOBAL)
```
</details>
</li>
</ul>
