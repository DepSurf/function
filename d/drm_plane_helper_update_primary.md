...
Location: drivers/gpu/drm/drm_plane_helper.c:164
Inline: False
```
**Symbols:**

```
ffffffff821fe85b-ffffffff821fe884: drm_plane_helper_update_primary.cold (STB_LOCAL)
ffffffff81cccda0-ffffffff81cccfe0: drm_plane_helper_update_primary (STB_GLOBAL)
```
</details>
</li>
</ul>
