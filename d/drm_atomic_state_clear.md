...
```
In drivers/gpu/drm/drm_atomic.c (ffffffff81c7b430)
Location: drivers/gpu/drm/drm_atomic.c:286
Inline: True
Inline callers:
...
```
ffffffff81c7a740-ffffffff81c7a77b: drm_atomic_state_clear (STB_GLOBAL)
```
</details>
</li>
</ul>
