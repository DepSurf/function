# Function: <code>__do_sys_io_uring_setup</code>
...
```
In io_uring/io_uring.c (ffffffff81816d49)
...
```
In fs/io_uring.c (c000000000510090)
Location: fs/io_uring.c:4003
Inline: True
Inline callers:
  - fs/io_uring.c:__se_sys_io_uring_setup
...
```
In fs/io_uring.c (ffffffe0002b1080)
Location: fs/io_uring.c:4003
Inline: True
Inline callers:
  - fs/io_uring.c:__se_sys_io_uring_setup
