# Function: <code>drm_rect_width</code>
...
Location: include/drm/drm_rect.h:184
Inline: True
Inline callers:
...
```
```
In drivers/gpu/drm/drm_format_helper.c (ffffffff81cc99fa)
Location: include/drm/drm_rect.h:184
Inline: True
Inline callers:
...
```
```
In drivers/gpu/drm/drm_plane_helper.c (ffffffff81cccb97)
Location: include/drm/drm_rect.h:184
Inline: True
```
```
In drivers/gpu/drm/drm_rect.c (ffffffff81ccf1c5)
Location: include/drm/drm_rect.h:184
Inline: True
Inline callers:
  - drivers/gpu/drm/drm_rect.c:drm_rect_calc_hscale
  - drivers/gpu/drm/drm_rect.c:drm_rect_calc_hscale
...
```
```
In drivers/gpu/drm/drm_fb_helper.c (ffffffff81cd4175)
Location: include/drm/drm_rect.h:184
Inline: True
Inline callers:
