...
```
In drivers/gpu/drm/drm_vblank.c (ffffffff81cb3e40)
Location: drivers/gpu/drm/drm_vblank.c:930
Inline: False
Direct callers:
...
```
ffffffff81cb3e40-ffffffff81cb3ee5: drm_vblank_count_and_time (STB_LOCAL)
```
</details>
</li>
</ul>
