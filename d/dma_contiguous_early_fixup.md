...
Location: include/asm-generic/dma-contiguous.h:8
Inline: True
```
</details>
</li>
...
```
In arch/arm/mm/dma-mapping.c (c1507c14)
Location: arch/arm/mm/dma-mapping.c:418
Inline: False
Direct callers:
...
```
c1507c14-c1507c48: dma_contiguous_early_fixup (STB_GLOBAL)
```
</details>
</li>
<li>
