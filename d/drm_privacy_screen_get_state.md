...
```
In drivers/gpu/drm/drm_privacy_screen.c (ffffffff81cbc2a0)
Location: drivers/gpu/drm/drm_privacy_screen.c:249
Inline: False
Direct callers:
...
```
ffffffff81cbc2a0-ffffffff81cbc2f9: drm_privacy_screen_get_state (STB_GLOBAL)
```
</details>
</li>
</ul>
