...
```
In drivers/gpu/drm/drm_atomic.c (ffffffff81c7b360)
Location: drivers/gpu/drm/drm_atomic.c:167
Inline: True
Direct callers:
...
```
ffffffff81c7b360-ffffffff81c7b409: drm_atomic_state_alloc (STB_GLOBAL)
```
</details>
</li>
</ul>
