...
```
In drivers/gpu/drm/drm_atomic.c (ffffffff81c79320)
Location: drivers/gpu/drm/drm_atomic.c:1640
Inline: False
Direct callers:
...
```
ffffffff81c79320-ffffffff81c794e1: __drm_atomic_helper_set_config (STB_GLOBAL)
```
</details>
</li>
</ul>
