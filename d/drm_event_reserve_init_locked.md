...
```
In drivers/gpu/drm/drm_file.c (ffffffff81c96901)
Location: drivers/gpu/drm/drm_file.c:664
Inline: True
Inline callers:
...
```
ffffffff81c96850-ffffffff81c968be: drm_event_reserve_init_locked (STB_GLOBAL)
```
</details>
</li>
</ul>
