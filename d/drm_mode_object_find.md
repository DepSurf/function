...
```
In drivers/gpu/drm/drm_mode_object.c (ffffffff81ca46bb)
Location: drivers/gpu/drm/drm_mode_object.c:175
Inline: True
Inline callers:
...
```
ffffffff81ca4220-ffffffff81ca423c: drm_mode_object_find (STB_GLOBAL)
```
</details>
</li>
</ul>
