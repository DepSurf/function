...
```
In drivers/gpu/drm/drm_property.c (ffffffff81cae390)
Location: drivers/gpu/drm/drm_property.c:162
Inline: False
Direct callers:
...
```
ffffffff81cae390-ffffffff81cae40f: drm_property_create_enum (STB_GLOBAL)
```
</details>
</li>
</ul>
