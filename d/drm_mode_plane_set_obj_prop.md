...
```
In drivers/gpu/drm/drm_plane.c (ffffffff81ca9170)
Location: drivers/gpu/drm/drm_plane.c:740
Inline: False
Direct callers:
...
```
ffffffff81ca9170-ffffffff81ca91e8: drm_mode_plane_set_obj_prop (STB_GLOBAL)
```
</details>
</li>
</ul>
