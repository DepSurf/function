...
```
In drivers/gpu/drm/drm_file.c (ffffffff81c96de0)
Location: drivers/gpu/drm/drm_file.c:872
Inline: False
Direct callers:
...
```
ffffffff81c96de0-ffffffff81c96ea5: drm_print_memory_stats (STB_GLOBAL)
```
</details>
</li>
</ul>
