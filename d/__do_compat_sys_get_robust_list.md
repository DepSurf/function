# Function: <code>__do_compat_sys_get_robust_list</code>
...
```
In kernel/futex_compat.c (ffffffff8112bdc0)
...
```
In kernel/futex.c (ffffffff81133890)
...
```
In kernel/futex.c (ffffffff8113e8f0)
...
```
In kernel/futex.c (ffffffff8114a460)
...
```
In kernel/futex.c (ffffffff8115af80)
...
```
In kernel/futex.c (ffffffff81157092)
...
```
In kernel/futex.c (ffffffff811584b2)
...
```
In kernel/futex.c (ffffffff8117d2f2)
...
```
In kernel/futex.c (c00000000021c5b8)
Location: kernel/futex.c:4080
Inline: True
Inline callers:
...
```
In kernel/futex.c (ffffffff81142a80)
Location: kernel/futex.c:4080
Inline: True
Inline callers:
  - kernel/futex.c:__x32_compat_sys_get_robust_list
...
```
In kernel/futex.c (ffffffff81135de0)
Location: kernel/futex.c:4080
Inline: True
Inline callers:
  - kernel/futex.c:__x32_compat_sys_get_robust_list
...
```
In kernel/futex.c (ffffffff81140930)
Location: kernel/futex.c:4080
Inline: True
Inline callers:
  - kernel/futex.c:__x32_compat_sys_get_robust_list
...
```
In kernel/futex.c (ffffffff8114db72)
Location: kernel/futex.c:4080
Inline: True
Inline callers:
  - kernel/futex.c:__x32_compat_sys_get_robust_list
