...
```
In drivers/gpu/drm/drm_property.c (ffffffff81cae120)
Location: drivers/gpu/drm/drm_property.c:369
Inline: False
Direct callers:
...
```
ffffffff81cae120-ffffffff81cae160: drm_property_create_bool (STB_GLOBAL)
```
</details>
</li>
</ul>
