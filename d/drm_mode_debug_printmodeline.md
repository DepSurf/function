...
```
In drivers/gpu/drm/drm_modes.c (ffffffff81ca50f0)
Location: drivers/gpu/drm/drm_modes.c:58
Inline: False
Direct callers:
...
```
ffffffff81ca50f0-ffffffff81ca517c: drm_mode_debug_printmodeline (STB_GLOBAL)
```
</details>
</li>
</ul>
