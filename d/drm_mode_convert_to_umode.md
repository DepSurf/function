...
```
In drivers/gpu/drm/drm_modes.c (ffffffff81ca8380)
Location: drivers/gpu/drm/drm_modes.c:2580
Inline: False
Direct callers:
...
```
ffffffff81ca8380-ffffffff81ca847e: drm_mode_convert_to_umode (STB_GLOBAL)
```
</details>
</li>
</ul>
