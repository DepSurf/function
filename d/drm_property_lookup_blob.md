...
```
In drivers/gpu/drm/drm_property.c (ffffffff81caede8)
Location: drivers/gpu/drm/drm_property.c:651
Inline: True
Inline callers:
...
```
ffffffff81cadd10-ffffffff81cadd35: drm_property_lookup_blob (STB_GLOBAL)
```
</details>
</li>
</ul>
