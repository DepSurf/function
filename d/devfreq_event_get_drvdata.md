# Function: <code>devfreq_event_get_drvdata</code>
...
```
In drivers/devfreq/event/exynos-nocp.c (c0c6b460)
Location: include/linux/devfreq-event.h:118
Inline: True
Inline callers:
...
```
```
In drivers/devfreq/event/exynos-ppmu.c (c0c6bdac)
Location: include/linux/devfreq-event.h:118
Inline: True
Inline callers:
