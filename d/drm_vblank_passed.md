# Function: <code>drm_vblank_passed</code>
...
```
In drivers/gpu/drm/drm_vblank.c (ffffffff81cb756d)
Location: drivers/gpu/drm/drm_internal.h:91
Inline: True
Inline callers:
...
```
```
In drivers/gpu/drm/drm_vblank_work.c (ffffffff81cb77be)
Location: drivers/gpu/drm/drm_internal.h:91
Inline: True
Inline callers:
