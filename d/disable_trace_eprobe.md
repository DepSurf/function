# Function: <code>disable_trace_eprobe</code>
...
Location: kernel/trace/trace_eprobe.c:805
Inline: True
Inline callers:
  - kernel/trace/trace_eprobe.c:eprobe_register
```
...
Location: kernel/trace/trace_eprobe.c:781
Inline: True
Inline callers:
  - kernel/trace/trace_eprobe.c:eprobe_register
```
...
Location: kernel/trace/trace_eprobe.c:699
Inline: True
Inline callers:
  - kernel/trace/trace_eprobe.c:eprobe_register
```
...
Location: kernel/trace/trace_eprobe.c:701
Inline: True
Inline callers:
  - kernel/trace/trace_eprobe.c:eprobe_register
```
