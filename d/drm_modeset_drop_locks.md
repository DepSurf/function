...
```
In drivers/gpu/drm/drm_modeset_lock.c (ffffffff81ca8cde)
Location: drivers/gpu/drm/drm_modeset_lock.c:274
Inline: True
Inline callers:
...
```
ffffffff81ca8990-ffffffff81ca89f3: drm_modeset_drop_locks (STB_GLOBAL)
```
</details>
</li>
</ul>
