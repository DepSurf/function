...
```
In drivers/gpu/drm/drm_atomic.c (ffffffff81c78580)
Location: drivers/gpu/drm/drm_atomic.c:1214
Inline: False
Direct callers:
...
```
ffffffff81c78580-ffffffff81c785ca: drm_atomic_get_new_bridge_state (STB_GLOBAL)
```
</details>
</li>
</ul>
