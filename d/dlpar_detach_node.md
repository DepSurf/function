...
```
In arch/powerpc/platforms/pseries/dlpar.c (c0000000000f3680)
Location: arch/powerpc/platforms/pseries/dlpar.c:259
Inline: False
Direct callers:
...
```
c0000000000f3680-c0000000000f371c: dlpar_detach_node (STB_GLOBAL)
```
</details>
</li>
<li>
