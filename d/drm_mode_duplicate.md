...
```
In drivers/gpu/drm/drm_modes.c (ffffffff81ca5fd0)
Location: drivers/gpu/drm/drm_modes.c:1453
Inline: False
Direct callers:
...
```
ffffffff81ca5fd0-ffffffff81ca609d: drm_mode_duplicate (STB_GLOBAL)
```
</details>
</li>
</ul>
