...
Location: drivers/gpu/drm/drm_atomic_uapi.c:434
Inline: False
Direct callers:
...
```
ffffffff81c7c000-ffffffff81c7c19f: drm_atomic_crtc_get_property (STB_LOCAL)
ffffffff821fbe61-ffffffff821fbebd: drm_atomic_crtc_get_property.cold (STB_LOCAL)
```
</details>
</li>
</ul>
