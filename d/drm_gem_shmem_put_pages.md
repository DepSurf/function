...
Location: drivers/gpu/drm/drm_gem_shmem_helper.c:207
Inline: False
Direct callers:
...
```
ffffffff821fdb1a-ffffffff821fdb2f: drm_gem_shmem_put_pages.cold (STB_LOCAL)
ffffffff81cbd390-ffffffff81cbd46f: drm_gem_shmem_put_pages (STB_GLOBAL)
```
</details>
</li>
</ul>
