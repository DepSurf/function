...
```
In drivers/gpu/drm/drm_syncobj.c (ffffffff81caf900)
Location: drivers/gpu/drm/drm_syncobj.c:1305
Inline: False
Direct callers:
...
```
ffffffff81caf900-ffffffff81caf979: drm_syncobj_array_free (STB_LOCAL)
```
</details>
</li>
</ul>
