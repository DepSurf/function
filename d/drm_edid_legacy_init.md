...
```
In drivers/gpu/drm/drm_edid.c (ffffffff81c8df30)
Location: drivers/gpu/drm/drm_edid.c:1683
Inline: False
Direct callers:
...
```
ffffffff81c8df30-ffffffff81c8df6f: drm_edid_legacy_init (STB_LOCAL)
```
</details>
</li>
</ul>
