# Function: <code>dw_pcie_readl_atu_ib</code>
...
```
In drivers/pci/controller/dwc/pcie-designware.c (ffffffff81925c4e)
...
```
In drivers/pci/controller/dwc/pcie-designware.c (ffffffff819699fe)
Location: drivers/pci/controller/dwc/pcie-designware.c:543
Inline: True
Inline callers:
  - drivers/pci/controller/dwc/pcie-designware.c:dw_pcie_iatu_detect
  - drivers/pci/controller/dwc/pcie-designware.c:dw_pcie_prog_ep_inbound_atu
...
```
In drivers/pci/controller/dwc/pcie-designware.c (ffffffff819b31ae)
