# Function: <code>drm_atomic_get_old_plane_state</code>
...
```
In drivers/gpu/drm/drm_atomic_helper.c (ffffffff81cc19f3)
Location: include/drm/drm_atomic.h:612
Inline: True
Inline callers:
...
```
```
In drivers/gpu/drm/tiny/simpledrm.c (ffffffff81cd697e)
Location: include/drm/drm_atomic.h:612
Inline: True
Inline callers:
