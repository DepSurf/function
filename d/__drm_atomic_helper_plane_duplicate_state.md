...
```
In drivers/gpu/drm/drm_atomic_state_helper.c (ffffffff81cc5200)
Location: drivers/gpu/drm/drm_atomic_state_helper.c:344
Inline: False
Direct callers:
...
```
ffffffff81cc5200-ffffffff81cc528b: __drm_atomic_helper_plane_duplicate_state (STB_GLOBAL)
```
</details>
</li>
</ul>
