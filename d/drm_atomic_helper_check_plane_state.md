...
Location: drivers/gpu/drm/drm_atomic_helper.c:859
Inline: False
Direct callers:
...
```
ffffffff821fdbc1-ffffffff821fdc16: drm_atomic_helper_check_plane_state.cold (STB_LOCAL)
ffffffff81cbfd50-ffffffff81cc0052: drm_atomic_helper_check_plane_state (STB_GLOBAL)
```
</details>
</li>
</ul>
