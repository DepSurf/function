...
```
In drivers/dpll/dpll_netlink.c (ffffffff81eb9d20)
Location: drivers/dpll/dpll_netlink.c:604
Inline: False
Direct callers:
...
```
ffffffff81eb9d20-ffffffff81eb9e8a: dpll_pin_event_send (STB_LOCAL)
```
</details>
</li>
</ul>
