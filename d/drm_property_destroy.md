...
```
In drivers/gpu/drm/drm_property.c (ffffffff81cadaa0)
Location: drivers/gpu/drm/drm_property.c:441
Inline: False
Direct callers:
...
```
ffffffff81cadaa0-ffffffff81cadb7c: drm_property_destroy (STB_GLOBAL)
```
</details>
</li>
</ul>
