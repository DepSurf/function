...
```
In drivers/gpu/drm/drm_crtc.c (ffffffff81c8a2cb)
Location: drivers/gpu/drm/drm_crtc.c:655
Inline: True
Inline callers:
...
```
ffffffff81c89b80-ffffffff81c89bc9: drm_mode_set_config_internal (STB_GLOBAL)
```
</details>
</li>
</ul>
