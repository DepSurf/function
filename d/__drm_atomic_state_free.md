...
```
In drivers/gpu/drm/drm_atomic.c (ffffffff81c7b420)
Location: drivers/gpu/drm/drm_atomic.c:305
Inline: False
Direct callers:
...
```
ffffffff81c7b420-ffffffff81c7b4f4: __drm_atomic_state_free (STB_GLOBAL)
```
</details>
</li>
</ul>
