...
```
In drivers/gpu/drm/drm_modeset_lock.c (ffffffff81ca8640)
Location: drivers/gpu/drm/drm_modeset_lock.c:366
Inline: False
Direct callers:
...
```
ffffffff81ca8640-ffffffff81ca8686: drm_modeset_lock_init (STB_GLOBAL)
```
</details>
</li>
</ul>
