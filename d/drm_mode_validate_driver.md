...
```
In drivers/gpu/drm/drm_modes.c (ffffffff81ca5dc0)
Location: drivers/gpu/drm/drm_modes.c:1667
Inline: True
Direct callers:
...
```
ffffffff81ca5dc0-ffffffff81ca5eb7: drm_mode_validate_driver (STB_GLOBAL)
```
</details>
</li>
</ul>
