# Function: <code>drm_atomic_get_new_connector_state</code>
...
```
In drivers/gpu/drm/drm_atomic.c (ffffffff81c7b227)
Location: include/drm/drm_atomic.h:685
Inline: True
Inline callers:
...
```
```
In drivers/gpu/drm/drm_atomic_state_helper.c (ffffffff81cc4ba9)
Location: include/drm/drm_atomic.h:685
Inline: True
Inline callers:
