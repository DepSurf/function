...
```
In drivers/gpu/drm/drm_modeset_lock.c (ffffffff81ca8b13)
Location: drivers/gpu/drm/drm_modeset_lock.c:392
Inline: True
Direct callers:
...
```
ffffffff821fd47c-ffffffff821fd4a6: drm_modeset_lock.cold (STB_LOCAL)
ffffffff81ca86f0-ffffffff81ca87d4: drm_modeset_lock (STB_GLOBAL)
```
</details>
</li>
</ul>
