...
```
In drivers/gpu/drm/drm_gem_framebuffer_helper.c (ffffffff81ccbdf0)
Location: drivers/gpu/drm/drm_gem_framebuffer_helper.c:151
Inline: False
Direct callers:
...
```
ffffffff81ccbdf0-ffffffff81ccc2e8: drm_gem_fb_init_with_funcs (STB_GLOBAL)
```
</details>
</li>
</ul>
