...
```
In drivers/gpu/drm/drm_modeset_lock.c (ffffffff81ca8a10)
Location: drivers/gpu/drm/drm_modeset_lock.c:197
Inline: False
Direct callers:
...
```
ffffffff81ca8a10-ffffffff81ca8ab8: drm_modeset_unlock_all (STB_GLOBAL)
```
</details>
</li>
</ul>
