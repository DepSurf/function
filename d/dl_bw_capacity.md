# Function: <code>dl_bw_capacity</code>
...
```
In kernel/sched/deadline.c (ffffffff810fd0d3)
...
```
In kernel/sched/deadline.c (ffffffff810ff477)
Location: kernel/sched/deadline.c:113
Inline: True
Inline callers:
  - kernel/sched/deadline.c:dl_cpu_busy
...
```
In kernel/sched/deadline.c (ffffffff8111b484)
Location: kernel/sched/deadline.c:113
Inline: True
Inline callers:
  - kernel/sched/deadline.c:dl_cpu_busy
...
```
In kernel/sched/build_policy.c (ffffffff8113b11c)
...
Location: kernel/sched/deadline.c:144
Inline: True
Inline callers:
