...
```
In drivers/gpu/drm/drm_connector.c (ffffffff81c87690)
Location: drivers/gpu/drm/drm_connector.c:828
Inline: False
Direct callers:
...
```
ffffffff81c87690-ffffffff81c87758: drm_connector_list_iter_next (STB_GLOBAL)
```
</details>
</li>
</ul>
