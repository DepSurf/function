# Function: <code>drm_framebuffer_put</code>
...
```
In drivers/gpu/drm/drm_atomic_uapi.c (ffffffff81c7cfb7)
Location: include/drm/drm_framebuffer.h:234
Inline: True
Inline callers:
...
```
```
In drivers/gpu/drm/drm_client.c (ffffffff81c81961)
Location: include/drm/drm_framebuffer.h:234
Inline: True
Inline callers:
...
```
```
In drivers/gpu/drm/drm_crtc.c (ffffffff81c8aa99)
Location: include/drm/drm_framebuffer.h:234
Inline: True
Inline callers:
...
```
```
In drivers/gpu/drm/drm_framebuffer.c (ffffffff81c99b46)
Location: include/drm/drm_framebuffer.h:234
Inline: True
Inline callers:
...
```
```
In drivers/gpu/drm/drm_plane.c (ffffffff81cab76d)
Location: include/drm/drm_framebuffer.h:234
Inline: True
Inline callers:
...
```
```
In drivers/gpu/drm/drm_writeback.c (ffffffff81cb8abf)
Location: include/drm/drm_framebuffer.h:234
Inline: True
Inline callers:
...
```
```
In drivers/gpu/drm/drm_atomic_state_helper.c (ffffffff81cc5b96)
Location: include/drm/drm_framebuffer.h:234
Inline: True
Inline callers:
