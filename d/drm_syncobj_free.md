...
```
In drivers/gpu/drm/drm_syncobj.c (ffffffff81caf810)
Location: drivers/gpu/drm/drm_syncobj.c:522
Inline: False
Direct callers:
...
```
ffffffff81caf810-ffffffff81caf8ed: drm_syncobj_free (STB_GLOBAL)
```
</details>
</li>
</ul>
