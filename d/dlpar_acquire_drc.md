...
```
In arch/powerpc/platforms/pseries/dlpar.c (c0000000000f3720)
Location: arch/powerpc/platforms/pseries/dlpar.c:289
Inline: False
Direct callers:
...
```
c0000000000f3720-c0000000000f3840: dlpar_acquire_drc (STB_GLOBAL)
```
</details>
</li>
<li>
