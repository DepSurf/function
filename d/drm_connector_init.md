...
```
In drivers/gpu/drm/drm_connector.c (ffffffff81c87f80)
Location: drivers/gpu/drm/drm_connector.c:355
Inline: True
Direct callers:
...
```
ffffffff81c87f80-ffffffff81c87fff: drm_connector_init (STB_GLOBAL)
```
</details>
</li>
</ul>
