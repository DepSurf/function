# Function: <code>drm_framebuffer_get</code>
...
```
In drivers/gpu/drm/drm_atomic_uapi.c (ffffffff81c7bc1b)
Location: include/drm/drm_framebuffer.h:222
Inline: True
Inline callers:
  - drivers/gpu/drm/drm_atomic_uapi.c:drm_atomic_set_fb_for_plane
```
```
In drivers/gpu/drm/drm_crtc.c (ffffffff81c8a888)
Location: include/drm/drm_framebuffer.h:222
Inline: True
Inline callers:
...
```
```
In drivers/gpu/drm/drm_plane.c (ffffffff81cabac7)
Location: include/drm/drm_framebuffer.h:222
Inline: True
Inline callers:
...
```
```
In drivers/gpu/drm/drm_writeback.c (ffffffff81cb8b96)
Location: include/drm/drm_framebuffer.h:222
Inline: True
Inline callers:
...
```
```
In drivers/gpu/drm/drm_atomic_state_helper.c (ffffffff81cc524e)
Location: include/drm/drm_framebuffer.h:222
Inline: True
Inline callers:
