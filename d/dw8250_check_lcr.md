...
```
In drivers/tty/serial/8250/8250_dw.c (ffff800010890cb0)
Location: drivers/tty/serial/8250/8250_dw.c:78
Inline: False
Direct callers:
...
```
ffff800010890cb0-ffff800010890d98: dw8250_check_lcr (STB_LOCAL)
```
</details>
</li>
<li>
