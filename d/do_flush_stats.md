...
```
In mm/memcontrol.c (ffffffff81484bd0)
Location: mm/memcontrol.c:642
Inline: True
Direct callers:
...
```
ffffffff81484bd0-ffffffff81484c3c: do_flush_stats (STB_LOCAL)
```
</details>
</li>
<li>
...
```
In mm/memcontrol.c (ffffffff814c0bc9)
Location: mm/memcontrol.c:739
Inline: True
Inline callers:
