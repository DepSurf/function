...
```
In drivers/base/dma-mapping.c (ffffffff8155daa2)
Location: include/asm-generic/dma-mapping-common.h:298
Inline: True
Inline callers:
...
Location: include/linux/dma-mapping.h:457
Inline: True
Inline callers:
  - drivers/base/dma-mapping.c:dmam_alloc_noncoherent
```
...
Location: include/linux/dma-mapping.h:509
Inline: True
Inline callers:
  - drivers/base/dma-mapping.c:dmam_alloc_noncoherent
```
...
```
In kernel/dma/mapping.c (ffffffff81137a60)
...
```
ffffffff81137a60-ffffffff81137ac1: dma_alloc_noncoherent (STB_GLOBAL)
```
</details>
</li>
<li>
