...
```
In drivers/gpu/drm/drm_modes.c (ffffffff81ca6300)
Location: drivers/gpu/drm/drm_modes.c:846
Inline: False
Direct callers:
...
```
ffffffff81ca6300-ffffffff81ca660c: drm_gtf_mode_complex (STB_GLOBAL)
```
</details>
</li>
</ul>
