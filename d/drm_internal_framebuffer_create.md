...
Location: drivers/gpu/drm/drm_framebuffer.c:269
Inline: False
Direct callers:
...
```
ffffffff821fce8b-ffffffff821fcea0: drm_internal_framebuffer_create.cold (STB_LOCAL)
ffffffff81c99ec0-ffffffff81c9a051: drm_internal_framebuffer_create (STB_GLOBAL)
```
</details>
</li>
</ul>
