...
```
In drivers/gpu/drm/drm_atomic_uapi.c (ffffffff81c7ba00)
Location: drivers/gpu/drm/drm_atomic_uapi.c:120
Inline: False
Direct callers:
...
```
ffffffff81c7ba00-ffffffff81c7bbbd: drm_atomic_set_mode_prop_for_crtc (STB_GLOBAL)
```
</details>
</li>
</ul>
