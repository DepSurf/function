# Function: <code>drm_atomic_crtc_needs_modeset</code>
...
```
In drivers/gpu/drm/drm_atomic.c (ffffffff81c7ae80)
Location: include/drm/drm_atomic.h:1056
Inline: True
Inline callers:
  - drivers/gpu/drm/drm_atomic.c:drm_atomic_check_only
```
```
In drivers/gpu/drm/drm_atomic_helper.c (ffffffff81cc2d3f)
Location: include/drm/drm_atomic.h:1056
Inline: True
Inline callers:
...
```
```
In drivers/gpu/drm/drm_damage_helper.c (ffffffff81cc81d0)
Location: include/drm/drm_atomic.h:1056
Inline: True
```
</details>
