...
```
In drivers/gpu/drm/drm_plane.c (ffffffff81ca9cf0)
Location: drivers/gpu/drm/drm_plane.c:557
Inline: False
Direct callers:
...
```
ffffffff81ca9cf0-ffffffff81ca9e8f: __drm_universal_plane_alloc (STB_GLOBAL)
```
</details>
</li>
</ul>
