...
```
In drivers/gpu/drm/drm_property.c (ffffffff81cadd50)
Location: drivers/gpu/drm/drm_property.c:556
Inline: False
Direct callers:
...
```
ffffffff81cadd50-ffffffff81cade6e: drm_property_create_blob (STB_GLOBAL)
```
</details>
</li>
</ul>
