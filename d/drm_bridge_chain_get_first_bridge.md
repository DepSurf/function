# Function: <code>drm_bridge_chain_get_first_bridge</code>
...
```
In drivers/gpu/drm/drm_atomic_helper.c (ffffffff81cc0d46)
Location: include/drm/drm_bridge.h:840
Inline: True
Inline callers:
...
```
```
In drivers/gpu/drm/drm_probe_helper.c (ffffffff81cce7a4)
Location: include/drm/drm_bridge.h:840
Inline: True
Inline callers:
