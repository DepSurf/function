...
```
In drivers/gpu/drm/drm_prime.c (ffffffff81cabd20)
Location: drivers/gpu/drm/drm_prime.c:96
Inline: False
Direct callers:
...
```
ffffffff81cabd20-ffffffff81cabe5d: drm_prime_add_buf_handle (STB_LOCAL)
```
</details>
</li>
</ul>
