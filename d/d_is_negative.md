# Function: <code>d_is_negative</code>
...
```
In kernel/audit_watch.c (0)
Location: include/linux/dcache.h:434
Inline: True
```
```
In fs/namei.c (0)
...
```
In kernel/audit_watch.c (0)
Location: include/linux/dcache.h:441
Inline: True
```
```
...
Location: include/linux/dcache.h:442
Inline: True
Inline callers:
...
Location: include/linux/dcache.h:437
Inline: True
Inline callers:
  - kernel/audit_watch.c:audit_add_watch
```
...
Location: include/linux/dcache.h:433
Inline: True
Inline callers:
  - kernel/audit_watch.c:audit_add_watch
```
