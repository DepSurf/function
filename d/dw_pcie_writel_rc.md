...
```
In drivers/pci/host/pcie-designware.c (ffffffff814a559b)
Location: drivers/pci/host/pcie-designware.c:126
Inline: True
Inline callers:
...
```
In drivers/pci/host/pcie-designware.c (ffffffff814c7863)
...
```
ffffffff814c7510-ffffffff814c7536: dw_pcie_writel_rc (STB_GLOBAL)
```
</details>
</li>
<li>
