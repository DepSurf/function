...
```
In drivers/gpu/drm/bridge/panel.c (ffffffff81cd0f05)
Location: drivers/gpu/drm/bridge/panel.c:288
Inline: True
Inline callers:
...
```
ffffffff81cd0d80-ffffffff81cd0e18: drm_panel_bridge_add_typed (STB_GLOBAL)
```
</details>
</li>
</ul>
