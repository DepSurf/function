...
Location: drivers/gpu/drm/drm_damage_helper.c:223
Inline: False
Direct callers:
...
```
ffffffff821fe315-ffffffff821fe33f: drm_atomic_helper_damage_iter_init.cold (STB_LOCAL)
ffffffff81cc7e40-ffffffff81cc7fa7: drm_atomic_helper_damage_iter_init (STB_GLOBAL)
```
</details>
</li>
</ul>
