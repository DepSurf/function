# Function: <code>debug_dma_free_coherent</code>
...
```
In mm/dmapool.c (0)
Location: include/linux/dma-debug.h:139
Inline: True
```
```
...
```
In mm/dmapool.c (0)
Location: include/linux/dma-debug.h:146
Inline: True
```
```
In drivers/virtio/virtio_ring.c (0)
...
Location: include/linux/dma-debug.h:140
Inline: True
```
```
In mm/dmapool.c (0)
...
```
In kernel/dma/mapping.c (0)
Location: include/linux/dma-debug.h:127
Inline: True
```
</details>
</li>
...
```
In kernel/dma/mapping.c (0)
Location: include/linux/dma-debug.h:115
Inline: True
```
</details>
</li>
...
```
In kernel/dma/mapping.c (0)
Location: kernel/dma/debug.h:81
Inline: True
```
</details>
</li>
...
```
In kernel/dma/mapping.c (0)
Location: kernel/dma/debug.h:88
Inline: True
```
</details>
</li>
