# Function: <code>drm_atomic_get_old_crtc_state</code>
...
Location: include/drm/drm_atomic.h:565
Inline: True
Inline callers:
  - drivers/gpu/drm/drm_atomic.c:drm_atomic_add_affected_planes
```
```
In drivers/gpu/drm/drm_atomic_helper.c (ffffffff81cc0816)
Location: include/drm/drm_atomic.h:565
Inline: True
Inline callers:
...
```
```
In drivers/gpu/drm/bridge/panel.c (ffffffff81cd0863)
Location: include/drm/drm_atomic.h:565
Inline: True
Inline callers:
