...
```
In net/core/devlink.c (ffffffff81c87c86)
...
```
In net/core/devlink.c (ffffffff81e43bc8)
Location: net/core/devlink.c:527
Inline: True
Inline callers:
  - net/core/devlink.c:devlink_nl_pre_doit
```
...
```
In net/devlink/leftover.c (ffffffff820411e0)
Location: net/devlink/leftover.c:289
Inline: False
Direct callers:
...
```
ffffffff820411e0-ffffffff82041249: devlink_linecard_get_from_info (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In net/devlink/linecard.c (ffffffff8211a745)
Location: net/devlink/linecard.c:63
Inline: True
Inline callers:
