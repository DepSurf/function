...
```
In net/core/devlink.c (ffffffff81c72b50)
Location: net/core/devlink.c:262
Inline: False
```
**Symbols:**

```
ffffffff81c72b50-ffffffff81c72b6d: devl_lock (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In net/core/devlink.c (ffffffff81e4499c)
Location: net/core/devlink.c:279
Inline: True
Inline callers:
...
```
ffffffff81e2b590-ffffffff81e2b5ad: devl_lock (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In net/devlink/core.c (ffffffff8204261f)
Location: net/devlink/core.c:52
Inline: True
Inline callers:
...
```
ffffffff82041d70-ffffffff82041d8d: devl_lock (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In net/devlink/core.c (ffffffff82101290)
Location: net/devlink/core.c:274
Inline: True
Inline callers:
  - net/devlink/core.c:devlink_pernet_pre_exit
  - net/devlink/core.c:devlink_unregister
...
```
ffffffff820fe7b0-ffffffff820fe7cd: devl_lock (STB_GLOBAL)
```
</details>
</li>
</ul>
