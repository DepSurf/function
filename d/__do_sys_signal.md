# Function: <code>__do_sys_signal</code>
...
```
In kernel/signal.c (ffffffff810a2928)
...
```
In kernel/signal.c (ffffffff810ab4f8)
...
```
In kernel/signal.c (ffffffff810e6605)
...
```
In kernel/signal.c (ffffffff81107245)
...
```
In kernel/signal.c (ffffffff81113535)
...
```
In kernel/signal.c (ffffffff8111cf25)
...
```
In kernel/signal.c (c00000000015b284)
Location: kernel/signal.c:4409
Inline: True
Inline callers:
