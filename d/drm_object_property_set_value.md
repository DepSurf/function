...
```
In drivers/gpu/drm/drm_mode_object.c (ffffffff81ca3b40)
Location: drivers/gpu/drm/drm_mode_object.c:283
Inline: False
Direct callers:
...
```
ffffffff81ca3b40-ffffffff81ca3c33: drm_object_property_set_value (STB_GLOBAL)
```
</details>
</li>
</ul>
