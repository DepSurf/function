...
```
In drivers/gpu/drm/drm_file.c (ffffffff81c968d0)
Location: drivers/gpu/drm/drm_file.c:706
Inline: False
Direct callers:
...
```
ffffffff81c968d0-ffffffff81c9696b: drm_event_reserve_init (STB_GLOBAL)
```
</details>
</li>
</ul>
