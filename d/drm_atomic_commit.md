...
```
In drivers/gpu/drm/drm_atomic.c (ffffffff81c7b050)
Location: drivers/gpu/drm/drm_atomic.c:1499
Inline: False
Direct callers:
...
```
ffffffff81c7b050-ffffffff81c7b120: drm_atomic_commit (STB_GLOBAL)
```
</details>
</li>
</ul>
