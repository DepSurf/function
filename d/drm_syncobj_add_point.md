...
```
In drivers/gpu/drm/drm_syncobj.c (ffffffff81cafe60)
Location: drivers/gpu/drm/drm_syncobj.c:332
Inline: False
Direct callers:
...
```
ffffffff81cafe60-ffffffff81cb00e3: drm_syncobj_add_point (STB_GLOBAL)
```
</details>
</li>
</ul>
