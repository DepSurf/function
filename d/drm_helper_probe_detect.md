...
```
In drivers/gpu/drm/drm_probe_helper.c (ffffffff81ccd3ed)
Location: drivers/gpu/drm/drm_probe_helper.c:385
Inline: True
Inline callers:
...
```
ffffffff81ccd2d0-ffffffff81ccd38f: drm_helper_probe_detect (STB_GLOBAL)
```
</details>
</li>
</ul>
