...
```
In drivers/gpu/drm/drm_modeset_lock.c (ffffffff81ca88e0)
Location: drivers/gpu/drm/drm_modeset_lock.c:246
Inline: False
Direct callers:
...
```
ffffffff81ca88e0-ffffffff81ca8971: drm_modeset_acquire_init (STB_GLOBAL)
```
</details>
</li>
</ul>
