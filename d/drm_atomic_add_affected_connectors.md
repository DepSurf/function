...
Location: drivers/gpu/drm/drm_atomic.c:1289
Inline: False
Direct callers:
...
```
ffffffff821fbbff-ffffffff821fbc25: drm_atomic_add_affected_connectors.cold (STB_LOCAL)
ffffffff81c79020-ffffffff81c79166: drm_atomic_add_affected_connectors (STB_GLOBAL)
```
</details>
</li>
</ul>
