# Function: <code>iterate_iovec</code>
...
```
In lib/iov_iter.c (ffffffff8185846c)
Location: include/linux/iov_iter.h:40
Inline: True
Inline callers:
...
```
```
In net/core/skbuff.c (ffffffff81ece2ef)
Location: include/linux/iov_iter.h:40
Inline: True
Inline callers:
...
```
```
In net/core/datagram.c (ffffffff81edd6a3)
Location: include/linux/iov_iter.h:40
Inline: True
Inline callers:
