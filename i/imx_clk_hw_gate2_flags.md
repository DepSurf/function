# Function: <code>imx_clk_hw_gate2_flags</code>
...
```
In drivers/clk/imx/clk-imx8mq.c (ffff8000107e04cc)
Location: drivers/clk/imx/clk.h:323
Inline: True
Inline callers:
...
```
In drivers/clk/imx/clk-imx5.c (c155b73c)
Location: drivers/clk/imx/clk.h:323
Inline: True
Inline callers:
...
```
```
In drivers/clk/imx/clk-imx6q.c (c15616a8)
Location: drivers/clk/imx/clk.h:323
Inline: True
Inline callers:
...
```
```
In drivers/clk/imx/clk-imx6sl.c (c1564ae0)
Location: drivers/clk/imx/clk.h:323
Inline: True
Inline callers:
...
```
```
In drivers/clk/imx/clk-imx6sll.c (c1566ec4)
Location: drivers/clk/imx/clk.h:323
Inline: True
Inline callers:
...
```
```
In drivers/clk/imx/clk-imx6sx.c (c156aa24)
Location: drivers/clk/imx/clk.h:323
Inline: True
Inline callers:
...
```
```
In drivers/clk/imx/clk-imx6ul.c (c156ec08)
Location: drivers/clk/imx/clk.h:323
Inline: True
Inline callers:
...
```
```
In drivers/clk/imx/clk-imx7d.c (c1575e5c)
Location: drivers/clk/imx/clk.h:323
Inline: True
Inline callers:
