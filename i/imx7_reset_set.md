...
```
In drivers/reset/reset-imx7.c (ffff80001084d680)
Location: drivers/reset/reset-imx7.c:90
Inline: False
Direct callers:
...
```
ffff80001084d680-ffff80001084d714: imx7_reset_set (STB_LOCAL)
```
</details>
</li>
<li>
...
```
In drivers/reset/reset-imx7.c (c0959abc)
Location: drivers/reset/reset-imx7.c:90
Inline: True
Inline callers:
  - drivers/reset/reset-imx7.c:imx7_reset_deassert
