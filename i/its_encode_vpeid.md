# Function: <code>its_encode_vpeid</code>
...
```
In drivers/irqchip/irq-gic-v3-its.c (ffff800010671610)
Location: drivers/irqchip/irq-gic-v3-its.c:374
Inline: True
Inline callers:
...
```
In drivers/irqchip/irq-gic-v3-its.c (c08198b8)
Location: drivers/irqchip/irq-gic-v3-its.c:374
Inline: True
Inline callers:
  - drivers/irqchip/irq-gic-v3-its.c:its_send_single_vcommand
