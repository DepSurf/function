# Function: <code>io_poll_mark_cancelled</code>
...
```
In io_uring/io_uring.c (ffffffff816cead9)
Location: io_uring/io_uring.c:6556
Inline: True
Inline callers:
