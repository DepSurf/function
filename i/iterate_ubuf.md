# Function: <code>iterate_ubuf</code>
...
```
In lib/iov_iter.c (ffffffff81858356)
Location: include/linux/iov_iter.h:23
Inline: True
Inline callers:
...
```
```
In net/core/skbuff.c (ffffffff81ece239)
Location: include/linux/iov_iter.h:23
Inline: True
Inline callers:
...
```
```
In net/core/datagram.c (ffffffff81edd5bf)
Location: include/linux/iov_iter.h:23
Inline: True
Inline callers:
