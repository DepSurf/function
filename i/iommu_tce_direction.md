...
```
In arch/powerpc/kernel/iommu.c (c000000000051090)
Location: arch/powerpc/kernel/iommu.c:961
Inline: False
Direct callers:
...
```
c000000000051090-c0000000000510d8: iommu_tce_direction (STB_GLOBAL)
```
</details>
</li>
<li>
