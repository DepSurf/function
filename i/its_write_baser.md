# Function: <code>its_write_baser</code>
...
```
In drivers/irqchip/irq-gic-v3-its.c (ffff800011473fe0)
Location: drivers/irqchip/irq-gic-v3-its.c:1745
Inline: True
Inline callers:
...
```
In drivers/irqchip/irq-gic-v3-its.c (c081a478)
Location: drivers/irqchip/irq-gic-v3-its.c:1745
Inline: True
Inline callers:
  - drivers/irqchip/irq-gic-v3-its.c:its_restore_enable
