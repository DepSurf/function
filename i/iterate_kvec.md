# Function: <code>iterate_kvec</code>
...
```
In lib/iov_iter.c (ffffffff818586d1)
Location: include/linux/iov_iter.h:74
Inline: True
Inline callers:
...
```
```
In net/core/skbuff.c (ffffffff81ece557)
Location: include/linux/iov_iter.h:74
Inline: True
Inline callers:
...
```
```
In net/core/datagram.c (ffffffff81edd8f2)
Location: include/linux/iov_iter.h:74
Inline: True
Inline callers:
