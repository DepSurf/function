...
```
In drivers/irqchip/irq-gic-v3-its.c (ffff800010671ca0)
Location: drivers/irqchip/irq-gic-v3-its.c:845
Inline: False
Direct callers:
...
```
ffff800010671ca0-ffff800010671e48: its_send_single_command (STB_LOCAL)
```
</details>
</li>
<li>
...
```
In drivers/irqchip/irq-gic-v3-its.c (c08191f4)
Location: drivers/irqchip/irq-gic-v3-its.c:845
Inline: False
Direct callers:
  - drivers/irqchip/irq-gic-v3-its.c:its_vpe_set_affinity
...
```
c08191f4-c0819374: its_send_single_command (STB_LOCAL)
```
</details>
</li>
<li>
