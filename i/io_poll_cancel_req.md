...
```
In io_uring/io_uring.c (ffffffff816ceb40)
Location: io_uring/io_uring.c:6783
Inline: False
Direct callers:
...
```
ffffffff816ceb40-ffffffff816ceb86: io_poll_cancel_req (STB_LOCAL)
```
</details>
</li>
<li>
