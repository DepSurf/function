...
```
In kernel/entry/common.c (ffffffff81c389e0)
Location: kernel/entry/common.c:319
Inline: False
Direct callers:
...
```
ffffffff81c389e0-ffffffff81c38a15: irqentry_enter (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In kernel/entry/common.c (ffffffff81c2ade0)
Location: kernel/entry/common.c:320
Inline: False
Direct callers:
  - arch/x86/entry/common.c:xen_pv_evtchn_do_upcall
  - arch/x86/xen/enlighten_hvm.c:sysvec_xen_hvm_callback
...
```
ffffffff81c2ade0-ffffffff81c2ae15: irqentry_enter (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In kernel/entry/common.c (ffffffff81d49370)
Location: kernel/entry/common.c:318
Inline: False
Direct callers:
  - arch/x86/entry/common.c:xen_pv_evtchn_do_upcall
  - arch/x86/xen/enlighten_hvm.c:sysvec_xen_hvm_callback
...
```
ffffffff81d49370-ffffffff81d493a5: irqentry_enter (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In kernel/entry/common.c (ffffffff81f18690)
...
```
ffffffff81f18690-ffffffff81f186c7: irqentry_enter (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In kernel/entry/common.c (ffffffff820bfc20)
Location: kernel/entry/common.c:314
Inline: False
Direct callers:
  - arch/x86/entry/common.c:xen_pv_evtchn_do_upcall
  - arch/x86/xen/enlighten_hvm.c:sysvec_xen_hvm_callback
...
```
ffffffff820bfc20-ffffffff820bfc57: irqentry_enter (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In kernel/entry/common.c (ffffffff82141a00)
Location: kernel/entry/common.c:315
Inline: False
Direct callers:
  - arch/x86/entry/common.c:xen_pv_evtchn_do_upcall
  - arch/x86/xen/enlighten_hvm.c:sysvec_xen_hvm_callback
...
```
ffffffff82141a00-ffffffff82141a37: irqentry_enter (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In kernel/entry/common.c (ffffffff82223da0)
Location: kernel/entry/common.c:230
Inline: False
Direct callers:
  - arch/x86/entry/common.c:xen_pv_evtchn_do_upcall
...
```
ffffffff82223da0-ffffffff82223dec: irqentry_enter (STB_GLOBAL)
```
</details>
</li>
</ul>
