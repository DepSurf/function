...
```
In drivers/acpi/arm64/iort.c (ffff8000107b1fe0)
Location: drivers/acpi/arm64/iort.c:207
Inline: False
Direct callers:
...
```
ffff8000107b1fe0-ffff8000107b20b8: iort_find_domain_token (STB_GLOBAL)
```
</details>
</li>
<li>
