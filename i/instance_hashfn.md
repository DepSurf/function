# Function: <code>instance_hashfn</code>
...
```
In net/netfilter/nfnetlink_queue.c (ffffffff8199ad9d)
Location: net/netfilter/nfnetlink_queue.c:96
Inline: True
Inline callers:
...
```
```
In net/netfilter/nfnetlink_log.c (ffffffff8199babb)
Location: net/netfilter/nfnetlink_log.c:95
Inline: True
Inline callers:
