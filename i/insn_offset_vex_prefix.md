# Function: <code>insn_offset_vex_prefix</code>
...
Location: arch/x86/include/asm/insn.h:176
Inline: True
```
```
...
```
In arch/x86/kernel/kprobes/core.c (ffffffff8105fa6a)
Location: arch/x86/include/asm/insn.h:186
Inline: True
Inline callers:
  - arch/x86/kernel/kprobes/core.c:__copy_instruction
```
```
In arch/x86/kernel/uprobes.c (ffffffff81065897)
Location: arch/x86/include/asm/insn.h:186
Inline: True
Inline callers:
...
```
In arch/x86/kernel/kprobes/core.c (ffffffff81062b0a)
Location: arch/x86/include/asm/insn.h:186
Inline: True
Inline callers:
  - arch/x86/kernel/kprobes/core.c:__copy_instruction
```
```
In arch/x86/kernel/uprobes.c (ffffffff81068dc7)
Location: arch/x86/include/asm/insn.h:186
Inline: True
Inline callers:
  - arch/x86/kernel/uprobes.c:arch_uprobe_analyze_insn
...
```
In arch/x86/kernel/kprobes/core.c (ffffffff810619bf)
Location: arch/x86/include/asm/insn.h:186
Inline: True
```
```
In arch/x86/kernel/uprobes.c (ffffffff8106809b)
Location: arch/x86/include/asm/insn.h:186
Inline: True
Inline callers:
  - arch/x86/kernel/uprobes.c:arch_uprobe_analyze_insn
...
```
In arch/x86/kernel/kprobes/core.c (ffffffff81065a1a)
Location: arch/x86/include/asm/insn.h:186
Inline: True
```
```
In arch/x86/kernel/uprobes.c (ffffffff8106c36c)
Location: arch/x86/include/asm/insn.h:186
Inline: True
Inline callers:
  - arch/x86/kernel/uprobes.c:arch_uprobe_analyze_insn
...
Location: arch/x86/include/asm/insn.h:173
Inline: True
```
```
...
Location: arch/x86/include/asm/insn.h:179
Inline: True
```
```
In arch/x86/kernel/uprobes.c (ffffffff81080caa)
Location: arch/x86/include/asm/insn.h:179
Inline: True
Inline callers:
...
```
```
In arch/x86/kernel/uprobes.c (ffffffff8108075a)
Location: arch/x86/include/asm/insn.h:179
Inline: True
Inline callers:
  - arch/x86/kernel/uprobes.c:riprel_analyze
...
Location: arch/x86/include/asm/insn.h:218
Inline: True
```
```
