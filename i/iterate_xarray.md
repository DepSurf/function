# Function: <code>iterate_xarray</code>
...
```
In lib/iov_iter.c (ffffffff8185876f)
Location: include/linux/iov_iter.h:147
Inline: True
Inline callers:
...
```
```
In net/core/skbuff.c (ffffffff81ece651)
Location: include/linux/iov_iter.h:147
Inline: True
Inline callers:
...
```
```
In net/core/datagram.c (ffffffff81edd9f5)
Location: include/linux/iov_iter.h:147
Inline: True
Inline callers:
