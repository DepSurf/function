# Function: <code>io_req_task_work_add_fallback</code>
...
```
In fs/io_uring.c (ffffffff81391b14)
Location: fs/io_uring.c:2176
Inline: True
Inline callers:
...
```
In fs/io_uring.c (ffffffff813a1bf5)
Location: fs/io_uring.c:2038
Inline: True
Inline callers:
  - fs/io_uring.c:io_wq_submit_work
  - fs/io_uring.c:__io_async_wake
