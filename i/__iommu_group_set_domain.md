...
```
In drivers/iommu/iommu.c (ffffffff81967550)
...
```
ffffffff81967550-ffffffff81967619: __iommu_group_set_domain (STB_LOCAL)
```
</details>
</li>
<li>
...
```
In drivers/iommu/iommu.c (ffffffff81ad0540)
Location: drivers/iommu/iommu.c:2186
Inline: False
Direct callers:
...
```
ffffffff81ad0540-ffffffff81ad0609: __iommu_group_set_domain (STB_LOCAL)
```
</details>
</li>
<li>
...
```
In drivers/iommu/iommu.c (ffffffff81b2045f)
...
```
In drivers/iommu/iommu.c (ffffffff81b76d8e)
Location: drivers/iommu/iommu.c:116
Inline: True
Inline callers:
  - drivers/iommu/iommu.c:iommu_setup_default_domain
