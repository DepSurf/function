...
```
In arch/powerpc/kernel/iommu.c (c000000000053070)
Location: arch/powerpc/kernel/iommu.c:899
Inline: False
Direct callers:
...
```
c000000000053070-c0000000000530fc: iommu_free_coherent (STB_GLOBAL)
```
</details>
</li>
<li>
