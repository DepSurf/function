# Function: <code>io_req_init_async</code>
...
```
In fs/io_uring.c (ffffffff8137e8e4)
...
```
In fs/io_uring.c (ffffffff81394395)
Location: fs/io_uring.c:1252
Inline: True
Inline callers:
