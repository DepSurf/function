...
```
In arch/powerpc/platforms/pseries/iommu.c (c0000000000f05e0)
Location: arch/powerpc/platforms/pseries/iommu.c:42
Inline: False
Direct callers:
...
```
c0000000000f05e0-c0000000000f06a4: iommu_pseries_alloc_group (STB_LOCAL)
```
</details>
</li>
<li>
