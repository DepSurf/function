# Function: <code>imx_clk_hw_mux</code>
...
```
In drivers/clk/imx/clk-imx8mm.c (ffff8000107d79d0)
Location: drivers/clk/imx/clk.h:388
Inline: True
Inline callers:
...
```
```
In drivers/clk/imx/clk-imx8mn.c (ffff8000107dacfc)
Location: drivers/clk/imx/clk.h:388
Inline: True
Inline callers:
...
```
```
In drivers/clk/imx/clk-imx8mq.c (ffff8000107dd878)
Location: drivers/clk/imx/clk.h:388
Inline: True
Inline callers:
...
```
In drivers/clk/imx/clk-imx5.c (c155bce0)
Location: drivers/clk/imx/clk.h:388
Inline: True
Inline callers:
...
```
```
In drivers/clk/imx/clk-imx6q.c (c155e5f4)
Location: drivers/clk/imx/clk.h:388
Inline: True
Inline callers:
...
```
```
In drivers/clk/imx/clk-imx6sl.c (c1562790)
Location: drivers/clk/imx/clk.h:388
Inline: True
Inline callers:
...
```
```
In drivers/clk/imx/clk-imx6sll.c (c1565414)
Location: drivers/clk/imx/clk.h:388
Inline: True
Inline callers:
...
```
```
In drivers/clk/imx/clk-imx6sx.c (c1568224)
Location: drivers/clk/imx/clk.h:388
Inline: True
Inline callers:
...
```
```
In drivers/clk/imx/clk-imx6ul.c (c156de04)
Location: drivers/clk/imx/clk.h:388
Inline: True
Inline callers:
...
```
```
In drivers/clk/imx/clk-imx7d.c (c1570b24)
Location: drivers/clk/imx/clk.h:388
Inline: True
Inline callers:
...
```
```
In drivers/clk/imx/clk-vf610.c (c157874c)
Location: drivers/clk/imx/clk.h:388
Inline: True
Inline callers:
