# Function: <code>its_encode_collection</code>
...
```
In drivers/irqchip/irq-gic-v3-its.c (ffff80001066fe7c)
Location: drivers/irqchip/irq-gic-v3-its.c:369
Inline: True
Inline callers:
...
```
In drivers/irqchip/irq-gic-v3-its.c (c08185c0)
Location: drivers/irqchip/irq-gic-v3-its.c:369
Inline: True
Inline callers:
  - drivers/irqchip/irq-gic-v3-its.c:its_build_invall_cmd
