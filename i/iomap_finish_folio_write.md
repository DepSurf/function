# Function: <code>iomap_finish_folio_write</code>
...
Location: fs/iomap/buffered-io.c:1268
Inline: True
Inline callers:
  - fs/iomap/buffered-io.c:iomap_finish_ioend
```
...
```
In fs/iomap/buffered-io.c (ffffffff8158a7d8)
Location: fs/iomap/buffered-io.c:1456
Inline: True
Inline callers:
  - fs/iomap/buffered-io.c:iomap_finish_ioend
```
