# Function: <code>iterate_discard</code>
...
```
In lib/iov_iter.c (ffffffff8185855b)
Location: include/linux/iov_iter.h:200
Inline: True
Inline callers:
...
```
```
In net/core/skbuff.c (ffffffff81ece43a)
Location: include/linux/iov_iter.h:200
Inline: True
Inline callers:
...
```
```
In net/core/datagram.c (ffffffff81edd7e4)
Location: include/linux/iov_iter.h:200
Inline: True
Inline callers:
