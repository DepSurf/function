# Function: <code>io_wqe_inc_running</code>
...
```
In fs/io-wq.c (ffffffff813f28d7)
...
```
In io_uring/io-wq.c (ffffffff816db455)
Location: io_uring/io-wq.c:311
Inline: True
Inline callers:
...
```
In io_uring/io-wq.c (ffffffff817a7505)
Location: io_uring/io-wq.c:313
Inline: True
Inline callers:
  - io_uring/io-wq.c:io_wq_worker_running
```
