# Function: <code>int3_emulate_pop</code>
...
Location: arch/x86/include/asm/text-patching.h:148
Inline: True
Inline callers:
...
Location: arch/x86/include/asm/text-patching.h:166
Inline: True
Inline callers:
  - arch/x86/kernel/alternative.c:poke_int3_handler
```
...
Location: arch/x86/include/asm/text-patching.h:167
Inline: True
Inline callers:
  - arch/x86/kernel/alternative.c:poke_int3_handler
```
...
Location: arch/x86/include/asm/text-patching.h:155
Inline: True
Inline callers:
  - arch/x86/kernel/alternative.c:poke_int3_handler
```
