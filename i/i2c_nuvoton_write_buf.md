...
```
In drivers/char/tpm/tpm_i2c_nuvoton.c (c0000000009675c0)
Location: drivers/char/tpm/tpm_i2c_nuvoton.c:64
Inline: False
Direct callers:
...
```
c0000000009675c0-c0000000009676a0: i2c_nuvoton_write_buf (STB_LOCAL)
```
</details>
</li>
<li>
