# Function: <code>its_encode_devid</code>
...
```
In drivers/irqchip/irq-gic-v3-its.c (ffff8000106702b8)
Location: drivers/irqchip/irq-gic-v3-its.c:334
Inline: True
Inline callers:
...
```
In drivers/irqchip/irq-gic-v3-its.c (c0818918)
Location: drivers/irqchip/irq-gic-v3-its.c:334
Inline: True
Inline callers:
  - drivers/irqchip/irq-gic-v3-its.c:its_build_vmovi_cmd
