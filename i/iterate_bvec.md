# Function: <code>iterate_bvec</code>
...
```
In lib/iov_iter.c (ffffffff818585aa)
Location: include/linux/iov_iter.h:108
Inline: True
Inline callers:
...
```
```
In net/core/skbuff.c (ffffffff81ece44c)
Location: include/linux/iov_iter.h:108
Inline: True
Inline callers:
...
```
```
In net/core/datagram.c (ffffffff81edd7f4)
Location: include/linux/iov_iter.h:108
Inline: True
Inline callers:
