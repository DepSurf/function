# Function: <code>in_entry_text</code>
...
```
In arch/arm/kernel/stacktrace.c (c030ee30)
Location: arch/arm/include/asm/sections.h:16
Inline: True
Inline callers:
...
```
```
In arch/arm/probes/kprobes/core.c (c0328114)
Location: arch/arm/include/asm/sections.h:16
Inline: True
Inline callers:
