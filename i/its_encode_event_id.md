# Function: <code>its_encode_event_id</code>
...
```
In drivers/irqchip/irq-gic-v3-its.c (ffff8000106702dc)
Location: drivers/irqchip/irq-gic-v3-its.c:339
Inline: True
Inline callers:
...
```
In drivers/irqchip/irq-gic-v3-its.c (c0818948)
Location: drivers/irqchip/irq-gic-v3-its.c:339
Inline: True
Inline callers:
  - drivers/irqchip/irq-gic-v3-its.c:its_build_vmovi_cmd
