...
```
In arch/powerpc/kernel/iommu.c (c000000000053100)
Location: arch/powerpc/kernel/iommu.c:939
Inline: False
Direct callers:
...
```
c000000000053100-c0000000000531e0: iommu_register_group (STB_GLOBAL)
```
</details>
</li>
<li>
