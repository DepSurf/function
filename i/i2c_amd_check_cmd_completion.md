...
```
In drivers/i2c/busses/i2c-amd-mp2-plat.c (ffffffff818688c0)
Location: drivers/i2c/busses/i2c-amd-mp2-plat.c:98
Inline: False
Direct callers:
...
```
ffffffff818688c0-ffffffff818689b3: i2c_amd_check_cmd_completion (STB_LOCAL)
```
</details>
</li>
<li>
