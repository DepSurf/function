# Function: <code>init_trace_eprobe_call</code>
...
Location: kernel/trace/trace_eprobe.c:800
Inline: True
Inline callers:
...
Location: kernel/trace/trace_eprobe.c:867
Inline: True
Inline callers:
  - kernel/trace/trace_eprobe.c:__trace_eprobe_create
```
...
Location: kernel/trace/trace_eprobe.c:843
Inline: True
Inline callers:
  - kernel/trace/trace_eprobe.c:__trace_eprobe_create
```
...
Location: kernel/trace/trace_eprobe.c:761
Inline: True
Inline callers:
  - kernel/trace/trace_eprobe.c:__trace_eprobe_create
```
