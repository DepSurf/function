# Function: <code>is_pset_node</code>
...
```
In drivers/base/property.c (ffffffff8155103f)
Location: drivers/base/property.c:22
Inline: True
Inline callers:
...
```
In drivers/base/property.c (ffffffff815a31f6)
...
```
In drivers/base/property.c (ffffffff815d1906)
Location: drivers/base/property.c:27
Inline: True
Inline callers:
  - drivers/base/property.c:device_remove_properties
...
```
In drivers/base/property.c (ffffffff815e6cd6)
Location: drivers/base/property.c:28
Inline: True
Inline callers:
  - drivers/base/property.c:device_remove_properties
  - drivers/base/property.c:device_remove_properties
...
Location: drivers/base/property.c:31
Inline: True
Inline callers:
  - drivers/base/property.c:device_remove_properties
  - drivers/base/property.c:device_remove_properties
...
Location: drivers/base/property.c:29
Inline: True
Inline callers:
  - drivers/base/property.c:device_remove_properties
  - drivers/base/property.c:device_remove_properties
