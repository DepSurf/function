# Function: <code>instrument_atomic_write</code>
...
Location: include/linux/instrumented.h:69
Inline: True
```
```
...
```
In arch/x86/events/core.c (0)
Location: include/linux/instrumented.h:84
Inline: True
```
```
In arch/x86/events/amd/core.c (0)
...
```
In arch/x86/coco/tdx/tdx.c (0)
Location: include/linux/instrumented.h:85
Inline: True
```
```
In arch/x86/events/core.c (0)
...
```
In arch/x86/coco/tdx/tdx.c (0)
Location: include/linux/instrumented.h:80
Inline: True
```
```
In arch/x86/events/core.c (0)
