...
```
In arch/arm/mach-omap2/id.c (c1511460)
Location: arch/arm/mach-omap2/soc.h:143
Inline: True
Inline callers:
...
```
```
In arch/arm/mach-omap2/i2c.c (c03369c4)
Location: arch/arm/mach-omap2/soc.h:143
Inline: True
Inline callers:
...
```
```
In arch/arm/mach-omap2/voltagedomains3xxx_data.c (c1517a64)
Location: arch/arm/mach-omap2/soc.h:143
Inline: True
Inline callers:
