...
```
In arch/x86/kernel/apic/x2apic_uv_x.c (ffffffff828bc8dd)
Location: arch/x86/include/asm/uv/uv_hub.h:259
Inline: True
Inline callers:
...
```
```
In arch/x86/platform/uv/tlb_uv.c (ffffffff828c9a61)
Location: arch/x86/include/asm/uv/uv_hub.h:259
Inline: True
Inline callers:
...
```
```
In arch/x86/platform/uv/uv_time.c (ffffffff810989b6)
Location: arch/x86/include/asm/uv/uv_hub.h:259
Inline: True
Inline callers:
...
```
```
In arch/x86/platform/uv/uv_nmi.c (ffffffff828ca138)
Location: arch/x86/include/asm/uv/uv_hub.h:259
Inline: True
Inline callers:
...
```
ffffffff8106d550-ffffffff8106d56d: is_uv2_hub.part.0 (STB_LOCAL)
ffffffff81095060-ffffffff8109507d: is_uv2_hub.part.0 (STB_LOCAL)
ffffffff81099350-ffffffff8109936d: is_uv2_hub.part.0 (STB_LOCAL)
```
</details>
</li>
<li>
...
```
In arch/x86/kernel/apic/x2apic_uv_x.c (ffffffff82ce1528)
...
```
```
In arch/x86/platform/uv/tlb_uv.c (ffffffff82cebf71)
Location: arch/x86/include/asm/uv/uv_hub.h:238
Inline: True
Inline callers:
  - arch/x86/platform/uv/tlb_uv.c:uv_bau_init
...
```
```
In arch/x86/platform/uv/uv_time.c (ffffffff8109e17d)
Location: arch/x86/include/asm/uv/uv_hub.h:238
Inline: True
Inline callers:
  - arch/x86/platform/uv/uv_time.c:uv_read_rtc
...
```
```
In arch/x86/platform/uv/uv_nmi.c (ffffffff8109f2f1)
Location: arch/x86/include/asm/uv/uv_hub.h:238
Inline: True
Inline callers:
  - arch/x86/platform/uv/uv_nmi.c:uv_handle_nmi
...
```
In arch/x86/kernel/apic/x2apic_uv_x.c (ffffffff82fce323)
Location: arch/x86/include/asm/uv/uv_hub.h:235
Inline: True
Inline callers:
  - arch/x86/kernel/apic/x2apic_uv_x.c:uv_system_init_hub
  - arch/x86/kernel/apic/x2apic_uv_x.c:build_socket_tables
...
```
In arch/x86/kernel/apic/x2apic_uv_x.c (ffffffff831d8e04)
Location: arch/x86/include/asm/uv/uv_hub.h:235
Inline: True
Inline callers:
  - arch/x86/kernel/apic/x2apic_uv_x.c:uv_system_init_hub
...
```
In arch/x86/kernel/apic/x2apic_uv_x.c (ffffffff832bc2cb)
Location: arch/x86/include/asm/uv/uv_hub.h:235
Inline: True
Inline callers:
  - arch/x86/kernel/apic/x2apic_uv_x.c:uv_system_init_hub
...
```
In arch/x86/kernel/apic/x2apic_uv_x.c (ffffffff8346dbf6)
Location: arch/x86/include/asm/uv/uv_hub.h:235
Inline: True
Inline callers:
  - arch/x86/kernel/apic/x2apic_uv_x.c:uv_system_init_hub
...
```
In arch/x86/kernel/apic/x2apic_uv_x.c (ffffffff83e93b95)
Location: arch/x86/include/asm/uv/uv_hub.h:235
Inline: True
Inline callers:
  - arch/x86/kernel/apic/x2apic_uv_x.c:uv_system_init_hub
...
```
In arch/x86/kernel/apic/x2apic_uv_x.c (ffffffff836b7701)
...
```
In arch/x86/kernel/apic/x2apic_uv_x.c (ffffffff838e8049)
Location: arch/x86/include/asm/uv/uv_hub.h:236
Inline: True
Inline callers:
  - arch/x86/kernel/apic/x2apic_uv_x.c:uv_system_init_hub
...
```
In arch/x86/kernel/apic/x2apic_uv_x.c (ffffffff828bd90a)
Location: arch/x86/include/asm/uv/uv_hub.h:259
Inline: True
Inline callers:
  - arch/x86/kernel/apic/x2apic_uv_x.c:uv_system_init_hub
...
```
```
In arch/x86/platform/uv/tlb_uv.c (ffffffff828caa9e)
Location: arch/x86/include/asm/uv/uv_hub.h:259
Inline: True
Inline callers:
  - arch/x86/platform/uv/tlb_uv.c:uv_bau_init
...
```
```
In arch/x86/platform/uv/uv_time.c (ffffffff81099e86)
Location: arch/x86/include/asm/uv/uv_hub.h:259
Inline: True
Inline callers:
  - arch/x86/platform/uv/uv_time.c:uv_read_rtc
...
```
```
In arch/x86/platform/uv/uv_nmi.c (ffffffff828cb175)
Location: arch/x86/include/asm/uv/uv_hub.h:259
Inline: True
Inline callers:
  - arch/x86/platform/uv/uv_nmi.c:uv_nmi_setup
...
```
ffffffff8106ec20-ffffffff8106ec3d: is_uv2_hub.part.0 (STB_LOCAL)
ffffffff81096520-ffffffff8109653d: is_uv2_hub.part.0 (STB_LOCAL)
ffffffff8109a820-ffffffff8109a83d: is_uv2_hub.part.0 (STB_LOCAL)
```
</details>
</li>
</ul>
