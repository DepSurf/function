# Function: <code>init_layer_masks</code>
...
```
In security/landlock/fs.c (ffffffff8163af04)
Location: security/landlock/fs.c:300
Inline: True
Inline callers:
...
```
In security/landlock/fs.c (ffffffff816f26a0)
...
```
In security/landlock/fs.c (ffffffff8172cade)
Location: security/landlock/fs.c:315
Inline: True
Inline callers:
  - security/landlock/fs.c:hook_file_open
