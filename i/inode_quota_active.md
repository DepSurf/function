# Function: <code>inode_quota_active</code>
...
```
In fs/quota/dquot.c (ffffffff81560480)
Location: fs/quota/dquot.c:1486
Inline: True
Inline callers:
...
```
In fs/quota/dquot.c (ffffffff81596b70)
Location: fs/quota/dquot.c:1440
Inline: True
Inline callers:
  - fs/quota/dquot.c:dquot_transfer
  - fs/quota/dquot.c:dquot_free_inode
