# Function: <code>imx_clk_divider</code>
...
```
In drivers/clk/imx/clk-imx8mq.c (ffff8000107ddba8)
Location: drivers/clk/imx/clk.h:231
Inline: True
Inline callers:
...
```
In drivers/clk/imx/clk-imx5.c (c155bec4)
Location: drivers/clk/imx/clk.h:231
Inline: True
Inline callers:
...
```
```
In drivers/clk/imx/clk-vf610.c (c15793e4)
Location: drivers/clk/imx/clk.h:231
Inline: True
Inline callers:
