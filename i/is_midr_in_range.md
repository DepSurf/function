# Function: <code>is_midr_in_range</code>
...
```
In arch/arm64/kernel/irq.c (ffff800011433768)
Location: arch/arm64/include/asm/cputype.h:165
Inline: True
Inline callers:
  - arch/arm64/kernel/irq.c:init_IRQ
```
```
In arch/arm64/kernel/setup.c (ffff80001008f768)
Location: arch/arm64/include/asm/cputype.h:165
Inline: True
```
```
...
```
```
In arch/arm64/kernel/efi.c (ffff8000100a78d8)
Location: arch/arm64/include/asm/cputype.h:165
Inline: True
```
```
...
```
```
In arch/arm64/kernel/kaslr.c (ffff800011436d44)
Location: arch/arm64/include/asm/cputype.h:165
Inline: True
Inline callers:
...
```
```
In mm/page_alloc.c (ffff800011458238)
Location: arch/arm64/include/asm/cputype.h:165
Inline: True
Inline callers:
...
```
```
In mm/sparse-vmemmap.c (ffff800010da0d9c)
Location: arch/arm64/include/asm/cputype.h:165
Inline: True
Inline callers:
...
```
```
In mm/early_ioremap.c (ffff8000103768f8)
Location: arch/arm64/include/asm/cputype.h:165
Inline: True
```
```
...
```
```
In drivers/irqchip/irq-dw-apb-ictl.c (ffff800011470c80)
Location: arch/arm64/include/asm/cputype.h:165
Inline: True
Inline callers:
...
```
```
In drivers/irqchip/irq-gic.c (ffff80001066cd2c)
Location: arch/arm64/include/asm/cputype.h:165
Inline: True
```
```
In drivers/irqchip/irq-gic-v2m.c (ffff800011471f64)
Location: arch/arm64/include/asm/cputype.h:165
Inline: True
Inline callers:
...
```
```
In drivers/irqchip/irq-gic-v3.c (ffff80001066f848)
Location: arch/arm64/include/asm/cputype.h:165
Inline: True
```
```
In drivers/irqchip/irq-gic-v3-its.c (ffff800011473ac8)
Location: arch/arm64/include/asm/cputype.h:165
Inline: True
Inline callers:
...
```
```
In drivers/irqchip/irq-bcm7038-l1.c (ffff800011475324)
Location: arch/arm64/include/asm/cputype.h:165
Inline: True
Inline callers:
...
```
```
In drivers/video/fbdev/imsttfb.c (ffff80001075ae4c)
Location: arch/arm64/include/asm/cputype.h:165
Inline: True
```
```
In drivers/video/fbdev/amba-clcd.c (ffff80001075c810)
Location: arch/arm64/include/asm/cputype.h:165
Inline: True
Inline callers:
...
```
```
In drivers/video/fbdev/efifb.c (ffff80001075e3ac)
Location: arch/arm64/include/asm/cputype.h:165
Inline: True
```
```
...
```
```
In drivers/clk/clk-qoriq.c (ffff800011483df0)
Location: arch/arm64/include/asm/cputype.h:165
Inline: True
Inline callers:
...
```
```
In drivers/dma/ipu/ipu_idmac.c (ffff80001080d8c0)
Location: arch/arm64/include/asm/cputype.h:165
Inline: True
```
```
...
```
```
In drivers/soc/renesas/renesas-soc.c (ffff800011490ccc)
Location: arch/arm64/include/asm/cputype.h:165
Inline: True
Inline callers:
...
```
```
In drivers/xen/xlate_mmu.c (ffff8000114923f8)
Location: arch/arm64/include/asm/cputype.h:165
Inline: True
Inline callers:
...
```
```
In drivers/reset/reset-sunxi.c (ffff800011492994)
Location: arch/arm64/include/asm/cputype.h:165
Inline: True
Inline callers:
...
```
```
In drivers/tty/serial/earlycon.c (ffff800011493c84)
Location: arch/arm64/include/asm/cputype.h:165
Inline: True
```
```
...
```
```
In drivers/clocksource/arm_arch_timer.c (ffff800010b67f54)
Location: arch/arm64/include/asm/cputype.h:165
Inline: True
```
```
