# Function: <code>io_rsrc_put_node</code>
...
```
In io_uring/io_uring.c (ffffffff816d5847)
Location: io_uring/io_uring.c:1375
Inline: True
Inline callers:
...
```
In io_uring/io_uring.c (ffffffff8178ec20)
Location: io_uring/rsrc.h:110
Inline: True
Inline callers:
  - io_uring/io_uring.c:io_free_batch_list
  - io_uring/io_uring.c:io_free_req
