# Function: <code>i_uid_into_mnt</code>
...
Location: include/linux/fs.h:1616
Inline: True
Inline callers:
...
```
```
In fs/posix_acl.c (ffffffff813be9b4)
Location: include/linux/fs.h:1616
Inline: True
Inline callers:
...
Location: include/linux/fs.h:1666
Inline: True
Inline callers:
  - kernel/capability.c:privileged_wrt_inode_uidgid
```
...
```
```
In fs/posix_acl.c (ffffffff8140e7e4)
Location: include/linux/fs.h:1666
Inline: True
Inline callers:
  - fs/posix_acl.c:posix_acl_permission
...
Location: include/linux/fs.h:1606
Inline: True
Inline callers:
  - kernel/capability.c:privileged_wrt_inode_uidgid
```
...
```
```
In fs/posix_acl.c (ffffffff81483e1e)
Location: include/linux/fs.h:1606
Inline: True
Inline callers:
  - fs/posix_acl.c:posix_acl_permission
