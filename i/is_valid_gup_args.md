...
```
In mm/gup.c (ffffffff813e6b73)
Location: mm/gup.c:2209
Inline: True
Inline callers:
...
```
ffffffff813e23f0-ffffffff813e24d8: is_valid_gup_args (STB_LOCAL)
```
</details>
</li>
<li>
...
```
In mm/gup.c (ffffffff81411803)
Location: mm/gup.c:2235
Inline: True
Inline callers:
  - mm/gup.c:pin_user_pages_unlocked
  - mm/gup.c:pin_user_pages
...
```
ffffffff8140cc20-ffffffff8140cd05: is_valid_gup_args (STB_LOCAL)
```
</details>
</li>
</ul>
