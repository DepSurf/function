# Function: <code>imx_clk_hw_fixed_factor</code>
...
```
In drivers/clk/imx/clk-imx8mm.c (ffff8000107d8304)
Location: drivers/clk/imx/clk.h:224
Inline: True
Inline callers:
...
```
```
In drivers/clk/imx/clk-imx8mn.c (ffff8000107db638)
Location: drivers/clk/imx/clk.h:224
Inline: True
Inline callers:
...
```
```
In drivers/clk/imx/clk-imx8mq.c (ffff8000107de12c)
Location: drivers/clk/imx/clk.h:224
Inline: True
Inline callers:
...
```
In drivers/clk/imx/clk-imx5.c (c155bdf4)
Location: drivers/clk/imx/clk.h:224
Inline: True
Inline callers:
...
```
```
In drivers/clk/imx/clk-imx6q.c (c155da94)
Location: drivers/clk/imx/clk.h:224
Inline: True
Inline callers:
...
```
```
In drivers/clk/imx/clk-imx6sl.c (c15632f4)
Location: drivers/clk/imx/clk.h:224
Inline: True
Inline callers:
...
```
```
In drivers/clk/imx/clk-imx6sll.c (c156598c)
Location: drivers/clk/imx/clk.h:224
Inline: True
Inline callers:
...
```
```
In drivers/clk/imx/clk-imx6sx.c (c1568ac8)
Location: drivers/clk/imx/clk.h:224
Inline: True
Inline callers:
...
```
```
In drivers/clk/imx/clk-imx6ul.c (c156cf7c)
Location: drivers/clk/imx/clk.h:224
Inline: True
Inline callers:
...
```
```
In drivers/clk/imx/clk-imx7d.c (c15713fc)
Location: drivers/clk/imx/clk.h:224
Inline: True
Inline callers:
...
```
```
In drivers/clk/imx/clk-vf610.c (c15786d4)
Location: drivers/clk/imx/clk.h:224
Inline: True
Inline callers:
