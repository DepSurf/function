# Function: <code>its_encode_target</code>
...
```
In drivers/irqchip/irq-gic-v3-its.c (ffff800010671d40)
Location: drivers/irqchip/irq-gic-v3-its.c:364
Inline: True
Inline callers:
...
```
In drivers/irqchip/irq-gic-v3-its.c (c0819290)
Location: drivers/irqchip/irq-gic-v3-its.c:364
Inline: True
Inline callers:
  - drivers/irqchip/irq-gic-v3-its.c:its_send_single_command
