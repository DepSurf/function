...
```
In fs/io_uring.c (ffffffff813950e2)
Location: fs/io_uring.c:1778
Inline: True
Inline callers:
...
```
In fs/io_uring.c (ffffffff813e873b)
Location: fs/io_uring.c:1731
Inline: True
Inline callers:
  - fs/io_uring.c:io_iopoll_complete
  - fs/io_uring.c:io_submit_flush_completions
...
```
In io_uring/io_uring.c (ffffffff816d57d1)
Location: io_uring/io_uring.c:2167
Inline: True
Inline callers:
...
```
ffffffff816cb3f0-ffffffff816cb427: io_put_task (STB_LOCAL)
```
</details>
</li>
<li>
...
```
In io_uring/io_uring.c (ffffffff8178ebb1)
...
```
In io_uring/io_uring.c (ffffffff817cffb5)
Location: io_uring/io_uring.c:748
Inline: True
Inline callers:
  - io_uring/io_uring.c:io_free_batch_list
```
...
```
In io_uring/io_uring.c (ffffffff81813145)
