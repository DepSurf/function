...
```
In arch/powerpc/sysdev/xics/xics-common.c (c0000000000ba760)
Location: arch/powerpc/sysdev/xics/xics-common.c:278
Inline: False
Direct callers:
...
```
c0000000000ba760-c0000000000ba89c: xics_get_irq_server (STB_GLOBAL)
```
</details>
</li>
<li>
