# Function: <code>get_kernel_vsid</code>
...
```
In arch/powerpc/kernel/process.c (c000000000022284)
Location: arch/powerpc/include/asm/book3s/64/mmu-hash.h:832
Inline: True
Inline callers:
...
```
```
In arch/powerpc/mm/book3s64/slb.c (c00000000008f7a0)
Location: arch/powerpc/include/asm/book3s/64/mmu-hash.h:832
Inline: True
Inline callers:
...
```
```
In arch/powerpc/mm/book3s64/hash_native.c (c000000000093cd4)
Location: arch/powerpc/include/asm/book3s/64/mmu-hash.h:832
Inline: True
Inline callers:
...
```
```
In arch/powerpc/platforms/pseries/lpar.c (c0000000000ea2f4)
Location: arch/powerpc/include/asm/book3s/64/mmu-hash.h:832
Inline: True
Inline callers:
