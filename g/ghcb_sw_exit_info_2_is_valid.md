# Function: <code>ghcb_sw_exit_info_2_is_valid</code>
...
```
In arch/x86/kernel/sev-es.c (ffffffff810827fe)
...
```
In arch/x86/kernel/sev.c (ffffffff81084bdf)
...
```
In arch/x86/kernel/sev.c (ffffffff81093d9f)
...
```
In arch/x86/kernel/sev.c (ffffffff810a3b4b)
...
```
In arch/x86/kernel/sev.c (ffffffff810bbfab)
...
```
In arch/x86/kernel/sev.c (ffffffff810bf2bb)
...
```
In arch/x86/kernel/sev.c (ffffffff810c660b)
