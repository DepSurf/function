# Function: <code>get_sigset_argpack</code>
...
```
In fs/select.c (ffffffff81338d40)
Location: fs/select.c:774
Inline: True
Direct callers:
  - fs/select.c:__ia32_sys_pselect6
...
```
ffffffff81338d40-ffffffff81338da4: get_sigset_argpack.constprop.0 (STB_LOCAL)
```
</details>
</li>
<li>
