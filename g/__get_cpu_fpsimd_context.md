...
```
In arch/arm64/kernel/fpsimd.c (ffff8000100872b0)
Location: arch/arm64/kernel/fpsimd.c:152
Inline: True
Direct callers:
...
```
ffff8000100872b0-ffff8000100872f4: __get_cpu_fpsimd_context (STB_LOCAL)
```
</details>
</li>
<li>
