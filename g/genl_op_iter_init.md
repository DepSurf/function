# Function: <code>genl_op_iter_init</code>
...
```
In net/netlink/genetlink.c (ffffffff81e6fd75)
...
```
In net/netlink/genetlink.c (ffffffff81ecb645)
Location: net/netlink/genetlink.c:322
Inline: True
Inline callers:
  - net/netlink/genetlink.c:ctrl_dumppolicy_start
...
```
In net/netlink/genetlink.c (ffffffff81f8eb64)
