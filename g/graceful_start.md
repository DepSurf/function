# Function: <code>graceful_start</code>
...
```
In drivers/net/ethernet/freescale/fman/fman_dtsec.c (ffff8000109f4700)
Location: drivers/net/ethernet/freescale/fman/fman_dtsec.c:868
Inline: True
Direct callers:
...
```
ffff8000109f4700-ffff8000109f4788: graceful_start.isra.0 (STB_LOCAL)
```
</details>
</li>
<li>
