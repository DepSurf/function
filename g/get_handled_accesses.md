# Function: <code>get_handled_accesses</code>
...
```
In security/landlock/fs.c (ffffffff8163a3bd)
Location: security/landlock/fs.c:278
Inline: True
Inline callers:
...
Location: security/landlock/fs.c:291
Inline: True
Inline callers:
