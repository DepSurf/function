# Function: <code>__gic_writeq_nonatomic</code>
...
```
In drivers/irqchip/irq-gic-v3.c (c154bbd8)
Location: arch/arm/include/asm/arch_gicv3.h:262
Inline: True
Inline callers:
...
```
```
In drivers/irqchip/irq-gic-v3-its.c (c081a4a4)
Location: arch/arm/include/asm/arch_gicv3.h:262
Inline: True
Inline callers:
