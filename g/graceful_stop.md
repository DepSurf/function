# Function: <code>graceful_stop</code>
...
```
In drivers/net/ethernet/freescale/fman/fman_dtsec.c (ffff8000109f4b40)
Location: drivers/net/ethernet/freescale/fman/fman_dtsec.c:880
Inline: True
Direct callers:
...
```
ffff8000109f4b40-ffff8000109f4c40: graceful_stop.isra.0 (STB_LOCAL)
```
</details>
</li>
<li>
