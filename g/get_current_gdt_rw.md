# Function: <code>get_current_gdt_rw</code>
...
Location: arch/x86/include/asm/desc.h:56
Inline: True
Inline callers:
...
Location: arch/x86/include/asm/desc.h:61
Inline: True
Inline callers:
  - arch/x86/kernel/ioport.c:sys_ioperm
```
...
Location: arch/x86/include/asm/desc.h:57
Inline: True
Inline callers:
  - arch/x86/kernel/process.c:native_tss_update_io_bitmap
```
...
```
In arch/x86/kernel/process.c (ffffffff81066899)
Location: arch/x86/include/asm/desc.h:57
Inline: True
Inline callers:
