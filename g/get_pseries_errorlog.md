...
```
In arch/powerpc/kernel/rtas.c (c00000000003f460)
Location: arch/powerpc/kernel/rtas.c:1031
Inline: False
Direct callers:
...
```
c00000000003f460-c00000000003f4e8: get_pseries_errorlog (STB_GLOBAL)
```
</details>
</li>
<li>
