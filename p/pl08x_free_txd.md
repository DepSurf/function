...
```
In drivers/dma/amba-pl08x.c (ffff8000108001c0)
Location: drivers/dma/amba-pl08x.c:1492
Inline: True
Direct callers:
...
```
ffff8000108001c0-ffff800010800268: pl08x_free_txd.isra.0 (STB_LOCAL)
```
</details>
</li>
<li>
...
```
In drivers/dma/amba-pl08x.c (c092055c)
Location: drivers/dma/amba-pl08x.c:1492
Inline: False
Direct callers:
  - drivers/dma/amba-pl08x.c:pl08x_prep_dma_cyclic
...
```
c092055c-c09205e8: pl08x_free_txd (STB_LOCAL)
```
</details>
</li>
<li>
