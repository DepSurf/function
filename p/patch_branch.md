...
```
In arch/powerpc/lib/code-patching.c (c0000000000a6f40)
Location: arch/powerpc/lib/code-patching.c:197
Inline: False
Direct callers:
...
```
c0000000000a6f40-c0000000000a6f90: patch_branch (STB_GLOBAL)
```
</details>
</li>
<li>
