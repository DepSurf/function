...
```
In arch/powerpc/kernel/prom_init.c (c000000001340600)
Location: arch/powerpc/kernel/prom_init.c:633
Inline: False
Direct callers:
...
```
c000000001340600-c000000001340654: prom_getprop (STB_LOCAL)
```
</details>
</li>
<li>
