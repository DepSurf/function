# Function: <code>prep_new_hugetlb_folio</code>
...
```
In mm/hugetlb.c (ffffffff83ec3d9e)
Location: mm/hugetlb.c:1941
Inline: True
Inline callers:
...
```
In mm/hugetlb.c (ffffffff836e8e4f)
Location: mm/hugetlb.c:1964
Inline: True
Inline callers:
  - mm/hugetlb.c:hugetlb_init
