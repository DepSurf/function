...
```
In kernel/sched/wait.c (ffffffff810c38c0)
...
```
ffffffff810c38c0-ffffffff810c39ad: prepare_to_wait_event (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In kernel/sched/wait.c (ffffffff810c7250)
Location: kernel/sched/wait.c:199
Inline: False
Direct callers:
  - kernel/kmod.c:__usermodehelper_disable
...
```
ffffffff810c7250-ffffffff810c733d: prepare_to_wait_event (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In kernel/sched/wait.c (ffffffff810cd110)
Location: kernel/sched/wait.c:208
Inline: False
Direct callers:
  - kernel/kmod.c:__usermodehelper_disable
  - kernel/kmod.c:__usermodehelper_disable
...
```
ffffffff810cd110-ffffffff810cd20b: prepare_to_wait_event (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In kernel/sched/wait.c (ffffffff810c9870)
...
```
ffffffff810c9870-ffffffff810c9961: prepare_to_wait_event (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In kernel/sched/wait.c (ffffffff810d1090)
...
```
ffffffff810d1090-ffffffff810d1184: prepare_to_wait_event (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In kernel/sched/wait.c (ffffffff810d9570)
Location: kernel/sched/wait.c:259
Inline: False
Direct callers:
  - kernel/umh.c:__usermodehelper_disable
  - kernel/umh.c:__usermodehelper_disable
...
```
ffffffff810d9570-ffffffff810d965e: prepare_to_wait_event (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In kernel/sched/wait.c (ffffffff810e3070)
...
```
ffffffff810e3070-ffffffff810e3156: prepare_to_wait_event (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In kernel/sched/wait.c (ffffffff810e9ce0)
Location: kernel/sched/wait.c:258
Inline: False
Direct callers:
  - arch/x86/kernel/cpu/resctrl/pseudo_lock.c:rdtgroup_pseudo_lock_create
  - arch/x86/kernel/cpu/resctrl/pseudo_lock.c:pseudo_lock_measure_trigger
...
```
ffffffff810e9ce0-ffffffff810e9dd0: prepare_to_wait_event (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In kernel/sched/wait.c (ffffffff810f56b0)
Location: kernel/sched/wait.c:258
Inline: False
Direct callers:
  - arch/x86/kernel/cpu/resctrl/pseudo_lock.c:rdtgroup_pseudo_lock_create
...
```
ffffffff810f56b0-ffffffff810f57a0: prepare_to_wait_event (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In kernel/sched/wait.c (ffffffff810fef30)
Location: kernel/sched/wait.c:275
Inline: False
Direct callers:
  - arch/x86/kernel/cpu/resctrl/pseudo_lock.c:rdtgroup_pseudo_lock_create
...
```
ffffffff810fef30-ffffffff810ff02b: prepare_to_wait_event (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In kernel/sched/wait.c (ffffffff810fd7a0)
Location: kernel/sched/wait.c:290
Inline: False
Direct callers:
  - arch/x86/kernel/cpu/resctrl/pseudo_lock.c:rdtgroup_pseudo_lock_create
  - arch/x86/kernel/cpu/resctrl/pseudo_lock.c:pseudo_lock_measure_cycles
...
```
ffffffff810fd7a0-ffffffff810fd8cd: prepare_to_wait_event (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In kernel/sched/wait.c (ffffffff810ffb80)
Location: kernel/sched/wait.c:295
Inline: False
Direct callers:
  - arch/x86/kernel/cpu/resctrl/pseudo_lock.c:rdtgroup_pseudo_lock_create
  - arch/x86/kernel/cpu/resctrl/pseudo_lock.c:pseudo_lock_measure_cycles
...
```
ffffffff810ffb80-ffffffff810ffcad: prepare_to_wait_event (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In kernel/sched/wait.c (ffffffff8111bc80)
Location: kernel/sched/wait.c:303
Inline: False
Direct callers:
  - arch/x86/kernel/cpu/resctrl/pseudo_lock.c:rdtgroup_pseudo_lock_create
  - arch/x86/kernel/cpu/resctrl/pseudo_lock.c:pseudo_lock_measure_cycles
...
```
ffffffff8111bc80-ffffffff8111bd95: prepare_to_wait_event (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In kernel/sched/build_utility.c (ffffffff8113faa0)
...
```
ffffffff8113faa0-ffffffff8113fbc6: prepare_to_wait_event (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In kernel/sched/build_utility.c (ffffffff8116a680)
Location: kernel/sched/wait.c:306
Inline: False
Direct callers:
  - arch/x86/kernel/cpu/resctrl/pseudo_lock.c:rdtgroup_pseudo_lock_create
  - arch/x86/kernel/cpu/resctrl/pseudo_lock.c:pseudo_lock_measure_cycles
...
```
ffffffff8116a680-ffffffff8116a7a6: prepare_to_wait_event (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In kernel/sched/build_utility.c (ffffffff8117ad90)
Location: kernel/sched/wait.c:306
Inline: False
Direct callers:
  - arch/x86/kernel/cpu/resctrl/pseudo_lock.c:rdtgroup_pseudo_lock_create
...
```
ffffffff8117ad90-ffffffff8117aebb: prepare_to_wait_event (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In kernel/sched/build_utility.c (ffffffff811887a0)
Location: kernel/sched/wait.c:271
Inline: False
Direct callers:
  - arch/x86/kernel/cpu/resctrl/pseudo_lock.c:rdtgroup_pseudo_lock_create
  - arch/x86/kernel/cpu/resctrl/pseudo_lock.c:pseudo_lock_measure_cycles
...
```
ffffffff811887a0-ffffffff811888cb: prepare_to_wait_event (STB_GLOBAL)
```
</details>
</li>
</ul>
...
```
In kernel/sched/wait.c (ffff800010158250)
Location: kernel/sched/wait.c:258
Inline: False
Direct callers:
  - kernel/umh.c:__usermodehelper_disable
...
```
ffff800010158250-ffff8000101583b8: prepare_to_wait_event (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In kernel/sched/wait.c (c03a5e1c)
Location: kernel/sched/wait.c:258
Inline: False
Direct callers:
...
```
c03a5e1c-c03a5f68: prepare_to_wait_event (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In kernel/sched/wait.c (c0000000001aceb0)
Location: kernel/sched/wait.c:258
Inline: False
Direct callers:
...
```
c0000000001aceb0-c0000000001ad018: prepare_to_wait_event (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In kernel/sched/wait.c (ffffffe0000feccc)
Location: kernel/sched/wait.c:258
Inline: False
Direct callers:
  - kernel/umh.c:__usermodehelper_disable
...
```
ffffffe0000feccc-ffffffe0000fed86: prepare_to_wait_event (STB_GLOBAL)
```
</details>
</li>
</ul>
...
```
In kernel/sched/wait.c (ffffffff810eeab0)
Location: kernel/sched/wait.c:258
Inline: False
Direct callers:
  - arch/x86/kernel/cpu/resctrl/pseudo_lock.c:rdtgroup_pseudo_lock_create
...
```
ffffffff810eeab0-ffffffff810eeba0: prepare_to_wait_event (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In kernel/sched/wait.c (ffffffff810deb40)
Location: kernel/sched/wait.c:258
Inline: False
Direct callers:
  - arch/x86/kernel/cpu/resctrl/pseudo_lock.c:rdtgroup_pseudo_lock_create
...
```
ffffffff810deb40-ffffffff810dec30: prepare_to_wait_event (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In kernel/sched/wait.c (ffffffff810ebbe0)
Location: kernel/sched/wait.c:258
Inline: False
Direct callers:
  - arch/x86/kernel/cpu/resctrl/pseudo_lock.c:rdtgroup_pseudo_lock_create
...
```
ffffffff810ebbe0-ffffffff810ebcd0: prepare_to_wait_event (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In kernel/sched/wait.c (ffffffff810f6c40)
Location: kernel/sched/wait.c:258
Inline: False
Direct callers:
  - arch/x86/kernel/cpu/resctrl/pseudo_lock.c:rdtgroup_pseudo_lock_create
...
```
ffffffff810f6c40-ffffffff810f6d30: prepare_to_wait_event (STB_GLOBAL)
```
</details>
</li>
</ul>
