...
```
In arch/powerpc/kernel/rtas-proc.c (c000000000040fd0)
Location: arch/powerpc/kernel/rtas-proc.c:457
Inline: False
Direct callers:
...
```
c000000000040fd0-c0000000000410dc: ppc_rtas_process_error (STB_LOCAL)
```
</details>
</li>
<li>
