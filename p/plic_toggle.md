...
```
In drivers/irqchip/irq-sifive-plic.c (ffffffe000495ae2)
Location: drivers/irqchip/irq-sifive-plic.c:72
Inline: True
Inline callers:
...
```
ffffffe00049557a-ffffffe000495646: plic_toggle (STB_LOCAL)
```
</details>
</li>
</ul>
