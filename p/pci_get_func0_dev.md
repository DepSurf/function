# Function: <code>pci_get_func0_dev</code>
...
```
In drivers/pci/vpd.c (ffffffff8163a67d)
...
```
In drivers/pci/vpd.c (ffffffff816aaf2d)
...
```
In drivers/pci/vpd.c (ffffffff817cdf47)
Location: drivers/pci/vpd.c:43
Inline: True
Inline callers:
  - drivers/pci/vpd.c:quirk_f0_vpd_link
...
```
In drivers/pci/vpd.c (ffffffff818ed917)
Location: drivers/pci/vpd.c:43
Inline: True
Inline callers:
  - drivers/pci/vpd.c:quirk_f0_vpd_link
...
```
In drivers/pci/vpd.c (ffffffff81930e17)
Location: drivers/pci/vpd.c:43
Inline: True
Inline callers:
  - drivers/pci/vpd.c:quirk_f0_vpd_link
...
```
In drivers/pci/vpd.c (ffffffff81979807)
Location: drivers/pci/vpd.c:43
Inline: True
Inline callers:
  - drivers/pci/vpd.c:quirk_f0_vpd_link
