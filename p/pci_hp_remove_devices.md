...
```
In arch/powerpc/kernel/pci-hotplug.c (c00000000006b190)
Location: arch/powerpc/kernel/pci-hotplug.c:79
Inline: False
Direct callers:
...
```
c00000000006b190-c00000000006b2b8: pci_hp_remove_devices (STB_GLOBAL)
```
</details>
</li>
<li>
