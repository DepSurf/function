# Function: <code>__put_unaligned_be16</code>
...
```
In kernel/debug/gdbstub.c (c043c9c0)
Location: include/linux/unaligned/be_byteshift.h:23
Inline: True
Inline callers:
...
```
```
In fs/ecryptfs/mmap.c (c06b38e4)
Location: include/linux/unaligned/be_byteshift.h:23
Inline: True
```
```
In fs/ecryptfs/crypto.c (c06b5b1c)
Location: include/linux/unaligned/be_byteshift.h:23
Inline: True
Inline callers:
...
```
```
In crypto/sha1_generic.c (c0773fb4)
Location: include/linux/unaligned/be_byteshift.h:23
Inline: True
Inline callers:
...
```
```
In crypto/sha512_generic.c (c0775818)
Location: include/linux/unaligned/be_byteshift.h:23
Inline: True
Inline callers:
...
```
```
In lib/crypto/sha256.c (c07e38f0)
Location: include/linux/unaligned/be_byteshift.h:23
Inline: True
Inline callers:
...
```
```
In lib/xz/xz_dec_bcj.c (c080762c)
Location: include/linux/unaligned/be_byteshift.h:23
Inline: True
Inline callers:
...
```
```
In drivers/scsi/scsi.c (c0a43708)
Location: include/linux/unaligned/be_byteshift.h:23
Inline: True
Inline callers:
...
```
```
In drivers/scsi/scsi_scan.c (c0a4f46c)
Location: include/linux/unaligned/be_byteshift.h:23
Inline: True
Inline callers:
...
```
```
In drivers/scsi/scsi_common.c (c0a56e64)
Location: include/linux/unaligned/be_byteshift.h:23
Inline: True
```
```
...
```
```
In drivers/scsi/sd_zbc.c (c0a5dd04)
Location: include/linux/unaligned/be_byteshift.h:23
Inline: True
Inline callers:
...
```
In fs/ecryptfs/mmap.c (ffffffe000364df4)
Location: include/linux/unaligned/be_byteshift.h:23
Inline: True
```
```
...
```
```
In crypto/sha1_generic.c (ffffffe00040b446)
Location: include/linux/unaligned/be_byteshift.h:23
Inline: True
Inline callers:
  - crypto/sha1_generic.c:sha1_final
...
```
```
In lib/crypto/sha256.c (ffffffe00046b1c2)
Location: include/linux/unaligned/be_byteshift.h:23
Inline: True
Inline callers:
  - lib/crypto/sha256.c:__sha256_final
...
```
```
In lib/xz/xz_dec_bcj.c (ffffffe00048b918)
Location: include/linux/unaligned/be_byteshift.h:23
Inline: True
Inline callers:
  - lib/xz/xz_dec_bcj.c:bcj_apply
...
```
```
In drivers/mmc/host/mmc_spi.c (ffffffe00071b2b0)
Location: include/linux/unaligned/be_byteshift.h:23
Inline: True
Inline callers:
