...
```
In drivers/dma/amba-pl08x.c (ffff8000107ffb70)
Location: drivers/dma/amba-pl08x.c:350
Inline: False
Direct callers:
...
```
ffff8000107ffb70-ffff8000107ffbe0: pl08x_release_mux (STB_LOCAL)
```
</details>
</li>
<li>
...
```
In drivers/dma/amba-pl08x.c (c09203f4)
Location: drivers/dma/amba-pl08x.c:350
Inline: False
Direct callers:
  - drivers/dma/amba-pl08x.c:pl08x_irq
...
```
c09203f4-c092047c: pl08x_release_mux (STB_LOCAL)
```
</details>
</li>
<li>
