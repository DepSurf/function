...
```
In kernel/memremap.c (ffffffff811c9280)
Location: kernel/memremap.c:508
Inline: True
Direct callers:
...
```
ffffffff811c9280-ffffffff811c92e9: put_zone_device_private_or_public_page (STB_GLOBAL)
```
</details>
</li>
<li>
