# Function: <code>__printk_recursion_counter</code>
...
Location: kernel/printk/printk.c:1958
Inline: True
Inline callers:
...
Location: kernel/printk/printk.c:1972
Inline: True
Inline callers:
  - kernel/printk/printk.c:vprintk_store
```
...
Location: kernel/printk/printk.c:2008
Inline: True
Inline callers:
  - kernel/printk/printk.c:vprintk_store
```
...
```
In kernel/printk/printk.c (ffffffff811b0e22)
Location: kernel/printk/printk.c:2004
Inline: True
Inline callers:
  - kernel/printk/printk.c:vprintk_store
```
