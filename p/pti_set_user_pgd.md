# Function: <code>pti_set_user_pgd</code>
...
```
In arch/x86/kernel/paravirt.c (ffffffff8106b0e8)
Location: arch/x86/include/asm/pgtable_64.h:206
Inline: True
Inline callers:
...
Location: arch/x86/include/asm/pgtable_64.h:207
Inline: True
Inline callers:
  - arch/x86/kernel/paravirt.c:native_set_p4d
```
