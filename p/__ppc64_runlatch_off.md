...
```
In arch/powerpc/kernel/process.c (c000000000022e10)
Location: arch/powerpc/kernel/process.c:2127
Inline: False
Direct callers:
...
```
c000000000022e10-c000000000022e30: __ppc64_runlatch_off (STB_GLOBAL)
```
</details>
</li>
<li>
