# Function: <code>pmd_hugepage_update</code>
...
Location: arch/powerpc/include/asm/book3s/64/pgtable.h:1154
Inline: True
Inline callers:
  - arch/powerpc/mm/book3s64/hash_pgtable.c:hash__pmdp_huge_get_and_clear
```
```
In arch/powerpc/mm/book3s64/pgtable.c (c000000000090c8c)
Location: arch/powerpc/include/asm/book3s/64/pgtable.h:1154
Inline: True
Inline callers:
...
```
```
In mm/huge_memory.c (c00000000043ecf0)
Location: arch/powerpc/include/asm/book3s/64/pgtable.h:1154
Inline: True
Inline callers:
