...
```
In arch/arm64/kernel/fpsimd.c (ffff8000100872f8)
Location: arch/arm64/kernel/fpsimd.c:174
Inline: True
Direct callers:
...
```
ffff8000100872f8-ffff800010087338: __put_cpu_fpsimd_context (STB_LOCAL)
```
</details>
</li>
<li>
