# Function: <code>partition_check_cpu</code>
...
```
In drivers/irqchip/irq-partition-percpu.c (ffff800010675a60)
Location: drivers/irqchip/irq-partition-percpu.c:25
Inline: True
Inline callers:
...
```
In drivers/irqchip/irq-partition-percpu.c (c081deb4)
Location: drivers/irqchip/irq-partition-percpu.c:25
Inline: True
Inline callers:
  - drivers/irqchip/irq-partition-percpu.c:partition_handle_irq
