...
```
In arch/powerpc/mm/pgtable-frag.c (c000000000089330)
Location: arch/powerpc/mm/pgtable-frag.c:109
Inline: False
Direct callers:
...
```
c000000000089330-c00000000008940c: pte_fragment_free (STB_GLOBAL)
```
</details>
</li>
<li>
