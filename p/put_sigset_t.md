# Function: <code>put_sigset_t</code>
...
```
In arch/arm64/kernel/signal32.c (ffff8000100a05ac)
Location: arch/arm64/kernel/signal32.c:51
Inline: True
Inline callers:
...
Location: arch/powerpc/kernel/signal_32.c:88
Inline: True
Inline callers:
