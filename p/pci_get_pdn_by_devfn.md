...
```
In arch/powerpc/kernel/pci_dn.c (c00000000006a730)
Location: arch/powerpc/kernel/pci_dn.c:58
Inline: False
Direct callers:
...
```
c00000000006a730-c00000000006a850: pci_get_pdn_by_devfn (STB_GLOBAL)
```
</details>
</li>
<li>
