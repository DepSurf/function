# Function: <code>__percpu_write_64</code>
...
```
In kernel/trace/bpf_trace.c (ffff80001024d5a4)
Location: arch/arm64/include/asm/percpu.h:111
Inline: True
```
```
In kernel/bpf/cgroup.c (ffff80001028e59c)
Location: arch/arm64/include/asm/percpu.h:111
Inline: True
Inline callers:
...
```
```
In net/bpf/test_run.c (ffff800010c52914)
Location: arch/arm64/include/asm/percpu.h:111
Inline: True
Inline callers:
