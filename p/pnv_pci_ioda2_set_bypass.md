...
```
In arch/powerpc/platforms/powernv/pci-ioda.c (c0000000000d5420)
Location: arch/powerpc/platforms/powernv/pci-ioda.c:2351
Inline: False
Direct callers:
...
```
c0000000000d5420-c0000000000d555c: pnv_pci_ioda2_set_bypass (STB_LOCAL)
```
</details>
</li>
<li>
