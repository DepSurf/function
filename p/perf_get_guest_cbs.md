# Function: <code>perf_get_guest_cbs</code>
...
```
In arch/x86/events/core.c (ffffffff8100a115)
Location: include/linux/perf_event.h:1234
Inline: True
Inline callers:
...
```
```
In arch/x86/events/intel/core.c (ffffffff8100f96b)
Location: include/linux/perf_event.h:1234
Inline: True
Inline callers:
