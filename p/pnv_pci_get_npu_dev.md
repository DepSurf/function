...
```
In arch/powerpc/platforms/powernv/npu-dma.c (c0000000000da1c0)
Location: arch/powerpc/platforms/powernv/npu-dma.c:68
Inline: False
Direct callers:
...
```
c0000000000da1c0-c0000000000da26c: pnv_pci_get_npu_dev (STB_GLOBAL)
```
</details>
</li>
<li>
