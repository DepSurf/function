...
```
In arch/powerpc/platforms/powernv/pci-ioda.c (c0000000000d2f10)
Location: arch/powerpc/platforms/powernv/pci-ioda.c:185
Inline: False
Direct callers:
...
```
c0000000000d2f10-c0000000000d2fd4: pnv_ioda_free_pe (STB_LOCAL)
```
</details>
</li>
<li>
