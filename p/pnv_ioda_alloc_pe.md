...
```
In arch/powerpc/platforms/powernv/pci-ioda.c (c0000000000d2880)
Location: arch/powerpc/platforms/powernv/pci-ioda.c:173
Inline: False
Direct callers:
...
```
c0000000000d2880-c0000000000d2908: pnv_ioda_alloc_pe (STB_LOCAL)
```
</details>
</li>
<li>
