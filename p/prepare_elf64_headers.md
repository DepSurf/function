# Function: <code>prepare_elf64_headers</code>
...
Location: arch/x86/kernel/crash.c:404
Inline: True
Inline callers:
...
Location: arch/x86/kernel/crash.c:380
Inline: True
Inline callers:
  - arch/x86/kernel/crash.c:crash_load_segments
```
...
Location: arch/x86/kernel/crash.c:396
Inline: True
Inline callers:
  - arch/x86/kernel/crash.c:crash_load_segments
```
...
Location: arch/x86/kernel/crash.c:397
Inline: True
Inline callers:
  - arch/x86/kernel/crash.c:crash_load_segments
```
