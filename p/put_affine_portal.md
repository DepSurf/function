# Function: <code>put_affine_portal</code>
...
```
In drivers/soc/fsl/qbman/bman.c (ffff800010811b40)
Location: drivers/soc/fsl/qbman/bman.c:235
Inline: True
Inline callers:
...
```
```
In drivers/soc/fsl/qbman/qman.c (ffff800010816fdc)
Location: drivers/soc/fsl/qbman/qman.c:1016
Inline: True
Inline callers:
