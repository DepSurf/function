# Function: <code>cfq_mark_cfqq_sync</code>
...
```
In block/cfq-iosched.c (ffffffff813e1ad9)
...
```
In block/cfq-iosched.c (ffffffff81427d16)
Location: block/cfq-iosched.c:449
Inline: True
Inline callers:
  - block/cfq-iosched.c:cfq_get_queue
...
```
In block/cfq-iosched.c (ffffffff814418f3)
