...
```
In drivers/clk/rockchip/clk-half-divider.c (ffff8000107eed04)
Location: drivers/clk/rockchip/clk-half-divider.c:35
Inline: True
Inline callers:
...
```
In drivers/clk/rockchip/clk-half-divider.c (c0908424)
Location: drivers/clk/rockchip/clk-half-divider.c:35
Inline: False
Direct callers:
  - drivers/clk/rockchip/clk-half-divider.c:clk_half_divider_round_rate
...
```
c0908424-c0908694: clk_half_divider_bestdiv (STB_LOCAL)
```
</details>
</li>
<li>
