# Function: <code>C_SYSC_sigpending</code>
...
```
In kernel/compat.c (ffffffff81110961)
...
```
In kernel/compat.c (ffffffff811180a1)
Location: kernel/compat.c:374
Inline: True
Inline callers:
  - kernel/compat.c:compat_SyS_sigpending
...
```
In kernel/compat.c (ffffffff8111f7c1)
...
```
In kernel/signal.c (ffffffff8109dd1f)
