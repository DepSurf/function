# Function: <code>class_raw_spinlock_destructor</code>
...
```
In drivers/pinctrl/intel/pinctrl-baytrail.c (ffffffff8193d0a7)
Location: include/linux/spinlock.h:537
Inline: True
Inline callers:
...
```
```
In drivers/pinctrl/intel/pinctrl-cherryview.c (ffffffff8193f344)
Location: include/linux/spinlock.h:537
Inline: True
Inline callers:
...
```
```
In drivers/pinctrl/intel/pinctrl-intel.c (ffffffff8194161b)
Location: include/linux/spinlock.h:537
Inline: True
Inline callers:
