...
```
In kernel/cpu_pm.c (ffff80001025b3f0)
Location: kernel/cpu_pm.c:60
Inline: False
Direct callers:
...
```
ffff80001025b3f0-ffff80001025b424: cpu_pm_unregister_notifier (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
c048e560-c048e588: cpu_pm_unregister_notifier (STB_GLOBAL)
```
</details>
</li>
<li>
