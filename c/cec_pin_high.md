# Function: <code>cec_pin_high</code>
...
```
In drivers/media/cec/cec-pin.c (ffff800010ac4888)
Location: drivers/media/cec/cec-pin.c:150
Inline: True
Inline callers:
...
```
In drivers/media/cec/cec-pin.c (ffffffff8188c78a)
Location: drivers/media/cec/cec-pin.c:150
Inline: True
Inline callers:
  - drivers/media/cec/cec-pin.c:cec_pin_allocate_adapter
