# Function: <code>class_raw_spinlock_irqsave_destructor</code>
...
```
In kernel/sched/core.c (ffffffff811581e6)
...
```
```
In drivers/pinctrl/intel/pinctrl-baytrail.c (ffffffff8193d4d1)
Location: include/linux/spinlock.h:553
Inline: True
Inline callers:
...
```
```
In drivers/pinctrl/intel/pinctrl-cherryview.c (ffffffff81940733)
Location: include/linux/spinlock.h:553
Inline: True
Inline callers:
...
```
```
In drivers/pinctrl/intel/pinctrl-intel.c (ffffffff81943000)
Location: include/linux/spinlock.h:553
Inline: True
Inline callers:
