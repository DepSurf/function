# Function: <code>ClearHPageMigratable</code>
...
```
In mm/hugetlb.c (ffffffff812de17e)
...
```
In mm/hugetlb.c (ffffffff813253ae)
...
```
In mm/hugetlb.c (ffffffff81393d13)
...
```
In mm/hugetlb.c (ffffffff81412a33)
...
```
```
In mm/memory-failure.c (ffffffff81463d72)
Location: include/linux/hugetlb.h:639
Inline: True
Inline callers:
