...
```
In net/netfilter/nf_conntrack_netlink.c (ffffffff819ad1a0)
Location: net/netfilter/nf_conntrack_netlink.c:1127
Inline: False
Direct callers:
...
```
ffffffff819ad1a0-ffffffff819ad392: ctnetlink_parse_tuple (STB_LOCAL)
```
</details>
</li>
<li>
