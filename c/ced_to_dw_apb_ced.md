# Function: <code>ced_to_dw_apb_ced</code>
...
```
In drivers/clocksource/dw_apb_timer.c (c0c48908)
Location: drivers/clocksource/dw_apb_timer.c:38
Inline: True
Inline callers:
  ...
  - drivers/clocksource/dw_apb_timer.c:dw_apb_clockevent_irq
```
</details>
</li>
<li>
