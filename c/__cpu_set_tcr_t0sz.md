# Function: <code>__cpu_set_tcr_t0sz</code>
...
Location: arch/arm64/include/asm/mmu_context.h:84
Inline: True
Inline callers:
  - arch/arm64/kernel/setup.c:setup_arch
```
```
In arch/arm64/kernel/cpufeature.c (ffff800010099f8c)
Location: arch/arm64/include/asm/mmu_context.h:84
Inline: True
Inline callers:
...
```
```
In arch/arm64/kernel/machine_kexec.c (ffff8000100a9d90)
Location: arch/arm64/include/asm/mmu_context.h:84
Inline: True
Inline callers:
...
```
```
In arch/arm64/mm/mmu.c (ffff8000114384f4)
Location: arch/arm64/include/asm/mmu_context.h:84
Inline: True
Inline callers:
