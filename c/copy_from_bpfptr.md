# Function: <code>copy_from_bpfptr</code>
...
Location: include/linux/bpfptr.h:54
Inline: True
Inline callers:
...
```
```
In kernel/bpf/verifier.c (ffffffff8123b097)
Location: include/linux/bpfptr.h:54
Inline: True
Inline callers:
...
Location: include/linux/bpfptr.h:57
Inline: True
Inline callers:
  - kernel/bpf/syscall.c:__sys_bpf
  - kernel/bpf/syscall.c:bpf_prog_load
...
```
```
In kernel/bpf/verifier.c (ffffffff81280c76)
Location: include/linux/bpfptr.h:57
Inline: True
Inline callers:
...
```
```
In kernel/bpf/verifier.c (ffffffff812d89e8)
Location: include/linux/bpfptr.h:57
Inline: True
Inline callers:
  - kernel/bpf/verifier.c:check_core_relo
...
```
```
In kernel/bpf/verifier.c (ffffffff81300398)
Location: include/linux/bpfptr.h:57
Inline: True
Inline callers:
  - kernel/bpf/verifier.c:check_core_relo
...
```
```
In kernel/bpf/verifier.c (ffffffff8131efe8)
Location: include/linux/bpfptr.h:57
Inline: True
Inline callers:
  - kernel/bpf/verifier.c:check_core_relo
