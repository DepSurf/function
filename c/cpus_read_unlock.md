...
```
ffffffff81085180-ffffffff810851ac: cpus_read_unlock (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
ffffffff8108bce0-ffffffff8108bd0d: cpus_read_unlock (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In kernel/cpu.c (ffffffff8108f4f0)
Location: kernel/cpu.c:294
Inline: False
Direct callers:
...
```
ffffffff8108f4f0-ffffffff8108f51d: cpus_read_unlock (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In kernel/cpu.c (ffffffff810977f0)
Location: kernel/cpu.c:298
Inline: False
Direct callers:
  - arch/x86/events/intel/core.c:fixup_ht_bug
  - arch/x86/events/intel/core.c:freeze_on_smi_store
...
```
ffffffff810977f0-ffffffff8109781d: cpus_read_unlock (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In kernel/cpu.c (ffffffff8109bdb0)
Location: kernel/cpu.c:299
Inline: False
Direct callers:
  - arch/x86/events/intel/core.c:fixup_ht_bug
...
```
ffffffff8109bdb0-ffffffff8109bddc: cpus_read_unlock (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In kernel/cpu.c (ffffffff810a2330)
...
```
ffffffff810a2330-ffffffff810a235c: cpus_read_unlock (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
ffffffff810a9490-ffffffff810a94cc: cpus_read_unlock (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
ffffffff810a4ee0-ffffffff810a4f1c: cpus_read_unlock (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
ffffffff810a5be0-ffffffff810a5c1c: cpus_read_unlock (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
ffffffff810b7570-ffffffff810b75ac: cpus_read_unlock (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
ffffffff810ce210-ffffffff810ce274: cpus_read_unlock (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
ffffffff810ec3b0-ffffffff810ec414: cpus_read_unlock (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
ffffffff810f7ee0-ffffffff810f7f44: cpus_read_unlock (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
ffffffff811012f0-ffffffff81101354: cpus_read_unlock (STB_GLOBAL)
```
</details>
</li>
</ul>
...
```
ffff8000100f7ae8-ffff8000100f7b34: cpus_read_unlock (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
c0355cb4-c0355d00: cpus_read_unlock (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
c00000000013e240-c00000000013e2b8: cpus_read_unlock (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In kernel/cpu.c (ffffffff8109bc50)
Location: kernel/cpu.c:302
Inline: False
Direct callers:
  - arch/x86/events/intel/core.c:fixup_ht_bug
...
```
ffffffff8109bc50-ffffffff8109bc7c: cpus_read_unlock (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In kernel/cpu.c (ffffffff8108a680)
Location: kernel/cpu.c:302
Inline: False
Direct callers:
  - arch/x86/events/intel/core.c:fixup_ht_bug
...
```
ffffffff8108a680-ffffffff8108a6ac: cpus_read_unlock (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In kernel/cpu.c (ffffffff8109bc00)
Location: kernel/cpu.c:302
Inline: False
Direct callers:
  - arch/x86/events/intel/core.c:fixup_ht_bug
...
```
ffffffff8109bc00-ffffffff8109bc2c: cpus_read_unlock (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
ffffffff810a3ec0-ffffffff810a3f04: cpus_read_unlock (STB_GLOBAL)
```
</details>
</li>
</ul>
