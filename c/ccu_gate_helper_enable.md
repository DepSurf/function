...
```
In drivers/clk/sunxi-ng/ccu_gate.c (ffff8000107f5cb8)
Location: drivers/clk/sunxi-ng/ccu_gate.c:35
Inline: True
Inline callers:
...
```
ffff8000107f5bb8-ffff8000107f5c94: ccu_gate_helper_enable.part.0 (STB_LOCAL)
ffff8000107f5d10-ffff8000107f5d4c: ccu_gate_helper_enable (STB_GLOBAL)
```
</details>
</li>
<li>
