...
```
In drivers/gpu/drm/drm_edid.c (ffffffff81c8e0f0)
Location: drivers/gpu/drm/drm_edid.c:4966
Inline: False
Direct callers:
...
```
ffffffff81c8e0f0-ffffffff81c8e13a: cea_db_iter_edid_begin (STB_LOCAL)
```
</details>
</li>
</ul>
