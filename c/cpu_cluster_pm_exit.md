...
```
In kernel/cpu_pm.c (ffff80001025b620)
Location: kernel/cpu_pm.c:164
Inline: True
Inline callers:
...
```
ffff80001025b5e8-ffff80001025b610: cpu_cluster_pm_exit (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
c048e744-c048e76c: cpu_cluster_pm_exit (STB_GLOBAL)
```
</details>
</li>
<li>
