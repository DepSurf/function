...
```
In arch/x86/entry/common.c (ffffffff8221b998)
Location: include/linux/context_tracking_state.h:52
Inline: True
Inline callers:
...
```
```
In kernel/sched/core.c (ffffffff8114b201)
Location: include/linux/context_tracking_state.h:52
Inline: True
```
```
In kernel/entry/common.c (ffffffff82223d4d)
Location: include/linux/context_tracking_state.h:52
Inline: True
Inline callers:
...
```
```
In kernel/context_tracking.c (ffffffff82224533)
Location: include/linux/context_tracking_state.h:52
Inline: True
Inline callers:
