...
```
In arch/arm64/kernel/cacheinfo.c (ffff80001009b7b0)
Location: arch/arm64/kernel/cacheinfo.c:20
Inline: True
Direct callers:
...
```
ffff80001009b7b0-ffff80001009b7f0: cache_line_size (STB_GLOBAL)
```
</details>
</li>
<li>
