# Function: <code>class_spinlock_irqsave_constructor</code>
...
```
In drivers/gpio/gpiolib.c (ffffffff8194911e)
Location: include/linux/spinlock.h:574
Inline: True
Inline callers:
...
```
```
In drivers/gpio/gpiolib-cdev.c (ffffffff819508c4)
Location: include/linux/spinlock.h:574
Inline: True
Inline callers:
