...
```
In arch/powerpc/lib/code-patching.c (c0000000000a7228)
Location: arch/powerpc/lib/code-patching.c:246
Inline: True
Inline callers:
...
```
c0000000000a6fd0-c0000000000a7014: create_branch (STB_GLOBAL)
```
</details>
</li>
<li>
