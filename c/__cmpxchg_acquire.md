# Function: <code>__cmpxchg_acquire</code>
...
```
In kernel/sched/rt.c (c0000000001a1dbc)
Location: arch/powerpc/include/asm/cmpxchg.h:463
Inline: True
Inline callers:
...
```
```
In kernel/locking/osq_lock.c (c0000000001c251c)
Location: arch/powerpc/include/asm/cmpxchg.h:463
Inline: True
Inline callers:
...
```
```
In kernel/locking/rtmutex.c (c000000000ee8138)
Location: arch/powerpc/include/asm/cmpxchg.h:463
Inline: True
Inline callers:
