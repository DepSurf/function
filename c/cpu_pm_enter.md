...
```
In kernel/cpu_pm.c (ffff80001025b498)
Location: kernel/cpu_pm.c:81
Inline: False
Direct callers:
...
```
ffff80001025b498-ffff80001025b514: cpu_pm_enter (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
c048e5ec-c048e670: cpu_pm_enter (STB_GLOBAL)
```
</details>
</li>
<li>
