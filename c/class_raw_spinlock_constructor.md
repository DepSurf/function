# Function: <code>class_raw_spinlock_constructor</code>
...
```
In drivers/pinctrl/intel/pinctrl-baytrail.c (ffffffff8193d090)
...
```
```
In drivers/pinctrl/intel/pinctrl-cherryview.c (ffffffff8193f2e7)
Location: include/linux/spinlock.h:537
Inline: True
Inline callers:
...
```
```
In drivers/pinctrl/intel/pinctrl-intel.c (ffffffff819415f8)
Location: include/linux/spinlock.h:537
Inline: True
Inline callers:
