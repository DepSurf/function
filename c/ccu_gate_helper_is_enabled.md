...
```
In drivers/clk/sunxi-ng/ccu_gate.c (ffff8000107f5a5c)
Location: drivers/clk/sunxi-ng/ccu_gate.c:60
Inline: True
Inline callers:
...
```
ffff8000107f5d50-ffff8000107f5da4: ccu_gate_helper_is_enabled (STB_GLOBAL)
```
</details>
</li>
<li>
