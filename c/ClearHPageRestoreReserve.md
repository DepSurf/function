# Function: <code>ClearHPageRestoreReserve</code>
...
```
In mm/hugetlb.c (ffffffff812da5fb)
...
```
In mm/hugetlb.c (ffffffff8132153b)
...
```
In mm/hugetlb.c (ffffffff8138e4f4)
...
```
```
In mm/hugetlb.c (ffffffff8140c8b1)
Location: include/linux/hugetlb.h:638
Inline: True
Inline callers:
