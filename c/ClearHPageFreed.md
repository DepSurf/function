# Function: <code>ClearHPageFreed</code>
...
```
In mm/hugetlb.c (ffffffff812d67f0)
...
```
In mm/hugetlb.c (ffffffff8131c582)
...
```
In mm/hugetlb.c (ffffffff81387714)
...
```
In mm/hugetlb.c (ffffffff81405b40)
