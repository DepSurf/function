# Function: <code>class_mutex_constructor</code>
...
```
In kernel/sched/core.c (ffffffff8114fe2e)
...
```
```
In kernel/sched/build_utility.c (ffffffff8118fbb9)
Location: include/linux/mutex.h:173
Inline: True
Inline callers:
...
```
```
In fs/pstore/inode.c (ffffffff816ac175)
Location: include/linux/mutex.h:173
Inline: True
Inline callers:
...
```
```
In drivers/gpio/gpiolib.c (ffffffff8194724a)
Location: include/linux/mutex.h:173
Inline: True
Inline callers:
...
```
```
In drivers/gpio/gpiolib-cdev.c (ffffffff8194fd99)
Location: include/linux/mutex.h:173
Inline: True
Inline callers:
...
```
```
In drivers/acpi/numa/hmat.c (ffffffff81a6e005)
Location: include/linux/mutex.h:173
Inline: True
Inline callers:
