# Function: <code>console_srcu_write_flags</code>
...
```
In kernel/printk/printk.c (ffffffff8118d982)
Location: include/linux/console.h:223
Inline: True
Inline callers:
...
```
In kernel/printk/printk.c (ffffffff8119f130)
Location: include/linux/console.h:270
Inline: True
Inline callers:
  - kernel/printk/printk.c:console_force_preferred_locked
  - kernel/printk/printk.c:unregister_console_locked
...
```
In kernel/printk/printk.c (ffffffff811ae220)
Location: include/linux/console.h:399
Inline: True
Inline callers:
  - kernel/printk/printk.c:console_force_preferred_locked
  - kernel/printk/printk.c:unregister_console_locked
