# Function: <code>cs_to_sh_tmu</code>
...
```
In drivers/clocksource/sh_tmu.c (ffff800010b65f78)
Location: drivers/clocksource/sh_tmu.c:244
Inline: True
Inline callers:
...
```
In drivers/clocksource/sh_tmu.c (c0c461f4)
Location: drivers/clocksource/sh_tmu.c:244
Inline: True
Inline callers:
  - drivers/clocksource/sh_tmu.c:sh_tmu_clocksource_resume
