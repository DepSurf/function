# Function: <code>cpu_max_bits_warn</code>
...
```
In init/main.c (0)
Location: include/linux/cpumask.h:134
Inline: True
```
```
In arch/x86/entry/common.c (0)
...
```
In init/main.c (0)
Location: include/linux/cpumask.h:105
Inline: True
```
```
In arch/x86/entry/vsyscall/vsyscall_64.c (0)
...
```
In init/main.c (0)
Location: include/linux/cpumask.h:107
Inline: True
```
```
In arch/x86/entry/vsyscall/vsyscall_64.c (0)
...
```
In init/main.c (0)
Location: include/linux/cpumask.h:140
Inline: True
```
```
In arch/x86/entry/vsyscall/vsyscall_64.c (0)
