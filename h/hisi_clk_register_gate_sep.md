...
```
In drivers/clk/hisilicon/clk.c (ffff8000107cffe8)
Location: drivers/clk/hisilicon/clk.c:287
Inline: False
Direct callers:
...
```
ffff8000107cffe8-ffff8000107d00d0: hisi_clk_register_gate_sep (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In drivers/clk/hisilicon/clk.c (c08f7a74)
Location: drivers/clk/hisilicon/clk.c:287
Inline: False
Direct callers:
...
```
c08f7a74-c08f7b40: hisi_clk_register_gate_sep (STB_GLOBAL)
```
</details>
</li>
<li>
