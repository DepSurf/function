...
```
In net/netfilter/nf_conntrack_core.c (ffffffff8199d000)
Location: net/netfilter/nf_conntrack_core.c:184
Inline: False
Direct callers:
...
```
ffffffff8199d000-ffffffff8199d169: hash_conntrack_raw (STB_LOCAL)
```
</details>
</li>
<li>
