...
```
In drivers/clk/hisilicon/clk.c (ffff8000107cfad8)
Location: drivers/clk/hisilicon/clk.c:120
Inline: False
Direct callers:
...
```
ffff8000107cfad8-ffff8000107cfbb0: hisi_clk_register_fixed_factor (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In drivers/clk/hisilicon/clk.c (c08f75e0)
Location: drivers/clk/hisilicon/clk.c:120
Inline: False
Direct callers:
...
```
c08f75e0-c08f76a4: hisi_clk_register_fixed_factor (STB_GLOBAL)
```
</details>
</li>
<li>
