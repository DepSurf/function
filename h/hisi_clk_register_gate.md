...
```
In drivers/clk/hisilicon/clk.c (ffff8000107cfee0)
Location: drivers/clk/hisilicon/clk.c:250
Inline: False
Direct callers:
...
```
ffff8000107cfee0-ffff8000107cffe8: hisi_clk_register_gate (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In drivers/clk/hisilicon/clk.c (c08f797c)
Location: drivers/clk/hisilicon/clk.c:250
Inline: False
Direct callers:
...
```
c08f797c-c08f7a74: hisi_clk_register_gate (STB_GLOBAL)
```
</details>
</li>
<li>
