# Function: <code>hpte_encode_avpn</code>
...
```
In arch/powerpc/mm/book3s64/hash_native.c (c0000000000925d4)
Location: arch/powerpc/include/asm/book3s/64/mmu-hash.h:325
Inline: True
Inline callers:
...
```
```
In arch/powerpc/platforms/pseries/lpar.c (c0000000000e9e34)
Location: arch/powerpc/include/asm/book3s/64/mmu-hash.h:325
Inline: True
Inline callers:
