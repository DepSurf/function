# Function: <code>htlb_modify_alloc_mask</code>
...
Location: include/linux/hugetlb.h:829
Inline: True
Inline callers:
  - mm/migrate.c:alloc_migration_target
```
...
Location: include/linux/hugetlb.h:859
Inline: True
Inline callers:
  - mm/migrate.c:alloc_migration_target
```
...
Location: include/linux/hugetlb.h:911
Inline: True
Inline callers:
  - mm/migrate.c:alloc_migration_target
```
...
Location: include/linux/hugetlb.h:939
Inline: True
Inline callers:
  - mm/migrate.c:alloc_migration_target
```
...
Location: include/linux/hugetlb.h:961
Inline: True
Inline callers:
  - mm/migrate.c:alloc_migration_target
```
