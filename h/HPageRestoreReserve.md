# Function: <code>HPageRestoreReserve</code>
...
```
In mm/hugetlb.c (ffffffff812d9423)
...
```
In mm/hugetlb.c (ffffffff8131fe93)
...
```
In mm/hugetlb.c (ffffffff8138cbf3)
...
```
In mm/hugetlb.c (ffffffff8140b623)
