...
```
In arch/powerpc/mm/book3s64/hash_pgtable.c (c00000000008b200)
Location: arch/powerpc/mm/book3s64/hash_pgtable.c:380
Inline: True
Direct callers:
...
```
c00000000008b200-c00000000008b278: hash__has_transparent_hugepage (STB_GLOBAL)
```
</details>
</li>
<li>
