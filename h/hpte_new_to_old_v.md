# Function: <code>hpte_new_to_old_v</code>
...
```
In arch/powerpc/mm/book3s64/hash_native.c (c0000000000925e8)
Location: arch/powerpc/include/asm/book3s/64/mmu-hash.h:361
Inline: True
Inline callers:
...
```
```
In arch/powerpc/kvm/book3s_hv_rm_mmu.c (c000000000120404)
Location: arch/powerpc/include/asm/book3s/64/mmu-hash.h:361
Inline: True
Inline callers:
