...
```
In drivers/perf/hisilicon/hisi_uncore_pmu.c (ffff800010b966ac)
Location: drivers/perf/hisilicon/hisi_uncore_pmu.c:204
Inline: True
Inline callers:
...
```
ffff800010b96568-ffff800010b965b4: hisi_uncore_pmu_set_event_period (STB_GLOBAL)
```
</details>
</li>
<li>
