...
```
In drivers/perf/hisilicon/hisi_uncore_pmu.c (ffff800010b968bc)
Location: drivers/perf/hisilicon/hisi_uncore_pmu.c:95
Inline: True
Inline callers:
...
```
ffff800010b96380-ffff800010b963bc: hisi_uncore_pmu_counter_valid (STB_GLOBAL)
```
</details>
</li>
<li>
