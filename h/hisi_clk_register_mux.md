...
```
In drivers/clk/hisilicon/clk.c (ffff8000107cfbb0)
Location: drivers/clk/hisilicon/clk.c:150
Inline: False
Direct callers:
...
```
ffff8000107cfbb0-ffff8000107cfcf0: hisi_clk_register_mux (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In drivers/clk/hisilicon/clk.c (c08f76a4)
Location: drivers/clk/hisilicon/clk.c:150
Inline: False
Direct callers:
...
```
c08f76a4-c08f77d4: hisi_clk_register_mux (STB_GLOBAL)
```
</details>
</li>
<li>
