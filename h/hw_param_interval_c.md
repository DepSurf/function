# Function: <code>hw_param_interval_c</code>
...
```
In sound/core/pcm_native.c (c0c93408)
Location: include/sound/pcm.h:898
Inline: True
Inline callers:
...
```
```
In sound/core/pcm_lib.c (c0c985ec)
Location: include/sound/pcm.h:898
Inline: True
```
```
In sound/core/pcm_drm_eld.c (0)
Location: include/sound/pcm.h:898
Inline: True
```
```
In sound/core/pcm_iec958.c (0)
Location: include/sound/pcm.h:898
Inline: True
```
```
