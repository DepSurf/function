...
```
In drivers/soc/fsl/qbman/qman.c (ffff8000108131a0)
Location: drivers/soc/fsl/qbman/qman.c:1687
Inline: False
Direct callers:
...
```
ffff8000108131a0-ffff800010813210: qman_p_irqsource_add (STB_GLOBAL)
```
</details>
</li>
<li>
