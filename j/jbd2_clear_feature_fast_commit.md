# Function: <code>jbd2_clear_feature_fast_commit</code>
...
```
In fs/jbd2/journal.c (ffffffff814642b0)
...
```
In fs/jbd2/journal.c (ffffffff81469960)
...
```
In fs/jbd2/journal.c (ffffffff814bfe00)
...
```
In fs/jbd2/journal.c (ffffffff8154a5b8)
...
```
In fs/jbd2/journal.c (ffffffff815ea028)
...
```
In fs/jbd2/journal.c (ffffffff81621e1d)
...
```
In fs/jbd2/journal.c (ffffffff8165a35d)
