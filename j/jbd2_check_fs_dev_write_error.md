# Function: <code>jbd2_check_fs_dev_write_error</code>
...
```
In fs/jbd2/transaction.c (ffffffff8164e4ea)
...
```
```
In fs/jbd2/recovery.c (ffffffff81652a29)
Location: include/linux/jbd2.h:1708
Inline: True
Inline callers:
...
```
```
In fs/jbd2/journal.c (ffffffff8165a76f)
Location: include/linux/jbd2.h:1708
Inline: True
Inline callers:
