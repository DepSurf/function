# Function: <code>nf_ct_is_expired</code>
...
```
In net/netfilter/nf_conntrack_core.c (ffffffff8199e486)
Location: include/net/netfilter/nf_conntrack.h:270
Inline: True
Inline callers:
...
```
```
In net/netfilter/nf_conntrack_standalone.c (ffffffff819a17c1)
Location: include/net/netfilter/nf_conntrack.h:270
Inline: True
Inline callers:
...
```
```
In net/netfilter/nf_conntrack_netlink.c (ffffffff819b08c7)
Location: include/net/netfilter/nf_conntrack.h:270
Inline: True
Inline callers:
