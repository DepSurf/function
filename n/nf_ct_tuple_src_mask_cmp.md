# Function: <code>nf_ct_tuple_src_mask_cmp</code>
...
```
In net/netfilter/nf_conntrack_expect.c (ffffffff819a27d5)
Location: include/net/netfilter/nf_conntrack_tuple.h:156
Inline: True
Inline callers:
...
```
```
In net/netfilter/nf_conntrack_helper.c (ffffffff819a3893)
Location: include/net/netfilter/nf_conntrack_tuple.h:156
Inline: True
Inline callers:
