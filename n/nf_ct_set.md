...
```
In net/netfilter/nf_conntrack_core.c (ffffffff8199f6d2)
Location: include/net/netfilter/nf_conntrack.h:317
Inline: True
Inline callers:
...
```
```
In net/netfilter/nf_conntrack_proto_icmp.c (ffffffff819a79d8)
Location: include/net/netfilter/nf_conntrack.h:317
Inline: True
Inline callers:
...
```
```
In net/netfilter/nf_conntrack_proto_icmpv6.c (ffffffff819a8a19)
Location: include/net/netfilter/nf_conntrack.h:317
Inline: True
Inline callers:
