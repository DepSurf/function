# Function: <code>nf_ct_timeout_lookup</code>
...
```
In net/netfilter/nf_conntrack_core.c (ffffffff8199fc10)
Location: include/net/netfilter/nf_conntrack_timeout.h:78
Inline: True
Inline callers:
  - net/netfilter/nf_conntrack_core.c:nf_conntrack_in
```
```
In net/netfilter/nf_conntrack_proto_tcp.c (ffffffff819a63aa)
Location: include/net/netfilter/nf_conntrack_timeout.h:78
Inline: True
Inline callers:
...
```
```
In net/netfilter/nf_conntrack_proto_udp.c (ffffffff819a7273)
Location: include/net/netfilter/nf_conntrack_timeout.h:78
Inline: True
Inline callers:
...
```
```
In net/netfilter/nf_conntrack_proto_icmp.c (ffffffff819a77f5)
Location: include/net/netfilter/nf_conntrack_timeout.h:78
Inline: True
Inline callers:
...
```
```
In net/netfilter/nf_conntrack_proto_icmpv6.c (ffffffff819a8825)
Location: include/net/netfilter/nf_conntrack_timeout.h:78
Inline: True
Inline callers:
...
```
```
In net/netfilter/nf_conntrack_proto_sctp.c (ffffffff819ab044)
Location: include/net/netfilter/nf_conntrack_timeout.h:78
Inline: True
Inline callers:
...
```
```
In net/netfilter/nf_conntrack_proto_gre.c (ffffffff819abb3e)
Location: include/net/netfilter/nf_conntrack_timeout.h:78
Inline: True
Inline callers:
