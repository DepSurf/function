...
```
In net/netfilter/nf_conntrack_core.c (ffffffff8199ce60)
Location: net/netfilter/nf_conntrack_core.c:2241
Inline: False
Direct callers:
...
```
ffffffff8199ce60-ffffffff8199ced4: nf_ct_alloc_hashtable (STB_GLOBAL)
```
</details>
</li>
<li>
