# Function: <code>next_request</code>
...
```
In drivers/usb/musb/musb_gadget_ep0.c (c0b6e010)
Location: drivers/usb/musb/musb_gadget.h:101
Inline: True
Inline callers:
...
```
```
In drivers/usb/musb/musb_gadget.c (c0b70604)
Location: drivers/usb/musb/musb_gadget.h:101
Inline: True
Inline callers:
