...
```
In net/netfilter/nf_conntrack_core.c (ffffffff8199f3a0)
Location: net/netfilter/nf_conntrack_core.c:800
Inline: False
Direct callers:
...
```
ffffffff8199f3a0-ffffffff8199f3db: nf_conntrack_find_get (STB_GLOBAL)
```
</details>
</li>
<li>
