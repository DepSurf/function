# Function: <code>nf_ct_tuplehash_to_ctrack</code>
...
```
In net/netfilter/nf_conntrack_core.c (ffffffff819a0748)
Location: include/net/netfilter/nf_conntrack.h:111
Inline: True
Inline callers:
...
```
```
In net/netfilter/nf_conntrack_standalone.c (ffffffff819a178b)
Location: include/net/netfilter/nf_conntrack.h:111
Inline: True
Inline callers:
...
```
```
In net/netfilter/nf_conntrack_proto.c (ffffffff819a451d)
Location: include/net/netfilter/nf_conntrack.h:111
Inline: True
Inline callers:
...
```
```
In net/netfilter/nf_conntrack_proto_icmp.c (ffffffff819a7992)
Location: include/net/netfilter/nf_conntrack.h:111
Inline: True
Inline callers:
...
```
```
In net/netfilter/nf_conntrack_ecache.c (ffffffff819a9179)
Location: include/net/netfilter/nf_conntrack.h:111
Inline: True
Inline callers:
...
```
```
In net/netfilter/nf_conntrack_netlink.c (ffffffff819b0e77)
Location: include/net/netfilter/nf_conntrack.h:111
Inline: True
Inline callers:
