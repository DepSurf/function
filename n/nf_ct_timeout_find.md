# Function: <code>nf_ct_timeout_find</code>
...
```
In net/netfilter/nf_conntrack_core.c (ffffffff8199fc18)
Location: include/net/netfilter/nf_conntrack_timeout.h:49
Inline: True
Inline callers:
...
```
```
In net/netfilter/nf_conntrack_proto_sctp.c (ffffffff819ab04b)
Location: include/net/netfilter/nf_conntrack_timeout.h:49
Inline: True
Inline callers:
