# Function: <code>nf_ct_zone_init</code>
...
```
In net/netfilter/nf_conntrack_core.c (ffffffff8199f87b)
Location: include/net/netfilter/nf_conntrack_zones.h:19
Inline: True
Inline callers:
  - net/netfilter/nf_conntrack_core.c:nf_conntrack_in
```
```
In net/netfilter/nf_conntrack_proto_icmp.c (ffffffff819a7909)
Location: include/net/netfilter/nf_conntrack_zones.h:19
Inline: True
Inline callers:
...
```
```
In net/netfilter/nf_conntrack_netlink.c (ffffffff819b1023)
Location: include/net/netfilter/nf_conntrack_zones.h:19
Inline: True
Inline callers:
