# Function: <code>nf_conntrack_event_cache</code>
...
```
In net/netfilter/nf_conntrack_core.c (ffffffff8199fc8b)
Location: include/net/netfilter/nf_conntrack_ecache.h:105
Inline: True
Inline callers:
...
```
```
In net/netfilter/nf_conntrack_proto_tcp.c (ffffffff819a643b)
Location: include/net/netfilter/nf_conntrack_ecache.h:105
Inline: True
Inline callers:
...
```
```
In net/netfilter/nf_conntrack_proto_udp.c (ffffffff819a72d0)
Location: include/net/netfilter/nf_conntrack_ecache.h:105
Inline: True
Inline callers:
...
```
```
In net/netfilter/nf_conntrack_proto_gre.c (ffffffff819abbcb)
Location: include/net/netfilter/nf_conntrack_ecache.h:105
Inline: True
Inline callers:
