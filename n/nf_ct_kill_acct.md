...
```
In net/netfilter/nf_conntrack_core.c (ffffffff8199dd90)
Location: net/netfilter/nf_conntrack_core.c:1803
Inline: False
Direct callers:
...
```
ffffffff8199dd90-ffffffff8199ddd8: nf_ct_kill_acct (STB_GLOBAL)
```
</details>
</li>
<li>
