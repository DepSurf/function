...
```
In net/netfilter/nf_conntrack_core.c (ffffffff8199dc20)
Location: net/netfilter/nf_conntrack_core.c:655
Inline: True
Direct callers:
...
```
ffffffff8199dc20-ffffffff8199dd83: nf_ct_delete (STB_GLOBAL)
```
</details>
</li>
<li>
