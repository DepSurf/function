...
```
In net/netfilter/nf_conntrack_helper.c (ffffffff819a3180)
Location: net/netfilter/nf_conntrack_helper.c:73
Inline: False
Direct callers:
...
```
ffffffff819a3180-ffffffff819a3214: __nf_conntrack_helper_find (STB_GLOBAL)
```
</details>
</li>
<li>
