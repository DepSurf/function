...
```
In net/netfilter/nf_conntrack_proto.c (ffffffff819a3dc0)
Location: net/netfilter/nf_conntrack_proto.c:97
Inline: False
Direct callers:
...
```
ffffffff819a3dc0-ffffffff819a3e5e: nf_ct_l4proto_find (STB_GLOBAL)
```
</details>
</li>
<li>
