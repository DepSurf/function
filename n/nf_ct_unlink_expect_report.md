...
```
In net/netfilter/nf_conntrack_expect.c (ffffffff819a2180)
Location: net/netfilter/nf_conntrack_expect.c:47
Inline: False
Direct callers:
...
```
ffffffff819a2180-ffffffff819a2273: nf_ct_unlink_expect_report (STB_GLOBAL)
```
</details>
</li>
<li>
