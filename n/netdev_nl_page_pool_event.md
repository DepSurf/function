...
```
In net/core/page_pool_user.c (ffffffff81f454a0)
Location: net/core/page_pool_user.c:254
Inline: False
Direct callers:
...
```
ffffffff81f454a0-ffffffff81f455ef: netdev_nl_page_pool_event (STB_LOCAL)
```
</details>
</li>
</ul>
