# Function: <code>nand_has_exec_op</code>
...
```
In drivers/mtd/nand/raw/nand_base.c (c0aa0900)
Location: drivers/mtd/nand/raw/internals.h:99
Inline: True
Inline callers:
...
```
```
In drivers/mtd/nand/raw/nand_legacy.c (c0aa3d84)
Location: drivers/mtd/nand/raw/internals.h:99
Inline: True
Inline callers:
  - drivers/mtd/nand/raw/nand_legacy.c:nand_legacy_check_hooks
  - drivers/mtd/nand/raw/nand_legacy.c:nand_legacy_set_defaults
```
```
