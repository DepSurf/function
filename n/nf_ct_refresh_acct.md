# Function: <code>nf_ct_refresh_acct</code>
...
```
In net/netfilter/nf_conntrack_core.c (ffffffff8199fc4f)
Location: include/net/netfilter/nf_conntrack.h:191
Inline: True
Inline callers:
  - net/netfilter/nf_conntrack_core.c:nf_conntrack_in
```
```
In net/netfilter/nf_conntrack_proto_tcp.c (ffffffff819a6493)
Location: include/net/netfilter/nf_conntrack.h:191
Inline: True
Inline callers:
...
```
```
In net/netfilter/nf_conntrack_proto_udp.c (ffffffff819a72a8)
Location: include/net/netfilter/nf_conntrack.h:191
Inline: True
Inline callers:
...
```
```
In net/netfilter/nf_conntrack_proto_icmp.c (ffffffff819a7850)
Location: include/net/netfilter/nf_conntrack.h:191
Inline: True
Inline callers:
...
```
```
In net/netfilter/nf_conntrack_proto_icmpv6.c (ffffffff819a8877)
Location: include/net/netfilter/nf_conntrack.h:191
Inline: True
Inline callers:
...
```
```
In net/netfilter/nf_conntrack_proto_dccp.c (ffffffff819a9d91)
Location: include/net/netfilter/nf_conntrack.h:191
Inline: True
Inline callers:
...
```
```
In net/netfilter/nf_conntrack_proto_sctp.c (ffffffff819ab069)
Location: include/net/netfilter/nf_conntrack.h:191
Inline: True
Inline callers:
...
```
```
In net/netfilter/nf_conntrack_proto_gre.c (ffffffff819abb84)
Location: include/net/netfilter/nf_conntrack.h:191
Inline: True
Inline callers:
