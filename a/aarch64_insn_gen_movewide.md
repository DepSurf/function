...
```
In arch/arm64/kernel/insn.c (ffff800010096ea0)
Location: arch/arm64/kernel/insn.c:952
Inline: False
Direct callers:
...
```
ffff800010096ea0-ffff800010096fb8: aarch64_insn_gen_movewide (STB_GLOBAL)
```
</details>
</li>
<li>
