# Function: <code>apparmor_sock</code>
...
```
In security/apparmor/lsm.c (ffffffff813e9c25)
Location: security/apparmor/include/net.h:61
Inline: True
Inline callers:
...
```
```
In security/apparmor/af_unix.c (ffffffff813f3ca6)
Location: security/apparmor/include/net.h:61
Inline: True
Inline callers:
...
```
In security/apparmor/lsm.c (ffffffff8140fcc5)
Location: security/apparmor/include/net.h:61
Inline: True
Inline callers:
  - security/apparmor/lsm.c:apparmor_sock_graft
...
```
```
In security/apparmor/af_unix.c (ffffffff8141be8c)
Location: security/apparmor/include/net.h:61
Inline: True
Inline callers:
  - security/apparmor/af_unix.c:aa_unix_file_perm
