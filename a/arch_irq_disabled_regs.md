# Function: <code>arch_irq_disabled_regs</code>
...
```
In arch/powerpc/kernel/traps.c (c00000000002ec7c)
Location: arch/powerpc/include/asm/hw_irq.h:268
Inline: True
Inline callers:
...
```
```
In arch/powerpc/mm/fault.c (c0000000000861f0)
Location: arch/powerpc/include/asm/hw_irq.h:268
Inline: True
Inline callers:
