# Function: <code>alloc_runtime_data</code>
...
Location: arch/x86/kernel/sev-es.c:656
Inline: True
Inline callers:
...
Location: arch/x86/kernel/sev.c:735
Inline: True
Inline callers:
...
Location: arch/x86/kernel/sev.c:732
Inline: True
Inline callers:
  - arch/x86/kernel/sev.c:sev_es_init_vc_handling
```
...
Location: arch/x86/kernel/sev.c:1304
Inline: True
Inline callers:
  - arch/x86/kernel/sev.c:sev_es_init_vc_handling
```
