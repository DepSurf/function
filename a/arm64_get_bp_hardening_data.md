# Function: <code>arm64_get_bp_hardening_data</code>
...
```
In arch/arm64/mm/fault.c (ffff80001008132c)
Location: arch/arm64/include/asm/mmu.h:96
Inline: True
Inline callers:
...
```
```
In arch/arm64/mm/context.c (ffff8000100afc54)
Location: arch/arm64/include/asm/mmu.h:96
Inline: True
Inline callers:
...
```
```
In virt/kvm/arm/arm.c (ffff8000100c59a4)
Location: arch/arm64/include/asm/mmu.h:96
Inline: True
Inline callers:
...
```
```
In arch/arm64/kvm/hyp/switch.c (ffff8000100efc68)
Location: arch/arm64/include/asm/mmu.h:96
Inline: True
Inline callers:
