...
Location: include/linux/atomic-arch-fallback.h:1759
Inline: True
```
```
...
Location: include/linux/atomic-arch-fallback.h:1829
Inline: True
```
```
...
Location: include/linux/atomic/atomic-arch-fallback.h:1829
Inline: True
```
```
...
Location: include/linux/atomic/atomic-arch-fallback.h:1927
Inline: True
```
```
...
Location: arch/arm64/include/asm/atomic.h:64
Inline: True
Inline callers:
...
```
```
In kernel/fork.c (ffff8000100f4a3c)
Location: arch/arm64/include/asm/atomic.h:64
Inline: True
Inline callers:
...
```
```
In fs/ecryptfs/mmap.c (ffff8000104f5a50)
Location: arch/arm64/include/asm/atomic.h:64
Inline: True
Inline callers:
...
```
```
In drivers/spi/spi.c (ffff8000109c4018)
Location: arch/arm64/include/asm/atomic.h:64
Inline: True
Inline callers:
...
```
```
In drivers/usb/core/hcd.c (ffff800010a1f084)
Location: arch/arm64/include/asm/atomic.h:64
Inline: True
Inline callers:
...
```
```
In drivers/usb/host/ehci-hcd.c (ffff800010a5d6e8)
Location: arch/arm64/include/asm/atomic.h:64
Inline: True
Inline callers:
...
```
```
In drivers/usb/host/ohci-hcd.c (ffff800010a65a94)
Location: arch/arm64/include/asm/atomic.h:64
Inline: True
Inline callers:
...
```
```
In drivers/usb/host/uhci-hcd.c (ffff800010a6ab34)
Location: arch/arm64/include/asm/atomic.h:64
Inline: True
Inline callers:
...
```
```
In drivers/rtc/rtc-sun6i.c (ffff800010aade18)
Location: arch/arm64/include/asm/atomic.h:64
Inline: True
Direct callers:
...
```
```
In drivers/i2c/i2c-core-of.c (ffff800010ab6e90)
Location: arch/arm64/include/asm/atomic.h:64
Inline: True
Direct callers:
...
```
ffff80001009be18-ffff80001009be30: arch_atomic64_andnot (STB_LOCAL)
ffff8000100f1708-ffff8000100f1720: arch_atomic64_andnot (STB_LOCAL)
ffff80001031fea0-ffff80001031feb8: arch_atomic64_andnot (STB_LOCAL)
ffff800010354228-ffff800010354240: arch_atomic64_andnot (STB_LOCAL)
ffff80001047dd70-ffff80001047dd88: arch_atomic64_andnot (STB_LOCAL)
ffff8000104cd9a0-ffff8000104cd9b8: arch_atomic64_andnot (STB_LOCAL)
ffff8000104d42d0-ffff8000104d42e8: arch_atomic64_andnot (STB_LOCAL)
ffff8000104f58e0-ffff8000104f5900: arch_atomic64_andnot.constprop.0 (STB_LOCAL)
ffff800010770840-ffff800010770858: arch_atomic64_andnot (STB_LOCAL)
ffff8000107d1264-ffff8000107d1280: arch_atomic64_andnot.constprop.0 (STB_LOCAL)
ffff8000107fd120-ffff8000107fd138: arch_atomic64_andnot (STB_LOCAL)
ffff8000109c3ed0-ffff8000109c3ef0: arch_atomic64_andnot.constprop.0 (STB_LOCAL)
ffff800010a1c118-ffff800010a1c130: arch_atomic64_andnot (STB_LOCAL)
ffff800010a54d50-ffff800010a54d68: arch_atomic64_andnot (STB_LOCAL)
ffff800010a60690-ffff800010a606a8: arch_atomic64_andnot (STB_LOCAL)
ffff800010a69520-ffff800010a69538: arch_atomic64_andnot (STB_LOCAL)
ffff800010a83658-ffff800010a83670: arch_atomic64_andnot (STB_LOCAL)
ffff800010aade18-ffff800010aade50: arch_atomic64_andnot.constprop.0 (STB_LOCAL)
ffff800010ab6e90-ffff800010ab6ec8: arch_atomic64_andnot.constprop.0 (STB_LOCAL)
ffff800010ae68a0-ffff800010ae68b8: arch_atomic64_andnot (STB_LOCAL)
```
</details>
</li>
<li>
