# Function: <code>arch_atomic_sub_return_release</code>
...
```
```
In kernel/power/process.c (ffff80001016fe24)
Location: arch/arm64/include/asm/atomic.h:53
Inline: True
Inline callers:
...
```
ffff80001010b1a8-ffff80001010b1e0: arch_atomic_sub_return_release.constprop.0 (STB_LOCAL)
ffff80001016f980-ffff80001016f9b8: arch_atomic_sub_return_release.constprop.0 (STB_LOCAL)
ffff8000103b2fd0-ffff8000103b3010: arch_atomic_sub_return_release.constprop.0 (STB_LOCAL)
ffff80001098f528-ffff80001098f558: arch_atomic_sub_return_release.constprop.0 (STB_LOCAL)
ffff800010d005e8-ffff800010d00618: arch_atomic_sub_return_release.constprop.0 (STB_LOCAL)
```
</details>
</li>
<li>
