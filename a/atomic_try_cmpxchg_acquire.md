# Function: <code>atomic_try_cmpxchg_acquire</code>
...
Location: include/asm-generic/atomic-instrumented.h:703
Inline: True
Inline callers:
...
```
```
In kernel/locking/qspinlock.c (ffffffff8110faa1)
Location: include/asm-generic/atomic-instrumented.h:703
Inline: True
```
```
...
```
```
In kernel/locking/qspinlock.c (ffffffff8110cc61)
Location: include/asm-generic/atomic-instrumented.h:703
Inline: True
```
```
...
```
```
In kernel/locking/qspinlock.c (ffffffff8110e952)
Location: include/asm-generic/atomic-instrumented.h:703
Inline: True
```
```
...
Location: include/linux/atomic/atomic-instrumented.h:509
Inline: True
Inline callers:
  - arch/x86/kernel/dumpstack.c:oops_begin
  - arch/x86/kernel/dumpstack.c:oops_begin
...
```
```
In kernel/locking/qspinlock.c (ffffffff8112e122)
Location: include/linux/atomic/atomic-instrumented.h:509
Inline: True
```
```
...
Location: include/linux/atomic/atomic-instrumented.h:539
Inline: True
Inline callers:
  - arch/x86/kernel/dumpstack.c:oops_begin
  - arch/x86/kernel/dumpstack.c:oops_begin
...
```
```
In kernel/locking/qspinlock.c (ffffffff8114f26c)
Location: include/linux/atomic/atomic-instrumented.h:539
Inline: True
```
```
...
```
```
In kernel/locking/qspinlock.c (ffffffff820d6641)
Location: include/linux/atomic/atomic-instrumented.h:539
Inline: True
Inline callers:
...
Location: include/linux/atomic-fallback.h:928
Inline: True
Inline callers:
