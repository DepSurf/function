# Function: <code>apparmor_cred</code>
...
Location: security/apparmor/include/context.h:59
Inline: True
Inline callers:
...
```
```
In security/apparmor/context.c (ffffffff813dcf4f)
Location: security/apparmor/include/context.h:59
Inline: True
Inline callers:
...
```
In security/apparmor/apparmorfs.c (ffffffff81400d3c)
Location: security/apparmor/include/context.h:59
Inline: True
Inline callers:
  - security/apparmor/apparmorfs.c:policy_readlink
...
```
```
In security/apparmor/context.c (ffffffff81403a6f)
Location: security/apparmor/include/context.h:59
Inline: True
Inline callers:
  - security/apparmor/context.c:aa_restore_previous_label
...
```
```
In security/apparmor/domain.c (ffffffff81409839)
Location: security/apparmor/include/context.h:59
Inline: True
Inline callers:
  - security/apparmor/domain.c:aa_change_profile
...
```
```
In security/apparmor/policy_unpack.c (ffffffff8140caf2)
Location: security/apparmor/include/context.h:59
Inline: True
```
```
In security/apparmor/procattr.c (ffffffff8140e477)
Location: security/apparmor/include/context.h:59
Inline: True
Inline callers:
  - security/apparmor/procattr.c:aa_getprocattr
...
```
```
In security/apparmor/lsm.c (ffffffff8140fcec)
Location: security/apparmor/include/context.h:59
Inline: True
Inline callers:
  - security/apparmor/lsm.c:apparmor_sock_graft
...
```
```
In security/apparmor/label.c (ffffffff81416e13)
Location: security/apparmor/include/context.h:59
Inline: True
Inline callers:
  - security/apparmor/label.c:aa_label_printk
...
```
```
In security/apparmor/net.c (ffffffff81419b53)
Location: security/apparmor/include/context.h:59
Inline: True
Inline callers:
  - security/apparmor/net.c:aa_sk_perm
...
```
```
In security/apparmor/af_unix.c (ffffffff8141b81c)
Location: security/apparmor/include/context.h:59
Inline: True
Inline callers:
  - security/apparmor/af_unix.c:aa_unix_opt_perm
