...
```
In arch/arm64/kernel/acpi.c (ffff8000100a9120)
Location: arch/arm64/kernel/acpi.c:241
Inline: False
Direct callers:
...
```
ffff8000100a9120-ffff8000100a93fc: __acpi_get_mem_attribute (STB_GLOBAL)
```
</details>
</li>
<li>
