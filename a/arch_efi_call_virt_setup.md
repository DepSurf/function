...
```
In arch/x86/platform/efi/efi_64.c (ffffffff810ebd80)
Location: arch/x86/platform/efi/efi_64.c:490
Inline: False
Direct callers:
...
```
ffffffff810ebd80-ffffffff810ebe04: arch_efi_call_virt_setup (STB_GLOBAL)
```
</details>
</li>
</ul>
