...
```
In arch/arm64/kernel/insn.c (ffff800010096780)
Location: arch/arm64/kernel/insn.c:573
Inline: False
Direct callers:
...
```
ffff800010096780-ffff8000100967d4: aarch64_insn_gen_branch_reg (STB_GLOBAL)
```
</details>
</li>
<li>
