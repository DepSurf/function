# Function: <code>available_huge_pages</code>
...
```
In mm/hugetlb.c (ffffffff8140b45c)
...
```
In mm/hugetlb.c (ffffffff8143eaac)
Location: mm/hugetlb.c:1346
Inline: True
Inline callers:
...
```
In mm/hugetlb.c (ffffffff814785cc)
Location: mm/hugetlb.c:1384
Inline: True
Inline callers:
  - mm/hugetlb.c:alloc_hugetlb_folio_nodemask
  - mm/hugetlb.c:dissolve_free_huge_page
