# Function: <code>atomic_long_andnot</code>
...
Location: include/asm-generic/atomic-long.h:201
Inline: True
```
</details>
</li>
...
Location: include/asm-generic/atomic-long.h:296
Inline: True
```
```
...
Location: include/asm-generic/atomic-long.h:297
Inline: True
```
```
...
Location: include/linux/atomic/atomic-instrumented.h:1496
Inline: True
```
```
...
Location: include/linux/atomic/atomic-instrumented.h:1597
Inline: True
```
```
...
Location: include/linux/atomic/atomic-instrumented.h:3968
Inline: True
```
```
...
Location: include/asm-generic/atomic-long.h:790
Inline: True
```
```
