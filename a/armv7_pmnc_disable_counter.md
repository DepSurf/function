# Function: <code>armv7_pmnc_disable_counter</code>
...
```
In arch/arm/kernel/perf_event_v7.c (c03195ac)
Location: arch/arm/kernel/perf_event_v7.c:796
Inline: True
Inline callers:
  ...
  - arch/arm/kernel/perf_event_v7.c:armv7pmu_reset
