...
```
In arch/x86/net/bpf_jit_comp.c (ffffffff810f3ab0)
Location: arch/x86/net/bpf_jit_comp.c:2493
Inline: False
Direct callers:
...
```
ffffffff810f3ab0-ffffffff810f46d4: __arch_prepare_bpf_trampoline (STB_LOCAL)
```
</details>
</li>
</ul>
