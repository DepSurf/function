...
```
In arch/x86/kernel/apic/ipi.c (ffffffff810a9e01)
Location: arch/x86/kernel/apic/ipi.c:115
Inline: True
Inline callers:
...
```
ffffffff810a9720-ffffffff810a9775: apic_mem_wait_icr_idle_timeout (STB_GLOBAL)
```
</details>
</li>
</ul>
