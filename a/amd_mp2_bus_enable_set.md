...
```
In drivers/i2c/busses/i2c-amd-mp2-pci.c (ffffffff81867e40)
Location: drivers/i2c/busses/i2c-amd-mp2-pci.c:57
Inline: False
Direct callers:
...
```
ffffffff81867e40-ffffffff81867f0b: amd_mp2_bus_enable_set (STB_GLOBAL)
```
</details>
</li>
<li>
