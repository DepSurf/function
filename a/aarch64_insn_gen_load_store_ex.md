...
```
In arch/arm64/kernel/insn.c (ffff8000100969f8)
Location: arch/arm64/kernel/insn.c:691
Inline: False
Direct callers:
...
```
ffff8000100969f8-ffff800010096ad4: aarch64_insn_gen_load_store_ex (STB_GLOBAL)
```
</details>
</li>
<li>
