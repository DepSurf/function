# Function: <code>ablkcipher_request_free</code>
...
```
In fs/ext4/crypto.c (ffffffff812e4f88)
...
```
```
In fs/ext4/crypto_key.c (ffffffff812e58ef)
Location: include/linux/crypto.h:997
Inline: True
Inline callers:
...
```
```
In fs/ext4/crypto_fname.c (ffffffff812e6163)
Location: include/linux/crypto.h:997
Inline: True
Inline callers:
...
```
```
In fs/ecryptfs/crypto.c (ffffffff81305394)
Location: include/linux/crypto.h:997
Inline: True
Inline callers:
