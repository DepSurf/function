# Function: <code>acpi_dev_hid_match</code>
...
```
In drivers/acpi/acpi_lpss.c (ffffffff81a00309)
Location: include/acpi/acpi_bus.h:863
Inline: True
Inline callers:
...
```
```
In drivers/acpi/x86/s2idle.c (ffffffff81a09f21)
Location: include/acpi/acpi_bus.h:863
Inline: True
```
```
In drivers/iommu/amd/iommu.c (ffffffff81b559b0)
Location: include/acpi/acpi_bus.h:863
Inline: True
Inline callers:
