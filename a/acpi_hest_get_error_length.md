# Function: <code>acpi_hest_get_error_length</code>
...
```
In drivers/firmware/efi/cper.c (ffffffff817886c1)
Location: include/acpi/ghes.h:93
Inline: True
Inline callers:
...
Location: include/acpi/ghes.h:94
Inline: True
```
```
In drivers/firmware/efi/cper.c (ffffffff817feb85)
Location: include/acpi/ghes.h:94
Inline: True
Inline callers:
  - drivers/firmware/efi/cper.c:cper_estatus_check
...
```
In drivers/acpi/apei/ghes.c (ffffffff815d74b5)
Location: include/acpi/ghes.h:93
Inline: True
```
```
In drivers/firmware/efi/cper.c (ffffffff81848381)
Location: include/acpi/ghes.h:93
Inline: True
Inline callers:
  - drivers/firmware/efi/cper.c:cper_estatus_check
...
```
In drivers/acpi/apei/ghes.c (ffffffff815f0c35)
Location: include/acpi/ghes.h:93
Inline: True
```
```
In drivers/firmware/efi/cper.c (ffffffff818745d1)
Location: include/acpi/ghes.h:93
Inline: True
Inline callers:
  - drivers/firmware/efi/cper.c:cper_estatus_check
...
```
In drivers/acpi/apei/ghes.c (ffffffff81622a33)
Location: include/acpi/ghes.h:93
Inline: True
```
```
...
```
In drivers/acpi/apei/ghes.c (ffffffff81644503)
Location: include/acpi/ghes.h:93
Inline: True
```
```
...
Location: include/acpi/ghes.h:96
Inline: True
```
```
...
```
In drivers/acpi/apei/ghes.c (ffffffff8170e63e)
...
Location: include/acpi/ghes.h:95
Inline: True
Inline callers:
  - drivers/acpi/apei/ghes.c:ghes_defer_non_standard_event
  - drivers/acpi/apei/ghes.c:ghes_defer_non_standard_event
...
Location: include/acpi/ghes.h:99
Inline: True
Inline callers:
  - drivers/acpi/apei/ghes.c:ghes_defer_non_standard_event
  - drivers/acpi/apei/ghes.c:ghes_defer_non_standard_event
...
```
In drivers/acpi/apei/ghes.c (ffff8000107af678)
Location: include/acpi/ghes.h:93
Inline: True
```
```
In drivers/firmware/efi/cper.c (ffff800010b5e4b0)
Location: include/acpi/ghes.h:93
Inline: True
Inline callers:
  - drivers/firmware/efi/cper.c:cper_estatus_check
...
```
In drivers/acpi/apei/ghes.c (ffffffff81638343)
Location: include/acpi/ghes.h:93
Inline: True
```
```
...
```
In drivers/acpi/apei/ghes.c (ffffffff81652683)
Location: include/acpi/ghes.h:93
Inline: True
```
```
