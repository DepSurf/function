...
```
```
In fs/ext4/super.c (ffffffff812bacc1)
Location: fs/ext4/ext4.h:2704
Inline: True
Inline callers:
...
```
```
In fs/ext4/inode.c (ffffffff812c3bdf)
Location: fs/ext4/ext4.h:2739
Inline: True
Inline callers:
  - fs/ext4/inode.c:__ext4_get_inode_loc
...
```
```
In fs/ext4/inode.c (ffffffff812d928f)
Location: fs/ext4/ext4.h:2717
Inline: True
Inline callers:
  - fs/ext4/inode.c:__ext4_get_inode_loc
...
```
ffffffff813ec940-ffffffff813ec97a: ext4_has_group_desc_csum (STB_LOCAL)
```
</details>
</li>
<li>
