...
```
In arch/powerpc/mm/book3s64/radix_tlb.c (c000000000095dc0)
Location: arch/powerpc/mm/book3s64/radix_tlb.c:658
Inline: False
Direct callers:
...
```
c000000000095dc0-c000000000095e90: exit_flush_lazy_tlbs (STB_LOCAL)
```
</details>
</li>
<li>
