# Function: <code>edid_extension_block_count</code>
...
```
In drivers/gpu/drm/drm_edid.c (ffffffff81c95d60)
Location: drivers/gpu/drm/drm_edid.c:1598
Inline: True
Inline callers:
  ...
  - drivers/gpu/drm/drm_edid.c:drm_edid_raw
  ...
  - drivers/gpu/drm/drm_edid.c:drm_edid_are_equal
  - drivers/gpu/drm/drm_edid.c:drm_edid_legacy_init
```
</details>
</li>
</ul>
