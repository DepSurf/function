# Function: <code>ext4_es_must_keep</code>
...
```
In fs/ext4/extents_status.c (ffffffff815a0f96)
Location: fs/ext4/extents_status.c:455
Inline: True
Inline callers:
...
```
In fs/ext4/extents_status.c (ffffffff815d9cf6)
Location: fs/ext4/extents_status.c:469
Inline: True
Inline callers:
  - fs/ext4/extents_status.c:ext4_clear_inode_es
  - fs/ext4/extents_status.c:es_do_reclaim_extents
