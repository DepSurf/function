...
```
In drivers/gpu/drm/drm_edid.c (ffffffff81c92139)
Location: drivers/gpu/drm/drm_edid.c:5182
Inline: True
Inline callers:
...
```
ffffffff81c8cbe0-ffffffff81c8cc6b: edid_hfeeodb_extension_block_count (STB_LOCAL)
```
</details>
</li>
</ul>
