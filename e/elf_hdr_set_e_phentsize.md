# Function: <code>elf_hdr_set_e_phentsize</code>
...
```
In drivers/remoteproc/remoteproc_core.c (ffffffff819cb37d)
Location: drivers/remoteproc/remoteproc_elf_helpers.h:67
Inline: True
Inline callers:
