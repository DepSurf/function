...
```
In arch/powerpc/kernel/eeh_pe.c (c000000000047cd0)
Location: arch/powerpc/kernel/eeh_pe.c:649
Inline: False
Direct callers:
...
```
c000000000047cd0-c000000000047dd8: eeh_pe_state_clear (STB_GLOBAL)
```
</details>
</li>
<li>
