...
```
In arch/powerpc/kernel/eeh_pe.c (c0000000000474b0)
Location: arch/powerpc/kernel/eeh_pe.c:367
Inline: False
Direct callers:
...
```
c0000000000474b0-c000000000047998: eeh_add_to_parent_pe (STB_GLOBAL)
```
</details>
</li>
<li>
