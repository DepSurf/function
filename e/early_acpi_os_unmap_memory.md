...
```
In drivers/acpi/osl.c (ffffffff81fa120f)
Location: drivers/acpi/osl.c:472
Inline: False
Direct callers:
...
```
ffffffff81fa120f-ffffffff81fa1223: early_acpi_os_unmap_memory (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In drivers/acpi/osl.c (ffffffff81fcd2dd)
...
```
ffffffff81fcd2dd-ffffffff81fcd2f1: early_acpi_os_unmap_memory (STB_GLOBAL)
```
</details>
</li>
<li>
