...
```
In arch/powerpc/kernel/process.c (c0000000000209f0)
Location: arch/powerpc/kernel/process.c:280
Inline: True
Direct callers:
...
```
c0000000000209f0-c000000000020a98: enable_kernel_altivec (STB_GLOBAL)
```
</details>
</li>
<li>
