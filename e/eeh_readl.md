...
Location: arch/powerpc/include/asm/eeh.h:399
Inline: True
```
```
...
```
```
In drivers/usb/host/ehci-pci.c (c000000000b2c2b0)
Location: arch/powerpc/include/asm/eeh.h:399
Inline: False
Direct callers:
...
```
c000000000891ca0-c000000000891d24: eeh_readl (STB_LOCAL)
c000000000b007b0-c000000000b00834: eeh_readl (STB_LOCAL)
c000000000b0db80-c000000000b0dc04: eeh_readl (STB_LOCAL)
c000000000b18190-c000000000b18214: eeh_readl (STB_LOCAL)
c000000000b2c2b0-c000000000b2c334: eeh_readl (STB_LOCAL)
c000000000b2ce20-c000000000b2cea4: eeh_readl (STB_LOCAL)
c000000000b41380-c000000000b41404: eeh_readl (STB_LOCAL)
c000000000b5d020-c000000000b5d0a4: eeh_readl (STB_LOCAL)
```
</details>
</li>
<li>
