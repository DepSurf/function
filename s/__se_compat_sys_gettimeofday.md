# Function: <code>__se_compat_sys_gettimeofday</code>
...
```c
long int __se_compat_sys_gettimeofday(long int tv, long int tz);
```
...
```
In kernel/time/time.c (c0000000001fb0e0)
Location: kernel/time/time.c:225
Inline: False
```
**Symbols:**
...
```
c0000000001fb0e0-c0000000001fb2b0: __se_compat_sys_gettimeofday (STB_GLOBAL)
```
</details>
</li>
<li>
