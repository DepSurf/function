# Function: <code>substream_to_prtd</code>
...
```
In sound/core/pcm_dmaengine.c (c0c9cc84)
Location: sound/core/pcm_dmaengine.c:29
Inline: True
Inline callers:
  ...
  - sound/core/pcm_dmaengine.c:snd_dmaengine_pcm_get_chan
```
</details>
</li>
<li>
