...
```
In kernel/bpf/syscall.c (ffffffff8119f240)
...
```
ffffffff8119f240-ffffffff8119f3cd: sockmap_get_from_fd (STB_LOCAL)
```
</details>
</li>
<li>
...
```
In kernel/bpf/sockmap.c (ffffffff811d0660)
Location: kernel/bpf/sockmap.c:2054
Inline: False
Direct callers:
...
```
ffffffff811d0660-ffffffff811d06e0: sockmap_get_from_fd (STB_GLOBAL)
```
</details>
</li>
<li>
