...
Location: arch/arm64/include/asm/lse.h:22
Inline: True
Inline callers:
...
```
```
In arch/arm64/kernel/smp.c (ffff80001009d174)
Location: arch/arm64/include/asm/lse.h:22
Inline: True
Inline callers:
...
```
```
In kernel/locking/osq_lock.c (ffff80001016a764)
Location: arch/arm64/include/asm/lse.h:22
Inline: True
Inline callers:
...
```
```
In kernel/trace/trace.c (ffff8000102220a4)
Location: arch/arm64/include/asm/lse.h:22
Inline: True
Inline callers:
...
```
```
In mm/shuffle.c (ffff80001031b2f4)
Location: arch/arm64/include/asm/lse.h:22
Inline: False
Direct callers:
...
```
```
In drivers/clk/hisilicon/clk-hi6220.c (ffff8000107d1264)
Location: arch/arm64/include/asm/lse.h:22
Inline: True
```
```
...
```
```
In drivers/firmware/efi/memmap.c (ffff800010b5cdc8)
Location: arch/arm64/include/asm/lse.h:22
Inline: False
Direct callers:
...
```
```
In drivers/of/irq.c (ffff800010b75574)
Location: arch/arm64/include/asm/lse.h:22
Inline: False
Direct callers:
...
```
```
In net/dns_resolver/dns_key.c (ffff800010d72ebc)
Location: arch/arm64/include/asm/lse.h:22
Inline: False
Direct callers:
...
```
ffff80001009bc88-ffff80001009bca0: system_uses_lse_atomics (STB_LOCAL)
ffff8000100fa4c0-ffff8000100fa4d8: system_uses_lse_atomics (STB_LOCAL)
ffff80001011b890-ffff80001011b8a8: system_uses_lse_atomics (STB_LOCAL)
ffff800010132500-ffff800010132518: system_uses_lse_atomics (STB_LOCAL)
ffff8000101771c0-ffff8000101771d8: system_uses_lse_atomics (STB_LOCAL)
ffff8000101ce210-ffff8000101ce228: system_uses_lse_atomics (STB_LOCAL)
ffff800010290d90-ffff800010290da8: system_uses_lse_atomics (STB_LOCAL)
ffff8000102b6038-ffff8000102b6050: system_uses_lse_atomics (STB_LOCAL)
ffff8000102d9838-ffff8000102d9850: system_uses_lse_atomics (STB_LOCAL)
ffff8000102dd610-ffff8000102dd628: system_uses_lse_atomics (STB_LOCAL)
ffff8000102f0ae8-ffff8000102f0b00: system_uses_lse_atomics (STB_LOCAL)
ffff80001031b2f4-ffff80001031b30c: system_uses_lse_atomics (STB_LOCAL)
ffff800010342fb0-ffff800010342fc8: system_uses_lse_atomics (STB_LOCAL)
ffff8000103613c0-ffff8000103613d8: system_uses_lse_atomics (STB_LOCAL)
ffff80001047d348-ffff80001047d360: system_uses_lse_atomics (STB_LOCAL)
ffff8000104cd850-ffff8000104cd868: system_uses_lse_atomics (STB_LOCAL)
ffff8000106785e8-ffff800010678600: system_uses_lse_atomics (STB_LOCAL)
ffff8000107bbfc8-ffff8000107bbfe0: system_uses_lse_atomics (STB_LOCAL)
ffff8000107f24c0-ffff8000107f24d8: system_uses_lse_atomics (STB_LOCAL)
ffff800010805c30-ffff800010805c48: system_uses_lse_atomics (STB_LOCAL)
ffff800010809a10-ffff800010809a28: system_uses_lse_atomics (STB_LOCAL)
ffff80001080ae28-ffff80001080ae40: system_uses_lse_atomics (STB_LOCAL)
ffff80001096ef38-ffff80001096ef50: system_uses_lse_atomics (STB_LOCAL)
ffff800010a2bf20-ffff800010a2bf38: system_uses_lse_atomics (STB_LOCAL)
ffff800010aad200-ffff800010aad218: system_uses_lse_atomics (STB_LOCAL)
ffff800010ab6840-ffff800010ab6858: system_uses_lse_atomics (STB_LOCAL)
ffff800010ae21d0-ffff800010ae21e8: system_uses_lse_atomics (STB_LOCAL)
ffff800010b5a898-ffff800010b5a8b0: system_uses_lse_atomics (STB_LOCAL)
ffff800010b5cdc8-ffff800010b5cde0: system_uses_lse_atomics (STB_LOCAL)
ffff800010b75574-ffff800010b7558c: system_uses_lse_atomics (STB_LOCAL)
ffff800010b7f478-ffff800010b7f490: system_uses_lse_atomics (STB_LOCAL)
ffff800010ceea60-ffff800010ceea78: system_uses_lse_atomics (STB_LOCAL)
ffff800010d72ebc-ffff800010d72ed4: system_uses_lse_atomics (STB_LOCAL)
```
</details>
</li>
<li>
