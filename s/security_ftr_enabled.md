# Function: <code>security_ftr_enabled</code>
...
```
In arch/powerpc/kernel/security.c (c00000000003bb38)
Location: arch/powerpc/include/asm/security_features.h:37
Inline: True
Inline callers:
  - arch/powerpc/kernel/security.c:setup_count_cache_flush
  - arch/powerpc/kernel/security.c:cpu_show_spec_store_bypass
...
```
```
In arch/powerpc/platforms/powernv/setup.c (c00000000135a9ac)
Location: arch/powerpc/include/asm/security_features.h:37
Inline: True
Inline callers:
...
```
```
In arch/powerpc/platforms/pseries/setup.c (c0000000000ee378)
Location: arch/powerpc/include/asm/security_features.h:37
Inline: True
Inline callers:
