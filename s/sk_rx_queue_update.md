# Function: <code>sk_rx_queue_update</code>
...
```
In net/ipv4/tcp_input.c (ffffffff81cfc557)
...
```
In net/ipv4/tcp_input.c (ffffffff81ec10f7)
...
```
In net/ipv4/tcp_input.c (ffffffff81f1f657)
Location: include/net/sock.h:2041
Inline: True
Inline callers:
  - net/ipv4/tcp_input.c:tcp_finish_connect
```
...
```
In net/ipv4/tcp_input.c (ffffffff81fe3d1f)
Location: include/net/sock.h:2031
Inline: True
Inline callers:
  - net/ipv4/tcp_input.c:tcp_finish_connect
```
