# Function: <code>__se_compat_sys_rt_sigpending</code>
...
```c
long int __se_compat_sys_rt_sigpending(long int uset, long int sigsetsize);
```
...
```
In kernel/signal.c (c000000000152e60)
Location: kernel/signal.c:3103
Inline: False
```
**Symbols:**
...
```
c000000000152e60-c000000000152f5c: __se_compat_sys_rt_sigpending (STB_GLOBAL)
```
</details>
</li>
<li>
