# Function: <code>skcipher_givcrypt_reqtfm</code>
...
```
In crypto/chainiv.c (ffffffff813a1ed2)
Location: include/crypto/skcipher.h:74
Inline: True
Inline callers:
...
```
```
In crypto/eseqiv.c (ffffffff813a2416)
Location: include/crypto/skcipher.h:74
Inline: True
Inline callers:
