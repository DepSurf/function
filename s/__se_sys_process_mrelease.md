# Function: <code>__se_sys_process_mrelease</code>
...
```
In mm/oom_kill.c (ffffffff812a3375)
...
```
In mm/oom_kill.c (ffffffff812fb285)
...
```
In mm/oom_kill.c (ffffffff81364605)
...
```
In mm/oom_kill.c (ffffffff81396ad5)
...
```
In mm/oom_kill.c (ffffffff813c03e5)
