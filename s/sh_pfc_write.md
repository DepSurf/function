...
```
In drivers/pinctrl/sh-pfc/core.c (ffff8000106afd70)
Location: drivers/pinctrl/sh-pfc/core.c:177
Inline: False
Direct callers:
...
```
ffff8000106afd70-ffff8000106afde8: sh_pfc_write (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In drivers/pinctrl/sh-pfc/core.c (c08536b0)
Location: drivers/pinctrl/sh-pfc/core.c:177
Inline: False
Direct callers:
  - drivers/pinctrl/sh-pfc/core.c:sh_pfc_restore_reg
...
```
c08536b0-c085371c: sh_pfc_write (STB_GLOBAL)
```
</details>
</li>
<li>
