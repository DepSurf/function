...
```
In drivers/video/fbdev/mx3fb.c (ffff80001075fd60)
Location: drivers/video/fbdev/mx3fb.c:506
Inline: False
Direct callers:
...
```
ffff80001075fd60-ffff800010760138: sdc_init_panel (STB_LOCAL)
```
</details>
</li>
<li>
...
```
In drivers/video/fbdev/mx3fb.c (c08e2bf8)
Location: drivers/video/fbdev/mx3fb.c:506
Inline: True
Inline callers:
  - drivers/video/fbdev/mx3fb.c:__set_par
