...
```
In drivers/scsi/virtio_scsi.c (ffffffff81be3289)
Location: include/scsi/scsi_host.h:728
Inline: True
Inline callers:
...
```
In drivers/scsi/virtio_scsi.c (ffffffff81c386e9)
Location: include/scsi/scsi_host.h:731
Inline: True
Inline callers:
  - drivers/scsi/virtio_scsi.c:virtscsi_restore
  - drivers/scsi/virtio_scsi.c:virtscsi_probe
...
```
In drivers/scsi/storvsc_drv.c (ffffffff81713a9d)
Location: include/scsi/scsi_host.h:709
Inline: True
Inline callers:
...
```
In drivers/scsi/virtio_scsi.c (ffffffff81772d87)
Location: include/scsi/scsi_host.h:709
Inline: True
Inline callers:
  - drivers/scsi/virtio_scsi.c:virtscsi_restore
