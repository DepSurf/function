# Function: <code>__se_compat_sys_recvmmsg_time32</code>
...
```c
long int __se_compat_sys_recvmmsg_time32(long int fd, long int mmsg, long int vlen, long int flags, long int timeout);
```
...
```
In net/compat.c (c000000000d2bc40)
Location: net/compat.c:710
Inline: False
```
**Symbols:**
...
```
c000000000d2bc40-c000000000d2bc8c: __se_compat_sys_recvmmsg_time32 (STB_GLOBAL)
```
</details>
</li>
<li>
