# Function: <code>__se_sys_sigprocmask</code>
...
```c
long int __se_sys_sigprocmask(long int how, long int nset, long int oset);
```
...
```
c036a490-c036a630: __se_sys_sigprocmask (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In kernel/signal.c (c0000000001556c0)
Location: kernel/signal.c:4185
Inline: False
```
**Symbols:**
...
```
c0000000001556c0-c000000000155834: __se_sys_sigprocmask (STB_GLOBAL)
```
</details>
</li>
<li>
