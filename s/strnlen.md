...
```
In lib/string.c (ffffffff813f1ae0)
Location: lib/string.c:494
Inline: False
Direct callers:
  - mm/util.c:kstrndup
...
```
ffffffff813f1ae0-ffffffff813f1b1b: strnlen (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In lib/string.c (ffffffff81438490)
Location: lib/string.c:494
Inline: False
Direct callers:
  - mm/util.c:get_cmdline
...
```
ffffffff81438490-ffffffff814384bd: strnlen (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In lib/string.c (ffffffff81455480)
Location: lib/string.c:494
Inline: False
Direct callers:
  - mm/util.c:get_cmdline
...
```
ffffffff81455480-ffffffff814554ad: strnlen (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In init/main.c (ffffffff8209dd2d)
...
```
ffffffff818f69c0-ffffffff818f69f0: strnlen (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In init/main.c (ffffffff826a3d01)
...
```
ffffffff8197d3c0-ffffffff8197d3f0: strnlen (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In init/main.c (ffffffff826ccdab)
Location: include/linux/string.h:275
Inline: True
Inline callers:
  - init/main.c:start_kernel
  - init/main.c:start_kernel
...
```
ffffffff819d9900-ffffffff819d992c: strnlen (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In init/main.c (ffffffff82882da8)
Location: include/linux/string.h:282
Inline: True
Inline callers:
  - init/main.c:start_kernel
  - init/main.c:start_kernel
...
```
ffffffff81a11b20-ffffffff81a11b4f: strnlen (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In init/main.c (ffffffff82899d26)
Location: include/linux/string.h:289
Inline: True
Inline callers:
  - init/main.c:start_kernel
  - init/main.c:start_kernel
...
```
ffffffff81a81080-ffffffff81a810a7: strnlen (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In init/main.c (ffffffff8289cd12)
...
```
ffffffff81ab8280-ffffffff81ab82a7: strnlen (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In init/main.c (ffffffff82cc303b)
Location: include/linux/string.h:336
Inline: True
Inline callers:
...
```
ffffffff815f2ea0-ffffffff815f2eca: strnlen (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In init/main.c (ffffffff82faed9c)
Location: include/linux/string.h:330
Inline: True
Inline callers:
  - init/main.c:setup_command_line
  - init/main.c:setup_command_line
...
```
ffffffff81617550-ffffffff8161757a: strnlen (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In init/main.c (ffffffff831b8f59)
Location: include/linux/fortify-string.h:68
Inline: True
Inline callers:
  - init/main.c:setup_command_line
  - init/main.c:setup_command_line
...
```
ffffffff815fabd0-ffffffff815fabfa: strnlen (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In init/main.c (ffffffff83298e9b)
Location: include/linux/fortify-string.h:68
Inline: True
Inline callers:
  - init/main.c:setup_command_line
...
```
ffffffff81668470-ffffffff8166849a: strnlen (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In init/main.c (ffffffff8344704d)
Location: include/linux/fortify-string.h:105
Inline: True
Inline callers:
  - init/main.c:setup_command_line
  - init/main.c:setup_command_line
...
```
ffffffff81781e60-ffffffff81781ea8: strnlen (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In init/main.c (ffffffff83e60193)
Location: include/linux/fortify-string.h:185
Inline: True
Inline callers:
  - init/main.c:setup_command_line
  - init/main.c:setup_command_line
...
```
ffffffff8203ec40-ffffffff8203ec88: strnlen (STB_GLOBAL)
```
</details>
</li>
<li>
...
Location: include/linux/fortify-string.h:165
Inline: True
Inline callers:
...
```
ffffffff820bd150-ffffffff820bd198: strnlen (STB_GLOBAL)
```
</details>
</li>
<li>
...
Location: include/linux/fortify-string.h:161
Inline: True
Inline callers:
  - init/main.c:do_one_initcall
  - init/main.c:setup_command_line
...
```
ffffffff82197a50-ffffffff82197a98: strnlen (STB_GLOBAL)
```
</details>
</li>
</ul>
...
```
In init/main.c (ffff800011430d38)
Location: include/linux/string.h:310
Inline: True
Inline callers:
  - init/main.c:start_kernel
...
```
ffff800010d8338c-ffff800010d8344c: strnlen (STB_WEAK)
```
</details>
</li>
<li>
...
```
c0e8ed74-c0e8edc8: strnlen (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In init/main.c (c000000001343dac)
Location: include/linux/string.h:310
Inline: True
Inline callers:
  - init/main.c:start_kernel
...
```
c000000000ed64a0-c000000000ed64e0: strnlen (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In lib/string.c (ffffffe0008bcb34)
...
```
ffffffe0008bcb34-ffffffe0008bcb5e: strnlen (STB_GLOBAL)
```
</details>
</li>
</ul>
...
```
In init/main.c (ffffffff8288ad12)
Location: include/linux/string.h:310
Inline: True
Inline callers:
  - init/main.c:start_kernel
...
```
ffffffff81a570d0-ffffffff81a570f7: strnlen (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In init/main.c (ffffffff82888cb2)
Location: include/linux/string.h:310
Inline: True
Inline callers:
  - init/main.c:start_kernel
...
```
ffffffff81a141b0-ffffffff81a141d7: strnlen (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In init/main.c (ffffffff8289dd12)
Location: include/linux/string.h:310
Inline: True
Inline callers:
  - init/main.c:start_kernel
...
```
ffffffff81ac34c0-ffffffff81ac34e7: strnlen (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
ffffffff81acf990-ffffffff81acf9b7: strnlen (STB_GLOBAL)
```
</details>
</li>
</ul>
