...
```
In drivers/soundwire/bus.c (ffffffff818c1da7)
Location: drivers/soundwire/bus.h:135
Inline: True
Inline callers:
...
```
```
In drivers/soundwire/stream.c (ffffffff818c413c)
Location: drivers/soundwire/bus.h:135
Inline: True
Inline callers:
