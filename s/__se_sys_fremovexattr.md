# Function: <code>__se_sys_fremovexattr</code>
...
```c
long int __se_sys_fremovexattr(long int fd, long int name);
```
...
```
c059c290-c059c340: __se_sys_fremovexattr (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In fs/xattr.c (c0000000004bcd90)
Location: fs/xattr.c:752
Inline: False
```
**Symbols:**
...
```
c0000000004bcd90-c0000000004bce98: __se_sys_fremovexattr (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In fs/xattr.c (ffffffe00027fdc6)
Location: fs/xattr.c:752
Inline: False
```
**Symbols:**
...
```
ffffffe00027fdc6-ffffffe00027fe64: __se_sys_fremovexattr (STB_GLOBAL)
```
</details>
</li>
</ul>
