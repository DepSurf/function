# Function: <code>set_page_zone</code>
...
```
```
In mm/memory_hotplug.c (ffffffff81208fb5)
Location: include/linux/mm.h:858
Inline: True
Inline callers:
...
```
In mm/page_alloc.c (ffffffff8189729f)
Location: include/linux/mm.h:954
Inline: True
Inline callers:
  - mm/page_alloc.c:memmap_init_zone
  - mm/page_alloc.c:memmap_init_zone
...
Location: include/linux/mm.h:985
Inline: True
Inline callers:
  - mm/page_alloc.c:memmap_init_zone
```
...
Location: include/linux/mm.h:1115
Inline: True
Inline callers:
  - mm/page_alloc.c:memmap_init_zone
```
...
Location: include/linux/mm.h:1251
Inline: True
Inline callers:
...
Location: include/linux/mm.h:1265
Inline: True
Inline callers:
  - mm/page_alloc.c:memmap_init_zone_device
  - mm/page_alloc.c:memmap_init_zone
...
Location: include/linux/mm.h:1439
Inline: True
Inline callers:
  - mm/page_alloc.c:memmap_init_zone_device
  - mm/page_alloc.c:memmap_init_zone
...
Location: include/linux/mm.h:1502
Inline: True
```
</details>
</li>
...
Location: include/linux/mm.h:1572
Inline: True
```
</details>
</li>
...
Location: include/linux/mm.h:1621
Inline: True
```
</details>
</li>
...
Location: include/linux/mm.h:1974
Inline: True
Inline callers:
...
Location: include/linux/mm.h:2029
Inline: True
Inline callers:
  - mm/mm_init.c:memmap_init_range
  - mm/mm_init.c:init_unavailable_range
...
```
In mm/page_alloc.c (c000000000eec9a0)
Location: include/linux/mm.h:1265
Inline: True
Inline callers:
  - mm/page_alloc.c:memmap_init_zone
