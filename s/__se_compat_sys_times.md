# Function: <code>__se_compat_sys_times</code>
...
```c
long int __se_compat_sys_times(long int tbuf);
```
...
```
In kernel/sys.c (c00000000015c590)
Location: kernel/sys.c:975
Inline: False
```
**Symbols:**
...
```
c00000000015c590-c00000000015c730: __se_compat_sys_times (STB_GLOBAL)
```
</details>
</li>
<li>
