...
```
In arch/x86/kernel/cpu/bugs.c (ffffffff81060345)
Location: arch/x86/kernel/cpu/bugs.c:82
Inline: True
Inline callers:
...
```
ffffffff8105f3a0-ffffffff8105f3b7: spec_ctrl_current (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In arch/x86/kernel/cpu/bugs.c (ffffffff8106e645)
Location: arch/x86/kernel/cpu/bugs.c:89
Inline: True
Inline callers:
  - arch/x86/kernel/cpu/bugs.c:update_stibp_msr
Direct callers:
...
```
ffffffff8106db40-ffffffff8106db57: spec_ctrl_current (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In arch/x86/kernel/cpu/bugs.c (ffffffff8213e640)
Location: arch/x86/kernel/cpu/bugs.c:94
Inline: False
Direct callers:
  - arch/x86/kernel/cpu/bugs.c:update_stibp_msr
  - arch/x86/platform/efi/quirks.c:efi_crash_gracefully_on_page_fault
...
```
ffffffff8213e640-ffffffff8213e64d: spec_ctrl_current (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In arch/x86/kernel/cpu/bugs.c (ffffffff82220630)
Location: arch/x86/kernel/cpu/bugs.c:94
Inline: False
Direct callers:
  - arch/x86/kernel/cpu/bugs.c:update_stibp_msr
...
```
ffffffff82220630-ffffffff8222063d: spec_ctrl_current (STB_GLOBAL)
```
</details>
</li>
</ul>
