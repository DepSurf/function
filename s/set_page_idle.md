# Function: <code>set_page_idle</code>
...
Location: include/linux/page_idle.h:31
Inline: True
Inline callers:
...
Location: include/linux/page_idle.h:32
Inline: True
Inline callers:
...
```
In mm/huge_memory.c (ffffffff813b9d3f)
Location: include/linux/page_idle.h:129
Inline: True
```
```
...
```
In mm/huge_memory.c (ffffffff8143c81c)
Location: include/linux/page_idle.h:143
Inline: True
```
```
...
```
In mm/huge_memory.c (ffffffff81471dc9)
Location: include/linux/page_idle.h:143
Inline: True
```
</details>
...
```
In mm/migrate.c (c055158c)
Location: include/linux/page_idle.h:88
Inline: True
Inline callers:
  - mm/migrate.c:migrate_page_states
```
```
In mm/page_idle.c (c05649e0)
Location: include/linux/page_idle.h:88
Inline: True
Inline callers:
  - mm/page_idle.c:page_idle_bitmap_write
