# Function: <code>skb_tstamp_cond</code>
...
```
In net/ipv6/ioam6.c (ffffffff81dd6f66)
...
```
In net/ipv6/ioam6.c (ffffffff81fa8926)
...
```
In net/ipv6/ioam6.c (ffffffff820092b6)
...
```
In net/ipv6/ioam6.c (ffffffff820d8256)
