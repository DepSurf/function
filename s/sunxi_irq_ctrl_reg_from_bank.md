# Function: <code>sunxi_irq_ctrl_reg_from_bank</code>
...
```
In drivers/pinctrl/sunxi/pinctrl-sunxi.c (ffff8000106b6a24)
Location: drivers/pinctrl/sunxi/pinctrl-sunxi.h:319
Inline: True
Inline callers:
