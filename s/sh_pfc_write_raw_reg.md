...
Location: drivers/pinctrl/sh-pfc/core.c:154
Inline: True
Inline callers:
...
```
ffff8000106afc60-ffff8000106afce8: sh_pfc_write_raw_reg (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
c085361c-c085368c: sh_pfc_write_raw_reg (STB_GLOBAL)
```
</details>
</li>
<li>
