# Function: <code>__se_sys_sendmmsg</code>
...
```c
long int __se_sys_sendmmsg(long int fd, long int mmsg, long int vlen, long int flags);
```
...
```
c0cc730c-c0cc7338: __se_sys_sendmmsg (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In net/socket.c (c000000000c7d170)
Location: net/socket.c:2480
Inline: False
```
**Symbols:**
...
```
c000000000c7d170-c000000000c7d1b0: __se_sys_sendmmsg (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In net/socket.c (ffffffe00073c026)
Location: net/socket.c:2480
Inline: False
```
**Symbols:**
...
```
ffffffe00073c026-ffffffe00073c070: __se_sys_sendmmsg (STB_GLOBAL)
```
</details>
</li>
</ul>
