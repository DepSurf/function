...
```
In drivers/irqchip/irq-sunxi-nmi.c (ffff800011471154)
Location: drivers/irqchip/irq-sunxi-nmi.c:159
Inline: False
Direct callers:
...
```
ffff800011471154-ffff8000114713a4: sunxi_sc_nmi_irq_init (STB_LOCAL)
```
</details>
</li>
<li>
