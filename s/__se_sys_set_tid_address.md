# Function: <code>__se_sys_set_tid_address</code>
...
```c
long int __se_sys_set_tid_address(long int tidptr);
```
...
```
c035323c-c0353278: __se_sys_set_tid_address (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In kernel/fork.c (c000000000136d00)
Location: kernel/fork.c:1632
Inline: False
```
**Symbols:**
...
```
c000000000136d00-c000000000136d48: __se_sys_set_tid_address (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In kernel/fork.c (ffffffe0000c1246)
Location: kernel/fork.c:1632
Inline: False
```
**Symbols:**
...
```
ffffffe0000c1246-ffffffe0000c1278: __se_sys_set_tid_address (STB_GLOBAL)
```
</details>
</li>
</ul>
