# Function: <code>__se_sys_setrlimit</code>
...
```c
long int __se_sys_setrlimit(long int resource, long int rlim);
```
...
```
c036dce0-c036ddb0: __se_sys_setrlimit (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In kernel/sys.c (c000000000161000)
Location: kernel/sys.c:1668
Inline: False
```
**Symbols:**
...
```
c000000000161000-c0000000001610a0: __se_sys_setrlimit (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In kernel/sys.c (ffffffe0000d4598)
Location: kernel/sys.c:1668
Inline: False
```
**Symbols:**
...
```
ffffffe0000d4598-ffffffe0000d45e8: __se_sys_setrlimit (STB_GLOBAL)
```
</details>
</li>
</ul>
