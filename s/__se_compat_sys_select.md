# Function: <code>__se_compat_sys_select</code>
...
```c
long int __se_compat_sys_select(long int n, long int inp, long int outp, long int exp, long int tvp);
```
...
```
In fs/select.c (c00000000049d940)
Location: fs/select.c:1268
Inline: False
```
**Symbols:**
...
```
c00000000049d940-c00000000049d974: __se_compat_sys_select (STB_GLOBAL)
```
</details>
</li>
<li>
