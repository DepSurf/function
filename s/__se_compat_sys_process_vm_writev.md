# Function: <code>__se_compat_sys_process_vm_writev</code>
...
```c
long int __se_compat_sys_process_vm_writev(long int pid, long int lvec, long int liovcnt, long int rvec, long int riovcnt, long int flags);
```
...
```
In mm/process_vm_access.c (c0000000003e3820)
Location: mm/process_vm_access.c:361
Inline: False
```
**Symbols:**
...
```
c0000000003e3820-c0000000003e3848: __se_compat_sys_process_vm_writev (STB_GLOBAL)
```
</details>
</li>
<li>
