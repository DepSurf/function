...
```
In arch/powerpc/kernel/time.c (c00000000002b674)
Location: arch/powerpc/include/asm/time.h:156
Inline: True
Inline callers:
...
```
```
In arch/powerpc/kernel/smp.c (c000000000055ee0)
Location: arch/powerpc/include/asm/time.h:156
Inline: True
Inline callers:
