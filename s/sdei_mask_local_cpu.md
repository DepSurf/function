...
```
In drivers/firmware/arm_sdei.c (ffff800010b4ce08)
Location: drivers/firmware/arm_sdei.c:304
Inline: False
Direct callers:
...
```
ffff800010b4ce08-ffff800010b4cea4: sdei_mask_local_cpu (STB_GLOBAL)
```
</details>
</li>
<li>
