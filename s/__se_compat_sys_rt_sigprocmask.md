# Function: <code>__se_compat_sys_rt_sigprocmask</code>
...
```c
long int __se_compat_sys_rt_sigprocmask(long int how, long int nset, long int oset, long int sigsetsize);
```
...
```
In kernel/signal.c (c000000000155d90)
Location: kernel/signal.c:3046
Inline: False
```
**Symbols:**
...
```
c000000000155d90-c000000000155f04: __se_compat_sys_rt_sigprocmask (STB_GLOBAL)
```
</details>
</li>
<li>
