...
```
In drivers/scsi/scsi_transport_fc.c (ffffffff81710338)
Location: drivers/scsi/scsi_transport_fc.c:1987
Inline: True
Inline callers:
...
```
ffffffff8170bfc0-ffffffff8170bfdb: scsi_is_fc_rport (STB_GLOBAL)
```
</details>
</li>
<li>
