...
```
In drivers/gpu/drm/drm_bridge.c (ffffffff81c800f0)
Location: drivers/gpu/drm/drm_bridge.c:872
Inline: False
Direct callers:
...
```
ffffffff81c800f0-ffffffff81c802e0: select_bus_fmt_recursive (STB_LOCAL)
```
</details>
</li>
</ul>
