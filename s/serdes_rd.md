...
```
In drivers/phy/phy-xgene.c (ffff800010688270)
Location: drivers/phy/phy-xgene.c:672
Inline: True
Direct callers:
...
```
ffff800010688270-ffff8000106882f4: serdes_rd.isra.0 (STB_LOCAL)
```
</details>
</li>
<li>
