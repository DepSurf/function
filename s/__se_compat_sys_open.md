# Function: <code>__se_compat_sys_open</code>
...
```c
long int __se_compat_sys_open(long int filename, long int flags, long int mode);
```
...
```
c0000000004751f0-c00000000047521c: __se_compat_sys_open (STB_GLOBAL)
```
</details>
</li>
<li>
