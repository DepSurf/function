# Function: <code>sg_is_dma_bus_address</code>
...
```
In kernel/dma/direct.c (ffffffff811c2d18)
...
```
```
In drivers/iommu/iommu.c (ffffffff81ad0378)
Location: include/linux/scatterlist.h:270
Inline: True
Inline callers:
...
```
```
In drivers/iommu/dma-iommu.c (ffffffff81ad5802)
Location: include/linux/scatterlist.h:270
Inline: True
Inline callers:
