# Function: <code>__se_compat_sys_move_pages</code>
...
```
In mm/migrate.c (ffffffff81272222)
...
```
In mm/migrate.c (ffffffff81286832)
...
```c
long int __se_compat_sys_move_pages(long int pid, long int nr_pages, long int pages32, long int nodes, long int status, long int flags);
```
...
```
In mm/migrate.c (c000000000439250)
Location: mm/migrate.c:1857
Inline: False
```
**Symbols:**
...
```
c000000000439250-c000000000439468: __se_compat_sys_move_pages (STB_GLOBAL)
```
</details>
</li>
<li>
