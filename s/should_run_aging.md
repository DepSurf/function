...
```
ffffffff813792c0-ffffffff81379539: should_run_aging (STB_LOCAL)
ffffffff8206293b-ffffffff8206296b: should_run_aging.cold (STB_LOCAL)
```
</details>
</li>
<li>
...
```
In mm/vmscan.c (ffffffff813b4673)
Location: mm/vmscan.c:5255
Inline: True
Inline callers:
...
```
In mm/vmscan.c (ffffffff813ddcd9)
Location: mm/vmscan.c:4586
Inline: True
Inline callers:
  - mm/vmscan.c:try_to_shrink_lruvec
```
