# Function: <code>__se_compat_sys_ftruncate</code>
...
```c
long int __se_compat_sys_ftruncate(long int fd, long int length);
```
...
```
c000000000473c40-c000000000473c60: __se_compat_sys_ftruncate (STB_GLOBAL)
```
</details>
</li>
<li>
