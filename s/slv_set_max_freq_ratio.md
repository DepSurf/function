# Function: <code>slv_set_max_freq_ratio</code>
...
Location: arch/x86/kernel/smpboot.c:1855
Inline: True
Inline callers:
...
Location: arch/x86/kernel/smpboot.c:1850
Inline: True
Inline callers:
  - arch/x86/kernel/smpboot.c:intel_set_max_freq_ratio
```
...
Location: arch/x86/kernel/smpboot.c:1849
Inline: True
Inline callers:
  - arch/x86/kernel/smpboot.c:intel_set_max_freq_ratio
```
...
Location: arch/x86/kernel/smpboot.c:1856
Inline: True
Inline callers:
  - arch/x86/kernel/smpboot.c:intel_set_max_freq_ratio
```
...
Location: arch/x86/kernel/cpu/aperfmperf.c:109
Inline: True
Inline callers:
