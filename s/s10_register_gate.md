...
```
In drivers/clk/socfpga/clk-gate-s10.c (ffff8000107f0f10)
Location: drivers/clk/socfpga/clk-gate-s10.c:68
Inline: False
Direct callers:
...
```
ffff8000107f0f10-ffff8000107f1098: s10_register_gate (STB_GLOBAL)
```
</details>
</li>
<li>
