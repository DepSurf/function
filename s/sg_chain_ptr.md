# Function: <code>sg_chain_ptr</code>
...
```
In lib/scatterlist.c (ffffffff816e013a)
Location: include/linux/scatterlist.h:79
Inline: True
Inline callers:
...
```
```
In drivers/base/devcoredump.c (ffffffff819b3d9b)
Location: include/linux/scatterlist.h:79
Inline: True
Inline callers:
...
```
In lib/scatterlist.c (ffffffff817d037a)
...
```
```
In drivers/base/devcoredump.c (ffffffff81b28abb)
Location: include/linux/scatterlist.h:82
Inline: True
Inline callers:
  - drivers/base/devcoredump.c:devcd_free_sgtable
...
```
```
In drivers/base/devcoredump.c (ffffffff81b78c6b)
Location: include/linux/scatterlist.h:82
Inline: True
Inline callers:
  - drivers/base/devcoredump.c:devcd_free_sgtable
...
```
```
In drivers/base/devcoredump.c (ffffffff81bccb3b)
Location: include/linux/scatterlist.h:82
Inline: True
Inline callers:
  - drivers/base/devcoredump.c:devcd_free_sgtable
