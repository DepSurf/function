# Function: <code>set_cpu_numa_mem</code>
...
```
In arch/powerpc/kernel/smp.c (c0000000013507e0)
...
```
```
In arch/powerpc/mm/numa.c (c0000000000a14dc)
Location: include/linux/topology.h:166
Inline: True
Inline callers:
...
```
```
In mm/page_alloc.c (c0000000003eca58)
Location: include/linux/topology.h:166
Inline: True
Inline callers:
