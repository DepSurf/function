...
```
c036a0c8-c036a220: __se_sys_sigaltstack (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In kernel/signal.c (c000000000152a50)
Location: kernel/signal.c:4042
Inline: False
```
**Symbols:**
...
```
c000000000152a50-c000000000152b64: __se_sys_sigaltstack (STB_GLOBAL)
```
</details>
</li>
<li>
...
```
In kernel/signal.c (ffffffe0000d1c2e)
Location: kernel/signal.c:4042
Inline: False
```
**Symbols:**
...
```
ffffffe0000d1c2e-ffffffe0000d1cd6: __se_sys_sigaltstack (STB_GLOBAL)
```
</details>
</li>
</ul>
