...
```
In arch/powerpc/mm/book3s64/pgtable.c (c000000000090ce4)
Location: arch/powerpc/mm/book3s64/pgtable.c:95
Inline: True
Inline callers:
...
```
c000000000090c10-c000000000090c5c: serialize_against_pte_lookup (STB_GLOBAL)
```
</details>
</li>
<li>
