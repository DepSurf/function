...
```
In arch/powerpc/kernel/traps.c (c00000000002db80)
Location: arch/powerpc/kernel/traps.c:1117
Inline: True
Direct callers:
...
```
c00000000002db80-c00000000002dc6c: single_step_exception (STB_GLOBAL)
```
</details>
</li>
<li>
